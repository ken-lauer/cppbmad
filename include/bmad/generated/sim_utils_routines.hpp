...
void end_akima_spline_calc(SplineProxyArray1D& spline, int which_end);
...
extern "C" void fortran_skip_header(
    int& ix_unit /* 0D_NOT_integer in */,
    bool& error_flag /* 0D_NOT_logical in */);
...
extern "C" void fortran_spline_akima(
    Bmad::array_descriptor_t& spline /* 1D_NOT_type inout */,
    bool& ok /* 0D_NOT_logical out */);
bool spline_akima(SplineProxyArray1D& spline);
...
SimUtils::SplineEvaluate spline_evaluate(SplineProxyArray1D& spline, double x);
...
SimUtils::SuperPolint super_polint(
    FArray1D<Real>& xa,
    FArray1D<Real>& ya,
    double x);
...
void super_sobseq(
    FArray1D<Real>& x,
    optional_ref<RandomStateProxy> ran_state = std::nullopt);
extern "C" void fortran_super_sort(
    Bmad::array_descriptor_t& arr /* 1D_NOT_integer inout */);
...
extern "C" void fortran_type_this_file(
    const char* filename /* 0D_NOT_character in */);
...
extern "C" bool fortran_word_len(
    const char* wording /* 0D_NOT_character in */,
    int& wlen /* 0D_NOT_integer in */);
