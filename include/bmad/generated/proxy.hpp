...
void spline_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void spline_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void spin_polar_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void spin_polar_struct_set_real(void *struct_obj, int field_id, double value_in);
void ac_kicker_time_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void ac_kicker_time_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void ac_kicker_freq_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void ac_kicker_freq_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void interval1_coef_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void interval1_coef_struct_set_real(void *struct_obj, int field_id, double value_in);
void photon_reflect_table_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void photon_reflect_table_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void photon_reflect_surface_struct_get_integer(
    const void *struct_obj,
    int field_id,
    int *value_out
);
void photon_reflect_surface_struct_set_integer(void *struct_obj, int field_id, int value_in);
void photon_reflect_surface_struct_get_real(
    const void *struct_obj,
    int field_id,
    double *value_out
);
void photon_reflect_surface_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void coord_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void coord_struct_set_integer(void *struct_obj, int field_id, int value_in);
void coord_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void coord_struct_set_real(void *struct_obj, int field_id, double value_in);
void coord_struct_get_real16(const void *struct_obj, int field_id, long double *value_out);
void coord_struct_set_real16(void *struct_obj, int field_id, long double value_in);
...
void bpm_phase_coupling_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void bpm_phase_coupling_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void expression_atom_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void wake_sr_z_long_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void wake_sr_z_long_struct_set_integer(void *struct_obj, int field_id, int value_in);
void wake_sr_z_long_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void wake_sr_z_long_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void wake_sr_z_long_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void wake_sr_z_long_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void wake_sr_mode_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void wake_sr_mode_struct_set_integer(void *struct_obj, int field_id, int value_in);
void wake_sr_mode_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void wake_sr_mode_struct_set_real(void *struct_obj, int field_id, double value_in);
void wake_sr_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void wake_sr_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void wake_sr_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void wake_sr_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void wake_lr_mode_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void wake_lr_mode_struct_set_integer(void *struct_obj, int field_id, int value_in);
void wake_lr_mode_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void wake_lr_mode_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void wake_lr_mode_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void wake_lr_mode_struct_set_real(void *struct_obj, int field_id, double value_in);
void wake_lr_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void wake_lr_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void wake_lr_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void wake_lr_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void lat_ele_loc_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void lat_ele_loc_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void taylor_term_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void taylor_term_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void taylor_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void taylor_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void cartesian_map_term1_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void cartesian_map_term1_struct_set_integer(void *struct_obj, int field_id, int value_in);
void cartesian_map_term1_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void cartesian_map_term1_struct_set_real(void *struct_obj, int field_id, double value_in);
void cartesian_map_term_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void cartesian_map_term_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void cartesian_map_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void cartesian_map_struct_set_integer(void *struct_obj, int field_id, int value_in);
void cartesian_map_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void cartesian_map_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void cylindrical_map_term1_struct_get_complex(
    const void *struct_obj,
    int field_id,
    std::complex<double> *value_out
);
void cylindrical_map_term1_struct_set_complex(
    void *struct_obj,
    int field_id,
    std::complex<double> value_in
);
void cylindrical_map_term_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void cylindrical_map_term_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void cylindrical_map_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void cylindrical_map_struct_set_integer(void *struct_obj, int field_id, int value_in);
void cylindrical_map_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void cylindrical_map_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void grid_field_pt_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void grid_field_pt_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void grid_field_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void grid_field_struct_set_integer(void *struct_obj, int field_id, int value_in);
void grid_field_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void grid_field_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void grid_field_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void grid_field_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void floor_position_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void floor_position_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void high_energy_space_charge_struct_get_real(
    const void *struct_obj,
    int field_id,
    double *value_out
);
void high_energy_space_charge_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void xy_disp_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void xy_disp_struct_set_real(void *struct_obj, int field_id, double value_in);
void twiss_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void twiss_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void bookkeeping_state_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void bookkeeping_state_struct_set_integer(void *struct_obj, int field_id, int value_in);
void bookkeeping_state_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void bookkeeping_state_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void rad_map_ele_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void rad_map_ele_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void surface_segmented_pt_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void surface_segmented_pt_struct_set_real(void *struct_obj, int field_id, double value_in);
void surface_segmented_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void surface_segmented_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void surface_h_misalign_pt_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void surface_h_misalign_pt_struct_set_real(void *struct_obj, int field_id, double value_in);
void surface_h_misalign_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void surface_h_misalign_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void surface_displacement_pt_struct_get_real(
    const void *struct_obj,
    int field_id,
    double *value_out
);
void surface_displacement_pt_struct_set_real(void *struct_obj, int field_id, double value_in);
void surface_displacement_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void surface_displacement_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void surface_curvature_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void surface_curvature_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void surface_curvature_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void surface_curvature_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void photon_target_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void photon_target_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void photon_material_struct_get_complex(
    const void *struct_obj,
    int field_id,
    std::complex<double> *value_out
);
void photon_material_struct_set_complex(
    void *struct_obj,
    int field_id,
    std::complex<double> value_in
);
...
void pixel_pt_struct_get_complex(
    const void *struct_obj,
    int field_id,
    std::complex<double> *value_out
);
void pixel_pt_struct_set_complex(void *struct_obj, int field_id, std::complex<double> value_in);
void pixel_pt_struct_get_integer8(const void *struct_obj, int field_id, int64_t *value_out);
void pixel_pt_struct_set_integer8(void *struct_obj, int field_id, int64_t value_in);
void pixel_pt_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void pixel_pt_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void pixel_detec_struct_get_integer8(const void *struct_obj, int field_id, int64_t *value_out);
void pixel_detec_struct_set_integer8(void *struct_obj, int field_id, int64_t value_in);
...
void photon_element_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void photon_element_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void wall3d_vertex_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void wall3d_vertex_struct_set_integer(void *struct_obj, int field_id, int value_in);
void wall3d_vertex_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void wall3d_vertex_struct_set_real(void *struct_obj, int field_id, double value_in);
void wall3d_section_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void wall3d_section_struct_set_integer(void *struct_obj, int field_id, int value_in);
void wall3d_section_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void wall3d_section_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void wall3d_section_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void wall3d_section_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void wall3d_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void wall3d_struct_set_integer(void *struct_obj, int field_id, int value_in);
void wall3d_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void wall3d_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void wall3d_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void wall3d_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void ramper_lord_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void ramper_lord_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void control_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void control_struct_set_integer(void *struct_obj, int field_id, int value_in);
void control_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void control_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void control_var1_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void control_var1_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void control_ramp1_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void control_ramp1_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void ellipse_beam_init_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void ellipse_beam_init_struct_set_integer(void *struct_obj, int field_id, int value_in);
void ellipse_beam_init_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void ellipse_beam_init_struct_set_real(void *struct_obj, int field_id, double value_in);
void kv_beam_init_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void kv_beam_init_struct_set_integer(void *struct_obj, int field_id, int value_in);
void kv_beam_init_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void kv_beam_init_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void grid_beam_init_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void grid_beam_init_struct_set_integer(void *struct_obj, int field_id, int value_in);
void grid_beam_init_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void grid_beam_init_struct_set_real(void *struct_obj, int field_id, double value_in);
void beam_init_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void beam_init_struct_set_integer(void *struct_obj, int field_id, int value_in);
void beam_init_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void beam_init_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void beam_init_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void beam_init_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void lat_param_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void lat_param_struct_set_integer(void *struct_obj, int field_id, int value_in);
void lat_param_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void lat_param_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void lat_param_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void lat_param_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void mode_info_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void mode_info_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void mode_info_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void mode_info_struct_set_real(void *struct_obj, int field_id, double value_in);
void pre_tracker_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void pre_tracker_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void anormal_mode_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void anormal_mode_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void linac_normal_mode_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void linac_normal_mode_struct_set_real(void *struct_obj, int field_id, double value_in);
void normal_modes_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void normal_modes_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void em_field_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void em_field_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void strong_beam_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void strong_beam_struct_set_integer(void *struct_obj, int field_id, int value_in);
void strong_beam_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void strong_beam_struct_set_real(void *struct_obj, int field_id, double value_in);
void track_point_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void track_point_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void track_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void track_struct_set_integer(void *struct_obj, int field_id, int value_in);
void track_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void track_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void space_charge_common_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void space_charge_common_struct_set_integer(void *struct_obj, int field_id, int value_in);
void space_charge_common_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void space_charge_common_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void space_charge_common_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void space_charge_common_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void bmad_common_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void bmad_common_struct_set_integer(void *struct_obj, int field_id, int value_in);
void bmad_common_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void bmad_common_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void bmad_common_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void bmad_common_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void rad_int1_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void rad_int1_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void rf_stair_step_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void rf_stair_step_struct_set_integer(void *struct_obj, int field_id, int value_in);
void rf_stair_step_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void rf_stair_step_struct_set_real(void *struct_obj, int field_id, double value_in);
void rf_ele_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void rf_ele_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void ele_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void ele_struct_set_integer(void *struct_obj, int field_id, int value_in);
void ele_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void ele_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void ele_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void ele_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void complex_taylor_term_struct_get_complex(
    const void *struct_obj,
    int field_id,
    std::complex<double> *value_out
);
void complex_taylor_term_struct_set_complex(
    void *struct_obj,
    int field_id,
    std::complex<double> value_in
);
...
void complex_taylor_struct_get_complex(
    const void *struct_obj,
    int field_id,
    std::complex<double> *value_out
);
void complex_taylor_struct_set_complex(
    void *struct_obj,
    int field_id,
    std::complex<double> value_in
);
...
void bunch_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void bunch_struct_set_integer(void *struct_obj, int field_id, int value_in);
void bunch_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void bunch_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void bunch_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void bunch_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void bunch_params_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void bunch_params_struct_set_integer(void *struct_obj, int field_id, int value_in);
void bunch_params_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void bunch_params_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void bunch_params_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void bunch_params_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void aperture_point_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void aperture_point_struct_set_integer(void *struct_obj, int field_id, int value_in);
void aperture_point_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void aperture_point_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void aperture_scan_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void aperture_scan_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void ele_pointer_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void ele_pointer_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void nametable_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void nametable_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void resonance_h_struct_get_complex(
    const void *struct_obj,
    int field_id,
    std::complex<double> *value_out
);
void resonance_h_struct_set_complex(void *struct_obj, int field_id, std::complex<double> value_in);
...
void ptc_normal_form_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void ptc_normal_form_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void bunch_track_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void bunch_track_struct_set_integer(void *struct_obj, int field_id, int value_in);
void bunch_track_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void bunch_track_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void summation_rdt_struct_get_complex(
    const void *struct_obj,
    int field_id,
    std::complex<double> *value_out
);
void summation_rdt_struct_set_complex(
    void *struct_obj,
    int field_id,
    std::complex<double> value_in
);
void tao_ele_shape_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_ele_shape_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_ele_shape_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_ele_shape_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_ele_shape_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_ele_shape_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_ele_pointer_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_ele_pointer_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void tao_curve_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_curve_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_curve_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_curve_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_curve_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_curve_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_curve_color_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_curve_color_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_curve_color_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_curve_orbit_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_curve_orbit_struct_set_real(void *struct_obj, int field_id, double value_in);
void tao_histogram_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_histogram_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_histogram_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_histogram_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_histogram_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_histogram_struct_set_real(void *struct_obj, int field_id, double value_in);
void lat_ele_order1_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void lat_ele_order1_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void tao_spin_ele_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_spin_ele_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_plot_cache_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_plot_cache_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_spin_polarization_struct_get_logical(
    const void *struct_obj,
    int field_id,
    bool *value_out
);
void tao_spin_polarization_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_spin_polarization_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_spin_polarization_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_lattice_branch_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_lattice_branch_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_lattice_branch_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_lattice_branch_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_lattice_branch_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_lattice_branch_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_model_element_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_model_element_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_beam_branch_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_beam_branch_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_beam_branch_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_beam_branch_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_d2_data_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_d2_data_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_d2_data_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_d2_data_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_data_var_component_struct_get_real(
    const void *struct_obj,
    int field_id,
    double *value_out
);
void tao_data_var_component_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_graph_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_graph_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_graph_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_graph_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_graph_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_graph_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_plot_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_plot_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_plot_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_plot_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_plot_region_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_plot_region_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_super_universe_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_super_universe_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_super_universe_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_super_universe_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_var_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_var_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_var_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_var_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_var_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_var_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_var_slave_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_var_slave_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void tao_beam_uni_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_beam_uni_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_dynamic_aperture_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_dynamic_aperture_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_spin_map_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_spin_map_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_spin_map_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_spin_map_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_data_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_data_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_data_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_data_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_data_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_data_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_ping_scale_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_ping_scale_struct_set_real(void *struct_obj, int field_id, double value_in);
void tao_universe_calc_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_universe_calc_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_universe_calc_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_universe_calc_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_expression_info_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_expression_info_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_expression_info_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_expression_info_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_eval_node_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_eval_node_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_eval_node_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_eval_node_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_title_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_title_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_title_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_title_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void qp_rect_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void qp_rect_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_shape_pattern_point_struct_get_real(
    const void *struct_obj,
    int field_id,
    double *value_out
);
void tao_shape_pattern_point_struct_set_real(void *struct_obj, int field_id, double value_in);
void qp_axis_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void qp_axis_struct_set_integer(void *struct_obj, int field_id, int value_in);
void qp_axis_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void qp_axis_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void qp_axis_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void qp_axis_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void qp_legend_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void qp_legend_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void qp_legend_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void qp_legend_struct_set_real(void *struct_obj, int field_id, double value_in);
void qp_point_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void qp_point_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void qp_line_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void qp_line_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void qp_symbol_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void qp_symbol_struct_set_integer(void *struct_obj, int field_id, int value_in);
void qp_symbol_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void qp_symbol_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_floor_plan_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_floor_plan_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_floor_plan_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_floor_plan_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_floor_plan_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_floor_plan_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_v1_var_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_v1_var_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void tao_global_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_global_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_global_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_global_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_global_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_global_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_init_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_init_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void tao_common_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_common_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_common_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_plot_page_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_plot_page_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_plot_page_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_plot_page_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void tao_plot_page_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_plot_page_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_building_wall_orientation_struct_get_real(
    const void *struct_obj,
    int field_id,
    double *value_out
);
void tao_building_wall_orientation_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_building_wall_point_struct_get_real(
    const void *struct_obj,
    int field_id,
    double *value_out
);
void tao_building_wall_point_struct_set_real(void *struct_obj, int field_id, double value_in);
void tao_wave_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_wave_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_wave_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_wave_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_wave_kick_pt_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_wave_kick_pt_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_wave_kick_pt_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void tao_wave_kick_pt_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void tao_cmd_history_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_cmd_history_struct_set_integer(void *struct_obj, int field_id, int value_in);
...
void tao_universe_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void tao_universe_struct_set_integer(void *struct_obj, int field_id, int value_in);
void tao_universe_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void tao_universe_struct_set_logical(void *struct_obj, int field_id, bool value_in);
...
void mad_energy_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void mad_energy_struct_set_integer(void *struct_obj, int field_id, int value_in);
void mad_energy_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void mad_energy_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void random_state_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void random_state_struct_set_integer(void *struct_obj, int field_id, int value_in);
void random_state_struct_get_integer8(const void *struct_obj, int field_id, int64_t *value_out);
void random_state_struct_set_integer8(void *struct_obj, int field_id, int64_t value_in);
void random_state_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void random_state_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void random_state_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void random_state_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void bbu_stage_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void bbu_stage_struct_set_integer(void *struct_obj, int field_id, int value_in);
void bbu_stage_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void bbu_stage_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void bbu_beam_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void bbu_beam_struct_set_integer(void *struct_obj, int field_id, int value_in);
void bbu_beam_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void bbu_beam_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void bbu_param_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void bbu_param_struct_set_integer(void *struct_obj, int field_id, int value_in);
void bbu_param_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void bbu_param_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void bbu_param_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void bbu_param_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void all_encompassing_struct_get_complex(
    const void *struct_obj,
    int field_id,
    std::complex<double> *value_out
);
void all_encompassing_struct_set_complex(
    void *struct_obj,
    int field_id,
    std::complex<double> value_in
);
void all_encompassing_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void all_encompassing_struct_set_integer(void *struct_obj, int field_id, int value_in);
void all_encompassing_struct_get_integer8(const void *struct_obj, int field_id, int64_t *value_out);
void all_encompassing_struct_set_integer8(void *struct_obj, int field_id, int64_t value_in);
void all_encompassing_struct_get_logical(const void *struct_obj, int field_id, bool *value_out);
void all_encompassing_struct_set_logical(void *struct_obj, int field_id, bool value_in);
void all_encompassing_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void all_encompassing_struct_set_real(void *struct_obj, int field_id, double value_in);
...
void test_sub_sub_struct_get_integer(const void *struct_obj, int field_id, int *value_out);
void test_sub_sub_struct_set_integer(void *struct_obj, int field_id, int value_in);
void test_sub_sub_struct_get_integer8(const void *struct_obj, int field_id, int64_t *value_out);
void test_sub_sub_struct_set_integer8(void *struct_obj, int field_id, int64_t value_in);
void test_sub_sub_struct_get_real(const void *struct_obj, int field_id, double *value_out);
void test_sub_sub_struct_set_real(void *struct_obj, int field_id, double value_in);
...
public:
  ...
  double x0() const; // 0D_NOT_real [dispatch:0]
  void set_x0(double value);
  double y0() const; // 0D_NOT_real [dispatch:1]
  void set_y0(double value);
  double x1() const; // 0D_NOT_real [dispatch:2]
...
public:
  ...
  double polarization() const; // 0D_NOT_real [dispatch:0]
  void set_polarization(double value);
  double theta() const; // 0D_NOT_real [dispatch:1]
  void set_theta(double value);
  double phi() const; // 0D_NOT_real [dispatch:2]
  void set_phi(double value);
  double xi() const; // 0D_NOT_real [dispatch:3]
...
public:
  ...
  double amp() const; // 0D_NOT_real [dispatch:0]
  void set_amp(double value);
  double time() const; // 0D_NOT_real [dispatch:1]
...
public:
  ...
  double f() const; // 0D_NOT_real [dispatch:0]
  void set_f(double value);
  double amp() const; // 0D_NOT_real [dispatch:1]
  void set_amp(double value);
  double phi() const; // 0D_NOT_real [dispatch:2]
  void set_phi(double value);
};
...
public:
  ...
  double c0() const; // 0D_NOT_real [dispatch:0]
  void set_c0(double value);
  double c1() const; // 0D_NOT_real [dispatch:1]
  void set_c1(double value);
  double n_exp() const; // 0D_NOT_real [dispatch:2]
...
public:
  ...
  double max_energy() const; // 0D_NOT_real [dispatch:0]
...
public:
  ...
  explicit PhotonReflectSurfaceStruct(
      ...
      std::optional<std::string> reflectivity_file = std::nullopt,
    ...
    if (reflectivity_file)
      set_reflectivity_file(*reflectivity_file);
  ...
  double surface_roughness_rms() const; // 0D_NOT_real [dispatch:0]
  void set_surface_roughness_rms(double value);
  double roughness_correlation_len() const; // 0D_NOT_real [dispatch:1]
  void set_roughness_correlation_len(double value);
  int ix_surface() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  double s() const; // 0D_NOT_real [dispatch:0]
  void set_s(double value);
  long double t() const; // 0D_NOT_real16 [dispatch:0]
  ...
  double charge() const; // 0D_NOT_real [dispatch:1]
  void set_charge(double value);
  double dt_ref() const; // 0D_NOT_real [dispatch:2]
  void set_dt_ref(double value);
  double r() const; // 0D_NOT_real [dispatch:3]
  void set_r(double value);
  double p0c() const; // 0D_NOT_real [dispatch:4]
  void set_p0c(double value);
  double E_potential() const; // 0D_NOT_real [dispatch:5]
  void set_E_potential(double value);
  double beta() const; // 0D_NOT_real [dispatch:6]
  void set_beta(double value);
  int ix_ele() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_ele(int value);
  int ix_branch() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_branch(int value);
  int ix_turn() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_turn(int value);
  int ix_user() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_user(int value);
  int state() const; // 0D_NOT_integer [dispatch:4]
  void set_state(int value);
  int direction() const; // 0D_NOT_integer [dispatch:5]
  void set_direction(int value);
  int time_dir() const; // 0D_NOT_integer [dispatch:6]
  void set_time_dir(int value);
  int species() const; // 0D_NOT_integer [dispatch:7]
  void set_species(int value);
  int location() const; // 0D_NOT_integer [dispatch:8]
...
public:
  ...
  double K_22a() const; // 0D_NOT_real [dispatch:0]
  void set_K_22a(double value);
  double K_12a() const; // 0D_NOT_real [dispatch:1]
  void set_K_12a(double value);
  double K_11b() const; // 0D_NOT_real [dispatch:2]
  void set_K_11b(double value);
  double K_12b() const; // 0D_NOT_real [dispatch:3]
  void set_K_12b(double value);
  double Cbar22_a() const; // 0D_NOT_real [dispatch:4]
  void set_Cbar22_a(double value);
  double Cbar12_a() const; // 0D_NOT_real [dispatch:5]
  void set_Cbar12_a(double value);
  double Cbar11_b() const; // 0D_NOT_real [dispatch:6]
  void set_Cbar11_b(double value);
  double Cbar12_b() const; // 0D_NOT_real [dispatch:7]
  void set_Cbar12_b(double value);
  double phi_a() const; // 0D_NOT_real [dispatch:8]
  void set_phi_a(double value);
  double phi_b() const; // 0D_NOT_real [dispatch:9]
...
public:
  ...
  std::string name() const; // 0D_NOT_character
  void set_name(const std::string &value);
  int type() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  double z0() const; // 0D_NOT_real [dispatch:1]
  void set_z0(double value);
  double smoothing_sigma() const; // 0D_NOT_real [dispatch:2]
  void set_smoothing_sigma(double value);
  int position_dependence() const; // 0D_NOT_integer [dispatch:0]
  void set_position_dependence(int value);
  bool time_based() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  double amp() const; // 0D_NOT_real [dispatch:0]
  void set_amp(double value);
  double damp() const; // 0D_NOT_real [dispatch:1]
  void set_damp(double value);
  double k() const; // 0D_NOT_real [dispatch:2]
  void set_k(double value);
  double phi() const; // 0D_NOT_real [dispatch:3]
  void set_phi(double value);
  double b_sin() const; // 0D_NOT_real [dispatch:4]
  void set_b_sin(double value);
  double b_cos() const; // 0D_NOT_real [dispatch:5]
  void set_b_cos(double value);
  double a_sin() const; // 0D_NOT_real [dispatch:6]
  void set_a_sin(double value);
  double a_cos() const; // 0D_NOT_real [dispatch:7]
  void set_a_cos(double value);
  int polarization() const; // 0D_NOT_integer [dispatch:0]
  void set_polarization(int value);
  int position_dependence() const; // 0D_NOT_integer [dispatch:1]
  void set_position_dependence(int value);
};
...
public:
  ...
  double z_ref_long() const; // 0D_NOT_real [dispatch:0]
  void set_z_ref_long(double value);
  double z_ref_trans() const; // 0D_NOT_real [dispatch:1]
  void set_z_ref_trans(double value);
  double z_max() const; // 0D_NOT_real [dispatch:2]
  void set_z_max(double value);
  double amp_scale() const; // 0D_NOT_real [dispatch:3]
  void set_amp_scale(double value);
  double z_scale() const; // 0D_NOT_real [dispatch:4]
  void set_z_scale(double value);
  bool scale_with_length() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  double freq() const; // 0D_NOT_real [dispatch:0]
  void set_freq(double value);
  double freq_in() const; // 0D_NOT_real [dispatch:1]
  void set_freq_in(double value);
  double R_over_Q() const; // 0D_NOT_real [dispatch:2]
  void set_R_over_Q(double value);
  double Q() const; // 0D_NOT_real [dispatch:3]
  void set_Q(double value);
  double damp() const; // 0D_NOT_real [dispatch:4]
  void set_damp(double value);
  double phi() const; // 0D_NOT_real [dispatch:5]
  void set_phi(double value);
  double angle() const; // 0D_NOT_real [dispatch:6]
  void set_angle(double value);
  double b_sin() const; // 0D_NOT_real [dispatch:7]
  void set_b_sin(double value);
  double b_cos() const; // 0D_NOT_real [dispatch:8]
  void set_b_cos(double value);
  double a_sin() const; // 0D_NOT_real [dispatch:9]
  void set_a_sin(double value);
  double a_cos() const; // 0D_NOT_real [dispatch:10]
  void set_a_cos(double value);
  int m() const; // 0D_NOT_integer [dispatch:0]
  void set_m(int value);
  bool polarized() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  double t_ref() const; // 0D_NOT_real [dispatch:0]
  void set_t_ref(double value);
  double freq_spread() const; // 0D_NOT_real [dispatch:1]
  void set_freq_spread(double value);
  double amp_scale() const; // 0D_NOT_real [dispatch:2]
  void set_amp_scale(double value);
  double time_scale() const; // 0D_NOT_real [dispatch:3]
  void set_time_scale(double value);
  bool self_wake_on() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  double coef() const; // 0D_NOT_real [dispatch:0]
  void set_coef(double value);
  double kx() const; // 0D_NOT_real [dispatch:1]
  void set_kx(double value);
  double ky() const; // 0D_NOT_real [dispatch:2]
  void set_ky(double value);
  double kz() const; // 0D_NOT_real [dispatch:3]
  void set_kz(double value);
  double x0() const; // 0D_NOT_real [dispatch:4]
  void set_x0(double value);
  double y0() const; // 0D_NOT_real [dispatch:5]
  void set_y0(double value);
  double phi_z() const; // 0D_NOT_real [dispatch:6]
  void set_phi_z(double value);
  int family() const; // 0D_NOT_integer [dispatch:0]
  void set_family(int value);
  int form() const; // 0D_NOT_integer [dispatch:1]
...
public:
  ...
  std::string file() const; // 0D_NOT_character
  void set_file(const std::string &value);
  int n_link() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  double field_scale() const; // 0D_NOT_real [dispatch:0]
  void set_field_scale(double value);
  FArray1D<double> r0() const; // 1D_NOT_real
  void set_r0(const std::vector<double> &v);
  int master_parameter() const; // 0D_NOT_integer [dispatch:0]
  void set_master_parameter(int value);
  int ele_anchor_pt() const; // 0D_NOT_integer [dispatch:1]
  void set_ele_anchor_pt(int value);
  int field_type() const; // 0D_NOT_integer [dispatch:2]
...
public:
  ...
  std::complex<double> e_coef() const; // 0D_NOT_complex [dispatch:0]
  void set_e_coef(std::complex<double> value);
  std::complex<double> b_coef() const; // 0D_NOT_complex [dispatch:1]
...
public:
  ...
  int m() const; // 0D_NOT_integer [dispatch:0]
  void set_m(int value);
  int harmonic() const; // 0D_NOT_integer [dispatch:1]
  void set_harmonic(int value);
  double phi0_fieldmap() const; // 0D_NOT_real [dispatch:0]
  void set_phi0_fieldmap(double value);
  double theta0_azimuth() const; // 0D_NOT_real [dispatch:1]
  void set_theta0_azimuth(double value);
  double field_scale() const; // 0D_NOT_real [dispatch:2]
  void set_field_scale(double value);
  int master_parameter() const; // 0D_NOT_integer [dispatch:2]
  void set_master_parameter(int value);
  int ele_anchor_pt() const; // 0D_NOT_integer [dispatch:3]
  void set_ele_anchor_pt(int value);
  double dz() const; // 0D_NOT_real [dispatch:3]
  void set_dz(double value);
  FArray1D<double> r0() const; // 1D_NOT_real
  void set_r0(const std::vector<double> &v);
...
public:
  ...
  int geometry() const; // 0D_NOT_integer [dispatch:0]
  ...
  int field_type() const; // 0D_NOT_integer [dispatch:2]
  void set_field_type(int value);
  int master_parameter() const; // 0D_NOT_integer [dispatch:3]
  void set_master_parameter(int value);
  int ele_anchor_pt() const; // 0D_NOT_integer [dispatch:4]
  void set_ele_anchor_pt(int value);
  int interpolation_order() const; // 0D_NOT_integer [dispatch:5]
...
public:
  ...
  double theta() const; // 0D_NOT_real [dispatch:0]
  void set_theta(double value);
  double phi() const; // 0D_NOT_real [dispatch:1]
  void set_phi(double value);
  double psi() const; // 0D_NOT_real [dispatch:2]
...
public:
  ...
  double kick_const() const; // 0D_NOT_real [dispatch:0]
  void set_kick_const(double value);
  double sig_x() const; // 0D_NOT_real [dispatch:1]
  void set_sig_x(double value);
  double sig_y() const; // 0D_NOT_real [dispatch:2]
  void set_sig_y(double value);
  double phi() const; // 0D_NOT_real [dispatch:3]
  void set_phi(double value);
  double sin_phi() const; // 0D_NOT_real [dispatch:4]
  void set_sin_phi(double value);
  double cos_phi() const; // 0D_NOT_real [dispatch:5]
  void set_cos_phi(double value);
  double sig_z() const; // 0D_NOT_real [dispatch:6]
...
public:
  ...
  double eta() const; // 0D_NOT_real [dispatch:0]
  void set_eta(double value);
  double etap() const; // 0D_NOT_real [dispatch:1]
  void set_etap(double value);
  double deta_ds() const; // 0D_NOT_real [dispatch:2]
  void set_deta_ds(double value);
  double sigma() const; // 0D_NOT_real [dispatch:3]
  void set_sigma(double value);
  double deta_dpz() const; // 0D_NOT_real [dispatch:4]
  void set_deta_dpz(double value);
  double detap_dpz() const; // 0D_NOT_real [dispatch:5]
...
public:
  ...
  double beta() const; // 0D_NOT_real [dispatch:0]
  void set_beta(double value);
  double alpha() const; // 0D_NOT_real [dispatch:1]
  void set_alpha(double value);
  double gamma() const; // 0D_NOT_real [dispatch:2]
  void set_gamma(double value);
  double phi() const; // 0D_NOT_real [dispatch:3]
  void set_phi(double value);
  double eta() const; // 0D_NOT_real [dispatch:4]
  void set_eta(double value);
  double etap() const; // 0D_NOT_real [dispatch:5]
  void set_etap(double value);
  double deta_ds() const; // 0D_NOT_real [dispatch:6]
  void set_deta_ds(double value);
  double sigma() const; // 0D_NOT_real [dispatch:7]
  void set_sigma(double value);
  double sigma_p() const; // 0D_NOT_real [dispatch:8]
  void set_sigma_p(double value);
  double emit() const; // 0D_NOT_real [dispatch:9]
  void set_emit(double value);
  double norm_emit() const; // 0D_NOT_real [dispatch:10]
  void set_norm_emit(double value);
  double chrom() const; // 0D_NOT_real [dispatch:11]
  void set_chrom(double value);
  double dbeta_dpz() const; // 0D_NOT_real [dispatch:12]
  void set_dbeta_dpz(double value);
  double dalpha_dpz() const; // 0D_NOT_real [dispatch:13]
  void set_dalpha_dpz(double value);
  double deta_dpz() const; // 0D_NOT_real [dispatch:14]
  void set_deta_dpz(double value);
  double detap_dpz() const; // 0D_NOT_real [dispatch:15]
  void set_detap_dpz(double value);
};
...
public:
  ...
  int attributes() const; // 0D_NOT_integer [dispatch:0]
  void set_attributes(int value);
  int control() const; // 0D_NOT_integer [dispatch:1]
  void set_control(int value);
  int floor_position() const; // 0D_NOT_integer [dispatch:2]
  void set_floor_position(int value);
  int s_position() const; // 0D_NOT_integer [dispatch:3]
  void set_s_position(int value);
  int ref_energy() const; // 0D_NOT_integer [dispatch:4]
  void set_ref_energy(int value);
  int mat6() const; // 0D_NOT_integer [dispatch:5]
  void set_mat6(int value);
  int rad_int() const; // 0D_NOT_integer [dispatch:6]
  void set_rad_int(int value);
  int ptc() const; // 0D_NOT_integer [dispatch:7]
  void set_ptc(int value);
  bool has_misalign() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  bool stale() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  void set_field_type(int value);
  int iz0() const; // 0D_NOT_integer [dispatch:2]
  void set_iz0(int value);
  int iz1() const; // 0D_NOT_integer [dispatch:3]
...
public:
  ...
  double y0() const; // 0D_NOT_real [dispatch:1]
  void set_y0(double value);
  double z0() const; // 0D_NOT_real [dispatch:2]
  void set_z0(double value);
  double dz_dx() const; // 0D_NOT_real [dispatch:3]
  void set_dz_dx(double value);
  double dz_dy() const; // 0D_NOT_real [dispatch:4]
...
public:
  ...
  bool active() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  double y0() const; // 0D_NOT_real [dispatch:1]
  void set_y0(double value);
  double rot_y() const; // 0D_NOT_real [dispatch:2]
  void set_rot_y(double value);
  double rot_t() const; // 0D_NOT_real [dispatch:3]
  void set_rot_t(double value);
  double rot_y_rms() const; // 0D_NOT_real [dispatch:4]
  void set_rot_y_rms(double value);
  double rot_t_rms() const; // 0D_NOT_real [dispatch:5]
...
public:
  ...
  double dz_dy() const; // 0D_NOT_real [dispatch:4]
  void set_dz_dy(double value);
  double d2z_dxdy() const; // 0D_NOT_real [dispatch:5]
...
public:
  ...
  int type() const; // 0D_NOT_integer [dispatch:0]
  void set_type(int value);
  int n_corner() const; // 0D_NOT_integer [dispatch:1]
...
public:
  ...
  std::complex<double> f0_m1() const; // 0D_NOT_complex [dispatch:0]
  void set_f0_m1(std::complex<double> value);
  std::complex<double> f0_m2() const; // 0D_NOT_complex [dispatch:1]
  void set_f0_m2(std::complex<double> value);
  std::complex<double> f_0() const; // 0D_NOT_complex [dispatch:2]
  void set_f_0(std::complex<double> value);
  std::complex<double> f_h() const; // 0D_NOT_complex [dispatch:3]
  void set_f_h(std::complex<double> value);
  std::complex<double> f_hbar() const; // 0D_NOT_complex [dispatch:4]
  void set_f_hbar(std::complex<double> value);
  std::complex<double> f_hkl() const; // 0D_NOT_complex [dispatch:5]
...
public:
  ...
  int64_t n_photon() const; // 0D_NOT_integer8 [dispatch:0]
  void set_n_photon(int64_t value);
  std::complex<double> E_x() const; // 0D_NOT_complex [dispatch:0]
  void set_E_x(std::complex<double> value);
  std::complex<double> E_y() const; // 0D_NOT_complex [dispatch:1]
  void set_E_y(std::complex<double> value);
  double intensity_x() const; // 0D_NOT_real [dispatch:0]
  void set_intensity_x(double value);
  double intensity_y() const; // 0D_NOT_real [dispatch:1]
  void set_intensity_y(double value);
  double intensity() const; // 0D_NOT_real [dispatch:2]
...
public:
  ...
  FArray1D<double> r0() const; // 1D_NOT_real
  void set_r0(const std::vector<double> &v);
  int64_t n_track_tot() const; // 0D_NOT_integer8 [dispatch:0]
  void set_n_track_tot(int64_t value);
  int64_t n_hit_detec() const; // 0D_NOT_integer8 [dispatch:1]
  void set_n_hit_detec(int64_t value);
  int64_t n_hit_pixel() const; // 0D_NOT_integer8 [dispatch:2]
...
public:
  ...
  int reflectivity_table_type() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  double x() const; // 0D_NOT_real [dispatch:0]
  void set_x(double value);
  double y() const; // 0D_NOT_real [dispatch:1]
  void set_y(double value);
  double radius_x() const; // 0D_NOT_real [dispatch:2]
  void set_radius_x(double value);
  double radius_y() const; // 0D_NOT_real [dispatch:3]
  void set_radius_y(double value);
  double tilt() const; // 0D_NOT_real [dispatch:4]
  void set_tilt(double value);
  double angle() const; // 0D_NOT_real [dispatch:5]
  void set_angle(double value);
  double x0() const; // 0D_NOT_real [dispatch:6]
  void set_x0(double value);
  double y0() const; // 0D_NOT_real [dispatch:7]
  void set_y0(double value);
  int type() const; // 0D_NOT_integer [dispatch:0]
  void set_type(int value);
};
...
public:
  ...
  int type() const; // 0D_NOT_integer [dispatch:0]
  void set_type(int value);
  int n_vertex_input() const; // 0D_NOT_integer [dispatch:1]
  void set_n_vertex_input(int value);
  int ix_ele() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_ele(int value);
  int ix_branch() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_branch(int value);
  int vertices_state() const; // 0D_NOT_integer [dispatch:4]
  void set_vertices_state(int value);
  bool patch_in_region() const; // 0D_NOT_logical [dispatch:0]
  void set_patch_in_region(bool value);
  double thickness() const; // 0D_NOT_real [dispatch:0]
  void set_thickness(double value);
  double s() const; // 0D_NOT_real [dispatch:1]
  void set_s(double value);
  FArray1D<double> r0() const; // 1D_NOT_real
  void set_r0(const std::vector<double> &v);
  double dx0_ds() const; // 0D_NOT_real [dispatch:2]
  void set_dx0_ds(double value);
  double dy0_ds() const; // 0D_NOT_real [dispatch:3]
  ...
  double dr_ds() const; // 0D_NOT_real [dispatch:4]
...
public:
  ...
  explicit Wall3dStruct(
      ...
      std::optional<int> n_link = std::nullopt,
      std::optional<double> thickness = std::nullopt,
      std::optional<std::string> clear_material = std::nullopt,
      std::optional<std::string> opaque_material = std::nullopt,
    ...
    if (thickness)
      set_thickness(*thickness);
    if (clear_material)
      set_clear_material(*clear_material);
    if (opaque_material)
      set_opaque_material(*opaque_material);
    if (superimpose)
  ...
  int type() const; // 0D_NOT_integer [dispatch:0]
  void set_type(int value);
  int ix_wall3d() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_wall3d(int value);
  int n_link() const; // 0D_NOT_integer [dispatch:2]
  void set_n_link(int value);
  double thickness() const; // 0D_NOT_real [dispatch:0]
  void set_thickness(double value);
  ...
  bool superimpose() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  int ix_ele() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_ele(int value);
  int ix_con() const; // 0D_NOT_integer [dispatch:1]
...
public:
  ...
  int ix_attrib() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  double value() const; // 0D_NOT_real [dispatch:0]
  void set_value(double value);
  double old_value() const; // 0D_NOT_real [dispatch:1]
...
public:
  ...
  std::string slave_name() const; // 0D_NOT_character
  void set_slave_name(const std::string &value);
  bool is_controller() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  int part_per_ellipse() const; // 0D_NOT_integer [dispatch:0]
  void set_part_per_ellipse(int value);
  int n_ellipse() const; // 0D_NOT_integer [dispatch:1]
  void set_n_ellipse(int value);
  double sigma_cutoff() const; // 0D_NOT_real [dispatch:0]
...
public:
  ...
  int n_I2() const; // 0D_NOT_integer [dispatch:0]
  void set_n_I2(int value);
  double A() const; // 0D_NOT_real [dispatch:0]
...
public:
  ...
  int n_x() const; // 0D_NOT_integer [dispatch:0]
  void set_n_x(int value);
  int n_px() const; // 0D_NOT_integer [dispatch:1]
  void set_n_px(int value);
  double x_min() const; // 0D_NOT_real [dispatch:0]
  void set_x_min(double value);
  double x_max() const; // 0D_NOT_real [dispatch:1]
  void set_x_max(double value);
  double px_min() const; // 0D_NOT_real [dispatch:2]
  void set_px_min(double value);
  double px_max() const; // 0D_NOT_real [dispatch:3]
...
public:
  ...
  explicit BeamInitStruct(
      ...
      std::optional<std::string> random_engine = std::nullopt,
      std::optional<std::string> random_gauss_converter = std::nullopt,
    ...
    if (random_engine)
      set_random_engine(*random_engine);
    if (random_gauss_converter)
      set_random_gauss_converter(*random_gauss_converter);
  ...
  double sig_z_jitter() const; // 0D_NOT_real [dispatch:0]
  void set_sig_z_jitter(double value);
  double sig_pz_jitter() const; // 0D_NOT_real [dispatch:1]
  void set_sig_pz_jitter(double value);
  int n_particle() const; // 0D_NOT_integer [dispatch:0]
  void set_n_particle(int value);
  bool renorm_center() const; // 0D_NOT_logical [dispatch:0]
  void set_renorm_center(bool value);
  bool renorm_sigma() const; // 0D_NOT_logical [dispatch:1]
  ...
  double random_sigma_cutoff() const; // 0D_NOT_real [dispatch:2]
  void set_random_sigma_cutoff(double value);
  double a_norm_emit() const; // 0D_NOT_real [dispatch:3]
  void set_a_norm_emit(double value);
  double b_norm_emit() const; // 0D_NOT_real [dispatch:4]
  void set_b_norm_emit(double value);
  double a_emit() const; // 0D_NOT_real [dispatch:5]
  void set_a_emit(double value);
  double b_emit() const; // 0D_NOT_real [dispatch:6]
  void set_b_emit(double value);
  double dPz_dz() const; // 0D_NOT_real [dispatch:7]
  void set_dPz_dz(double value);
  FArray1D<double> center() const; // 1D_NOT_real
  void set_center(const std::vector<double> &v);
  double t_offset() const; // 0D_NOT_real [dispatch:8]
  void set_t_offset(double value);
  double dt_bunch() const; // 0D_NOT_real [dispatch:9]
  void set_dt_bunch(double value);
  double sig_z() const; // 0D_NOT_real [dispatch:10]
  void set_sig_z(double value);
  double sig_pz() const; // 0D_NOT_real [dispatch:11]
  void set_sig_pz(double value);
  double bunch_charge() const; // 0D_NOT_real [dispatch:12]
  void set_bunch_charge(double value);
  int n_bunch() const; // 0D_NOT_integer [dispatch:1]
  void set_n_bunch(int value);
  int ix_turn() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_turn(int value);
  std::string species() const; // 0D_NOT_character
  void set_species(const std::string &value);
  bool full_6D_coupling_calc() const; // 0D_NOT_logical [dispatch:2]
  void set_full_6D_coupling_calc(bool value);
  bool use_particle_start() const; // 0D_NOT_logical [dispatch:3]
  void set_use_particle_start(bool value);
  bool use_t_coords() const; // 0D_NOT_logical [dispatch:4]
  void set_use_t_coords(bool value);
  bool use_z_as_t() const; // 0D_NOT_logical [dispatch:5]
...
public:
  ...
  double n_part() const; // 0D_NOT_real [dispatch:0]
  void set_n_part(double value);
  double total_length() const; // 0D_NOT_real [dispatch:1]
  void set_total_length(double value);
  double unstable_factor() const; // 0D_NOT_real [dispatch:2]
  ...
  double spin_tune() const; // 0D_NOT_real [dispatch:3]
  void set_spin_tune(double value);
  int particle() const; // 0D_NOT_integer [dispatch:0]
  void set_particle(int value);
  int default_tracking_species() const; // 0D_NOT_integer [dispatch:1]
  void set_default_tracking_species(int value);
  int geometry() const; // 0D_NOT_integer [dispatch:2]
  void set_geometry(int value);
  int ixx() const; // 0D_NOT_integer [dispatch:3]
  void set_ixx(int value);
  bool stable() const; // 0D_NOT_logical [dispatch:0]
  void set_stable(bool value);
  bool live_branch() const; // 0D_NOT_logical [dispatch:1]
  void set_live_branch(bool value);
  double g1_integral() const; // 0D_NOT_real [dispatch:4]
  void set_g1_integral(double value);
  double g2_integral() const; // 0D_NOT_real [dispatch:5]
  void set_g2_integral(double value);
  double g3_integral() const; // 0D_NOT_real [dispatch:6]
...
public:
  ...
  bool stable() const; // 0D_NOT_logical [dispatch:0]
  void set_stable(bool value);
  double tune() const; // 0D_NOT_real [dispatch:0]
  void set_tune(double value);
  double emit() const; // 0D_NOT_real [dispatch:1]
  void set_emit(double value);
  double chrom() const; // 0D_NOT_real [dispatch:2]
  void set_chrom(double value);
  double sigma() const; // 0D_NOT_real [dispatch:3]
  void set_sigma(double value);
  double sigmap() const; // 0D_NOT_real [dispatch:4]
...
public:
  ...
  int who() const; // 0D_NOT_integer [dispatch:0]
  void set_who(int value);
  int ix_ele_start() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_ele_start(int value);
  int ix_ele_end() const; // 0D_NOT_integer [dispatch:2]
...
public:
  ...
  double emittance() const; // 0D_NOT_real [dispatch:0]
  void set_emittance(double value);
  double emittance_no_vert() const; // 0D_NOT_real [dispatch:1]
  ...
  double j_damp() const; // 0D_NOT_real [dispatch:2]
  void set_j_damp(double value);
  double alpha_damp() const; // 0D_NOT_real [dispatch:3]
  void set_alpha_damp(double value);
  double chrom() const; // 0D_NOT_real [dispatch:4]
  void set_chrom(double value);
  double tune() const; // 0D_NOT_real [dispatch:5]
  void set_tune(double value);
};
...
public:
  ...
  double i2_E4() const; // 0D_NOT_real [dispatch:0]
  void set_i2_E4(double value);
  double i3_E7() const; // 0D_NOT_real [dispatch:1]
  void set_i3_E7(double value);
  double i5a_E6() const; // 0D_NOT_real [dispatch:2]
  void set_i5a_E6(double value);
  double i5b_E6() const; // 0D_NOT_real [dispatch:3]
  void set_i5b_E6(double value);
  double sig_E1() const; // 0D_NOT_real [dispatch:4]
  void set_sig_E1(double value);
  double a_emittance_end() const; // 0D_NOT_real [dispatch:5]
  void set_a_emittance_end(double value);
  double b_emittance_end() const; // 0D_NOT_real [dispatch:6]
...
public:
  ...
  FArray1D<double> synch_int() const; // 1D_NOT_real
  void set_synch_int(const std::vector<double> &v);
  double sigE_E() const; // 0D_NOT_real [dispatch:0]
  void set_sigE_E(double value);
  double sig_z() const; // 0D_NOT_real [dispatch:1]
  void set_sig_z(double value);
  double e_loss() const; // 0D_NOT_real [dispatch:2]
  void set_e_loss(double value);
  double rf_voltage() const; // 0D_NOT_real [dispatch:3]
  void set_rf_voltage(double value);
  double pz_aperture() const; // 0D_NOT_real [dispatch:4]
  void set_pz_aperture(double value);
  double pz_average() const; // 0D_NOT_real [dispatch:5]
  void set_pz_average(double value);
  double momentum_compaction() const; // 0D_NOT_real [dispatch:6]
  void set_momentum_compaction(double value);
  double dpz_damp() const; // 0D_NOT_real [dispatch:7]
...
public:
  ...
  double phi() const; // 0D_NOT_real [dispatch:0]
  void set_phi(double value);
  double phi_B() const; // 0D_NOT_real [dispatch:1]
  void set_phi_B(double value);
...
public:
  ...
  int ix_slice() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_slice(int value);
  double x_center() const; // 0D_NOT_real [dispatch:0]
  void set_x_center(double value);
  double y_center() const; // 0D_NOT_real [dispatch:1]
  void set_y_center(double value);
  double x_sigma() const; // 0D_NOT_real [dispatch:2]
  void set_x_sigma(double value);
  double y_sigma() const; // 0D_NOT_real [dispatch:3]
  void set_y_sigma(double value);
  double dx() const; // 0D_NOT_real [dispatch:4]
  void set_dx(double value);
  double dy() const; // 0D_NOT_real [dispatch:5]
...
public:
  ...
  double s_lab() const; // 0D_NOT_real [dispatch:0]
  void set_s_lab(double value);
  double s_body() const; // 0D_NOT_real [dispatch:1]
...
public:
  ...
  double ds_save() const; // 0D_NOT_real [dispatch:0]
  void set_ds_save(double value);
  int n_pt() const; // 0D_NOT_integer [dispatch:0]
  void set_n_pt(int value);
  int n_bad() const; // 0D_NOT_integer [dispatch:1]
  void set_n_bad(int value);
  int n_ok() const; // 0D_NOT_integer [dispatch:2]
...
public:
  ...
  explicit SpaceChargeCommonStruct(
      ...
      std::optional<std::string> diagnostic_output_file = std::nullopt
  )
      : FortranProxy() {
    if (ds_track_step)
    ...
    if (diagnostic_output_file)
      set_diagnostic_output_file(*diagnostic_output_file);
  }

  double ds_track_step() const; // 0D_NOT_real [dispatch:0]
  void set_ds_track_step(double value);
  double dt_track_step() const; // 0D_NOT_real [dispatch:1]
  void set_dt_track_step(double value);
  double cathode_strength_cutoff() const; // 0D_NOT_real [dispatch:2]
  void set_cathode_strength_cutoff(double value);
  double rel_tol_tracking() const; // 0D_NOT_real [dispatch:3]
  void set_rel_tol_tracking(double value);
  double abs_tol_tracking() const; // 0D_NOT_real [dispatch:4]
  void set_abs_tol_tracking(double value);
  double beam_chamber_height() const; // 0D_NOT_real [dispatch:5]
  void set_beam_chamber_height(double value);
  double lsc_sigma_cutoff() const; // 0D_NOT_real [dispatch:6]
  ...
  int n_bin() const; // 0D_NOT_integer [dispatch:0]
  void set_n_bin(int value);
  int particle_bin_span() const; // 0D_NOT_integer [dispatch:1]
  void set_particle_bin_span(int value);
  int n_shield_images() const; // 0D_NOT_integer [dispatch:2]
  void set_n_shield_images(int value);
  int sc_min_in_bin() const; // 0D_NOT_integer [dispatch:3]
  void set_sc_min_in_bin(int value);
  bool lsc_kick_transverse_dependence() const; // 0D_NOT_logical [dispatch:0]
  void set_lsc_kick_transverse_dependence(bool value);
  bool debug() const; // 0D_NOT_logical [dispatch:1]
...
public:
  ...
  double max_aperture_limit() const; // 0D_NOT_real [dispatch:0]
  void set_max_aperture_limit(double value);
  FArray1D<double> d_orb() const; // 1D_NOT_real
  void set_d_orb(const std::vector<double> &v);
  double default_ds_step() const; // 0D_NOT_real [dispatch:1]
  void set_default_ds_step(double value);
  double significant_length() const; // 0D_NOT_real [dispatch:2]
  void set_significant_length(double value);
  double rel_tol_tracking() const; // 0D_NOT_real [dispatch:3]
  void set_rel_tol_tracking(double value);
  double abs_tol_tracking() const; // 0D_NOT_real [dispatch:4]
  void set_abs_tol_tracking(double value);
  double rel_tol_adaptive_tracking() const; // 0D_NOT_real [dispatch:5]
  void set_rel_tol_adaptive_tracking(double value);
  double abs_tol_adaptive_tracking() const; // 0D_NOT_real [dispatch:6]
  void set_abs_tol_adaptive_tracking(double value);
  double init_ds_adaptive_tracking() const; // 0D_NOT_real [dispatch:7]
  void set_init_ds_adaptive_tracking(double value);
  double min_ds_adaptive_tracking() const; // 0D_NOT_real [dispatch:8]
  void set_min_ds_adaptive_tracking(double value);
  double fatal_ds_adaptive_tracking() const; // 0D_NOT_real [dispatch:9]
  void set_fatal_ds_adaptive_tracking(double value);
  double autoscale_amp_abs_tol() const; // 0D_NOT_real [dispatch:10]
  void set_autoscale_amp_abs_tol(double value);
  double autoscale_amp_rel_tol() const; // 0D_NOT_real [dispatch:11]
  void set_autoscale_amp_rel_tol(double value);
  double autoscale_phase_tol() const; // 0D_NOT_real [dispatch:12]
  void set_autoscale_phase_tol(double value);
  double electric_dipole_moment() const; // 0D_NOT_real [dispatch:13]
  void set_electric_dipole_moment(double value);
  double synch_rad_scale() const; // 0D_NOT_real [dispatch:14]
  void set_synch_rad_scale(double value);
  double sad_eps_scale() const; // 0D_NOT_real [dispatch:15]
  void set_sad_eps_scale(double value);
  double sad_amp_max() const; // 0D_NOT_real [dispatch:16]
  void set_sad_amp_max(double value);
  int sad_n_div_max() const; // 0D_NOT_integer [dispatch:0]
  void set_sad_n_div_max(int value);
  int taylor_order() const; // 0D_NOT_integer [dispatch:1]
  void set_taylor_order(int value);
  int runge_kutta_order() const; // 0D_NOT_integer [dispatch:2]
  void set_runge_kutta_order(int value);
  int default_integ_order() const; // 0D_NOT_integer [dispatch:3]
  void set_default_integ_order(int value);
  int max_num_runge_kutta_step() const; // 0D_NOT_integer [dispatch:4]
  void set_max_num_runge_kutta_step(int value);
  bool rf_phase_below_transition_ref() const; // 0D_NOT_logical [dispatch:0]
  void set_rf_phase_below_transition_ref(bool value);
  bool sr_wakes_on() const; // 0D_NOT_logical [dispatch:1]
  void set_sr_wakes_on(bool value);
  bool lr_wakes_on() const; // 0D_NOT_logical [dispatch:2]
  void set_lr_wakes_on(bool value);
  bool auto_bookkeeper() const; // 0D_NOT_logical [dispatch:3]
...
public:
  ...
  double i0() const; // 0D_NOT_real [dispatch:0]
  void set_i0(double value);
  double i1() const; // 0D_NOT_real [dispatch:1]
  void set_i1(double value);
  double i2() const; // 0D_NOT_real [dispatch:2]
  void set_i2(double value);
  double i3() const; // 0D_NOT_real [dispatch:3]
  void set_i3(double value);
  double i4a() const; // 0D_NOT_real [dispatch:4]
  void set_i4a(double value);
  double i4b() const; // 0D_NOT_real [dispatch:5]
  void set_i4b(double value);
  double i4z() const; // 0D_NOT_real [dispatch:6]
  void set_i4z(double value);
  double i5a() const; // 0D_NOT_real [dispatch:7]
  void set_i5a(double value);
  double i5b() const; // 0D_NOT_real [dispatch:8]
  void set_i5b(double value);
  double i6b() const; // 0D_NOT_real [dispatch:9]
  void set_i6b(double value);
  double lin_i2_E4() const; // 0D_NOT_real [dispatch:10]
  void set_lin_i2_E4(double value);
  double lin_i3_E7() const; // 0D_NOT_real [dispatch:11]
  void set_lin_i3_E7(double value);
  double lin_i5a_E6() const; // 0D_NOT_real [dispatch:12]
  void set_lin_i5a_E6(double value);
  double lin_i5b_E6() const; // 0D_NOT_real [dispatch:13]
  void set_lin_i5b_E6(double value);
  double lin_norm_emit_a() const; // 0D_NOT_real [dispatch:14]
  void set_lin_norm_emit_a(double value);
  double lin_norm_emit_b() const; // 0D_NOT_real [dispatch:15]
  void set_lin_norm_emit_b(double value);
  double lin_sig_E() const; // 0D_NOT_real [dispatch:16]
  void set_lin_sig_E(double value);
  double n_steps() const; // 0D_NOT_real [dispatch:17]
...
public:
  ...
  double E_tot0() const; // 0D_NOT_real [dispatch:0]
  void set_E_tot0(double value);
  double E_tot1() const; // 0D_NOT_real [dispatch:1]
  void set_E_tot1(double value);
  double p0c() const; // 0D_NOT_real [dispatch:2]
  void set_p0c(double value);
  double p1c() const; // 0D_NOT_real [dispatch:3]
  void set_p1c(double value);
  double scale() const; // 0D_NOT_real [dispatch:4]
  void set_scale(double value);
  double time() const; // 0D_NOT_real [dispatch:5]
  void set_time(double value);
  double s0() const; // 0D_NOT_real [dispatch:6]
  void set_s0(double value);
  double s() const; // 0D_NOT_real [dispatch:7]
  void set_s(double value);
  int ix_step() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  double ds_step() const; // 0D_NOT_real [dispatch:0]
...
public:
  ...
  explicit EleStruct(
      ...
      std::optional<std::string> descrip = std::nullopt,
      optional_ref<const TwissStruct> a = std::nullopt,
      optional_ref<const TwissStruct> b = std::nullopt,
  ...
  double gamma_c() const; // 0D_NOT_real [dispatch:0]
  void set_gamma_c(double value);
  double s_start() const; // 0D_NOT_real [dispatch:1]
  void set_s_start(double value);
  double s() const; // 0D_NOT_real [dispatch:2]
  void set_s(double value);
  double ref_time() const; // 0D_NOT_real [dispatch:3]
  ...
  int key() const; // 0D_NOT_integer [dispatch:0]
  void set_key(int value);
  int sub_key() const; // 0D_NOT_integer [dispatch:1]
  void set_sub_key(int value);
  int ix_ele() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_ele(int value);
  int ix_branch() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_branch(int value);
  int lord_status() const; // 0D_NOT_integer [dispatch:4]
  void set_lord_status(int value);
  int n_slave() const; // 0D_NOT_integer [dispatch:5]
  void set_n_slave(int value);
  int n_slave_field() const; // 0D_NOT_integer [dispatch:6]
  void set_n_slave_field(int value);
  int ix1_slave() const; // 0D_NOT_integer [dispatch:7]
  void set_ix1_slave(int value);
  int slave_status() const; // 0D_NOT_integer [dispatch:8]
  void set_slave_status(int value);
  int n_lord() const; // 0D_NOT_integer [dispatch:9]
  void set_n_lord(int value);
  int n_lord_field() const; // 0D_NOT_integer [dispatch:10]
  void set_n_lord_field(int value);
  int n_lord_ramper() const; // 0D_NOT_integer [dispatch:11]
  void set_n_lord_ramper(int value);
  int ic1_lord() const; // 0D_NOT_integer [dispatch:12]
  void set_ic1_lord(int value);
  int ix_pointer() const; // 0D_NOT_integer [dispatch:13]
  void set_ix_pointer(int value);
  int ixx() const; // 0D_NOT_integer [dispatch:14]
  void set_ixx(int value);
  int iyy() const; // 0D_NOT_integer [dispatch:15]
  void set_iyy(int value);
  int izz() const; // 0D_NOT_integer [dispatch:16]
  void set_izz(int value);
  int mat6_calc_method() const; // 0D_NOT_integer [dispatch:17]
  void set_mat6_calc_method(int value);
  int tracking_method() const; // 0D_NOT_integer [dispatch:18]
  void set_tracking_method(int value);
  int spin_tracking_method() const; // 0D_NOT_integer [dispatch:19]
  void set_spin_tracking_method(int value);
  int csr_method() const; // 0D_NOT_integer [dispatch:20]
  void set_csr_method(int value);
  int space_charge_method() const; // 0D_NOT_integer [dispatch:21]
  void set_space_charge_method(int value);
  int ptc_integration_type() const; // 0D_NOT_integer [dispatch:22]
  void set_ptc_integration_type(int value);
  int field_calc() const; // 0D_NOT_integer [dispatch:23]
  void set_field_calc(int value);
  int aperture_at() const; // 0D_NOT_integer [dispatch:24]
  void set_aperture_at(int value);
  int aperture_type() const; // 0D_NOT_integer [dispatch:25]
  void set_aperture_type(int value);
  int ref_species() const; // 0D_NOT_integer [dispatch:26]
  void set_ref_species(int value);
  int orientation() const; // 0D_NOT_integer [dispatch:27]
  void set_orientation(int value);
  bool symplectify() const; // 0D_NOT_logical [dispatch:0]
  void set_symplectify(bool value);
  bool mode_flip() const; // 0D_NOT_logical [dispatch:1]
  void set_mode_flip(bool value);
  bool multipoles_on() const; // 0D_NOT_logical [dispatch:2]
  void set_multipoles_on(bool value);
  bool scale_multipoles() const; // 0D_NOT_logical [dispatch:3]
  void set_scale_multipoles(bool value);
  bool taylor_map_includes_offsets() const; // 0D_NOT_logical [dispatch:4]
  void set_taylor_map_includes_offsets(bool value);
  bool field_master() const; // 0D_NOT_logical [dispatch:5]
  void set_field_master(bool value);
  bool is_on() const; // 0D_NOT_logical [dispatch:6]
  void set_is_on(bool value);
  bool logic() const; // 0D_NOT_logical [dispatch:7]
  void set_logic(bool value);
  bool bmad_logic() const; // 0D_NOT_logical [dispatch:8]
  void set_bmad_logic(bool value);
  bool select() const; // 0D_NOT_logical [dispatch:9]
  void set_select(bool value);
  bool offset_moves_aperture() const; // 0D_NOT_logical [dispatch:10]
...
public:
  ...
  std::complex<double> coef() const; // 0D_NOT_complex [dispatch:0]
...
public:
  ...
  std::complex<double> ref() const; // 0D_NOT_complex [dispatch:0]
...
public:
  ...
  std::string name() const; // 0D_NOT_character
  void set_name(const std::string &value);
  int ix_branch() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_branch(int value);
  int ix_from_branch() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_from_branch(int value);
  int ix_from_ele() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_from_ele(int value);
  int ix_to_ele() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_to_ele(int value);
  int ix_fixer() const; // 0D_NOT_integer [dispatch:4]
  void set_ix_fixer(int value);
  int n_ele_track() const; // 0D_NOT_integer [dispatch:5]
  void set_n_ele_track(int value);
  int n_ele_max() const; // 0D_NOT_integer [dispatch:6]
...
public:
  ...
  explicit LatStruct(
      std::optional<std::string> use_name = std::nullopt,
      std::optional<std::string> lattice = std::nullopt,
      std::optional<std::string> machine = std::nullopt,
      std::optional<std::string> input_file_name = std::nullopt,
  ...
  void set_custom(const std::vector<double> &v);
  int version() const; // 0D_NOT_integer [dispatch:0]
  ...
  void set_n_ele_max(int value);
  int n_control_max() const; // 0D_NOT_integer [dispatch:1]
  void set_n_control_max(int value);
  int n_ic_max() const; // 0D_NOT_integer [dispatch:2]
  void set_n_ic_max(int value);
  int input_taylor_order() const; // 0D_NOT_integer [dispatch:3]
  void set_input_taylor_order(int value);
  IntAlloc1D ic() const; // 1D_ALLOC_integer
  void set_ic(const std::vector<int> &v);
  int photon_type() const; // 0D_NOT_integer [dispatch:4]
  void set_photon_type(int value);
  int creation_hash() const; // 0D_NOT_integer [dispatch:5]
...
public:
  ...
  double charge_tot() const; // 0D_NOT_real [dispatch:0]
  void set_charge_tot(double value);
  double charge_live() const; // 0D_NOT_real [dispatch:1]
  void set_charge_live(double value);
  double z_center() const; // 0D_NOT_real [dispatch:2]
  void set_z_center(double value);
  double t_center() const; // 0D_NOT_real [dispatch:3]
  void set_t_center(double value);
  double t0() const; // 0D_NOT_real [dispatch:4]
  void set_t0(double value);
  bool drift_between_t_and_s() const; // 0D_NOT_logical [dispatch:0]
  void set_drift_between_t_and_s(bool value);
  int ix_ele() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_ele(int value);
  int ix_bunch() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_bunch(int value);
  int ix_turn() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_turn(int value);
  int n_live() const; // 0D_NOT_integer [dispatch:3]
  void set_n_live(int value);
  int n_good() const; // 0D_NOT_integer [dispatch:4]
  void set_n_good(int value);
  int n_bad() const; // 0D_NOT_integer [dispatch:5]
  void set_n_bad(int value);
};
...
public:
  ...
  double s() const; // 0D_NOT_real [dispatch:0]
  void set_s(double value);
  double t() const; // 0D_NOT_real [dispatch:1]
  void set_t(double value);
  double sigma_t() const; // 0D_NOT_real [dispatch:2]
  void set_sigma_t(double value);
  double charge_live() const; // 0D_NOT_real [dispatch:3]
  void set_charge_live(double value);
  double charge_tot() const; // 0D_NOT_real [dispatch:4]
  void set_charge_tot(double value);
  int n_particle_tot() const; // 0D_NOT_integer [dispatch:0]
  void set_n_particle_tot(int value);
  int n_particle_live() const; // 0D_NOT_integer [dispatch:1]
  void set_n_particle_live(int value);
  int n_particle_lost_in_ele() const; // 0D_NOT_integer [dispatch:2]
  void set_n_particle_lost_in_ele(int value);
  int n_good_steps() const; // 0D_NOT_integer [dispatch:3]
  void set_n_good_steps(int value);
  int n_bad_steps() const; // 0D_NOT_integer [dispatch:4]
  void set_n_bad_steps(int value);
  int ix_ele() const; // 0D_NOT_integer [dispatch:5]
  void set_ix_ele(int value);
  int location() const; // 0D_NOT_integer [dispatch:6]
  void set_location(int value);
  bool twiss_valid() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  double y() const; // 0D_NOT_real [dispatch:1]
  void set_y(double value);
  int plane() const; // 0D_NOT_integer [dispatch:0]
  void set_plane(int value);
  int ix_ele() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_ele(int value);
  int i_turn() const; // 0D_NOT_integer [dispatch:2]
...
public:
  ...
  double max_angle() const; // 0D_NOT_real [dispatch:1]
  void set_max_angle(double value);
  int n_angle() const; // 0D_NOT_integer [dispatch:0]
  void set_n_angle(int value);
  int n_turn() const; // 0D_NOT_integer [dispatch:1]
  void set_n_turn(int value);
  double x_init() const; // 0D_NOT_real [dispatch:2]
  void set_x_init(double value);
  double y_init() const; // 0D_NOT_real [dispatch:3]
  void set_y_init(double value);
  double rel_accuracy() const; // 0D_NOT_real [dispatch:4]
  void set_rel_accuracy(double value);
  double abs_accuracy() const; // 0D_NOT_real [dispatch:5]
...
public:
  ...
  double pz_start() const; // 0D_NOT_real [dispatch:0]
...
public:
  ...
  int id() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  int n_min() const; // 0D_NOT_integer [dispatch:0]
  void set_n_min(int value);
  int n_max() const; // 0D_NOT_integer [dispatch:1]
...
public:
  ...
  std::complex<double> c_val() const; // 0D_NOT_complex [dispatch:0]
...
public:
  ...
  bool valid_map() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  std::complex<double> h11001() const; // 0D_NOT_complex [dispatch:0]
  void set_h11001(std::complex<double> value);
  std::complex<double> h00111() const; // 0D_NOT_complex [dispatch:1]
  void set_h00111(std::complex<double> value);
  std::complex<double> h20001() const; // 0D_NOT_complex [dispatch:2]
  void set_h20001(std::complex<double> value);
  std::complex<double> h00201() const; // 0D_NOT_complex [dispatch:3]
  void set_h00201(std::complex<double> value);
  std::complex<double> h10002() const; // 0D_NOT_complex [dispatch:4]
  void set_h10002(std::complex<double> value);
  std::complex<double> h21000() const; // 0D_NOT_complex [dispatch:5]
  void set_h21000(std::complex<double> value);
  std::complex<double> h30000() const; // 0D_NOT_complex [dispatch:6]
  void set_h30000(std::complex<double> value);
  std::complex<double> h10110() const; // 0D_NOT_complex [dispatch:7]
  void set_h10110(std::complex<double> value);
  std::complex<double> h10020() const; // 0D_NOT_complex [dispatch:8]
  void set_h10020(std::complex<double> value);
  std::complex<double> h10200() const; // 0D_NOT_complex [dispatch:9]
  void set_h10200(std::complex<double> value);
  std::complex<double> h31000() const; // 0D_NOT_complex [dispatch:10]
  void set_h31000(std::complex<double> value);
  std::complex<double> h40000() const; // 0D_NOT_complex [dispatch:11]
  void set_h40000(std::complex<double> value);
  std::complex<double> h20110() const; // 0D_NOT_complex [dispatch:12]
  void set_h20110(std::complex<double> value);
  std::complex<double> h11200() const; // 0D_NOT_complex [dispatch:13]
  void set_h11200(std::complex<double> value);
  std::complex<double> h20020() const; // 0D_NOT_complex [dispatch:14]
  void set_h20020(std::complex<double> value);
  std::complex<double> h20200() const; // 0D_NOT_complex [dispatch:15]
  void set_h20200(std::complex<double> value);
  std::complex<double> h00310() const; // 0D_NOT_complex [dispatch:16]
  void set_h00310(std::complex<double> value);
  std::complex<double> h00400() const; // 0D_NOT_complex [dispatch:17]
  void set_h00400(std::complex<double> value);
  std::complex<double> h22000() const; // 0D_NOT_complex [dispatch:18]
  void set_h22000(std::complex<double> value);
  std::complex<double> h00220() const; // 0D_NOT_complex [dispatch:19]
  void set_h00220(std::complex<double> value);
  std::complex<double> h11110() const; // 0D_NOT_complex [dispatch:20]
...
public:
  ...
  explicit TaoEleShapeStruct(
      std::optional<std::string> ele_id = std::nullopt,
      std::optional<std::string> shape = std::nullopt,
      ...
      std::optional<std::string> name_ele = std::nullopt
  )
      : FortranProxy() {
    if (ele_id)
      set_ele_id(*ele_id);
  ...
  double size() const; // 0D_NOT_real [dispatch:0]
  void set_size(double value);
  std::string label() const; // 0D_NOT_character
  void set_label(const std::string &value);
  bool draw() const; // 0D_NOT_logical [dispatch:0]
  void set_draw(bool value);
  bool multi() const; // 0D_NOT_logical [dispatch:1]
  void set_multi(bool value);
  int line_width() const; // 0D_NOT_integer [dispatch:0]
  void set_line_width(int value);
  double offset() const; // 0D_NOT_real [dispatch:1]
  void set_offset(double value);
  int ix_key() const; // 0D_NOT_integer [dispatch:1]
...
public:
  ...
  int n_loc() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  explicit TaoCurveStruct(
      std::optional<std::string> name = std::nullopt,
      std::optional<std::string> data_source = std::nullopt,
      std::optional<std::string> data_index = std::nullopt,
      std::optional<std::string> data_type_x = std::nullopt,
      std::optional<std::string> data_type = std::nullopt,
      std::optional<std::string> ele_ref_name = std::nullopt,
      std::optional<std::string> legend_text = std::nullopt,
    ...
    if (data_index)
      set_data_index(*data_index);
    if (data_type_x)
      set_data_type_x(*data_type_x);
    if (data_type)
      set_data_type(*data_type);
    if (ele_ref_name)
      set_ele_ref_name(*ele_ref_name);
    if (legend_text)
  ...
  double y_axis_scale_factor() const; // 0D_NOT_real [dispatch:0]
  ...
  int ix_universe() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_universe(int value);
  int symbol_every() const; // 0D_NOT_integer [dispatch:1]
  void set_symbol_every(int value);
  int ix_branch() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_branch(int value);
  int ix_bunch() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_bunch(int value);
  int n_turn() const; // 0D_NOT_integer [dispatch:4]
  void set_n_turn(int value);
  bool use_y2() const; // 0D_NOT_logical [dispatch:0]
  void set_use_y2(bool value);
  bool draw_line() const; // 0D_NOT_logical [dispatch:1]
  void set_draw_line(bool value);
  bool draw_symbols() const; // 0D_NOT_logical [dispatch:2]
  void set_draw_symbols(bool value);
  bool draw_symbol_index() const; // 0D_NOT_logical [dispatch:3]
  void set_draw_symbol_index(bool value);
  bool draw_error_bars() const; // 0D_NOT_logical [dispatch:4]
  void set_draw_error_bars(bool value);
  bool smooth_line_calc() const; // 0D_NOT_logical [dispatch:5]
  void set_smooth_line_calc(bool value);
  bool valid() const; // 0D_NOT_logical [dispatch:6]
...
public:
  ...
  void set_data_type(const std::string &value);
  bool is_on() const; // 0D_NOT_logical [dispatch:0]
  void set_is_on(bool value);
  double min() const; // 0D_NOT_real [dispatch:0]
  void set_min(double value);
  double max() const; // 0D_NOT_real [dispatch:1]
  void set_max(double value);
  bool autoscale() const; // 0D_NOT_logical [dispatch:1]
...
public:
  ...
  double y() const; // 0D_NOT_real [dispatch:1]
  void set_y(double value);
  double t() const; // 0D_NOT_real [dispatch:2]
  void set_t(double value);
};
...
public:
  ...
  bool density_normalized() const; // 0D_NOT_logical [dispatch:0]
  void set_density_normalized(bool value);
  bool weight_by_charge() const; // 0D_NOT_logical [dispatch:1]
  void set_weight_by_charge(bool value);
  double minimum() const; // 0D_NOT_real [dispatch:0]
  void set_minimum(double value);
  double maximum() const; // 0D_NOT_real [dispatch:1]
  void set_maximum(double value);
  double width() const; // 0D_NOT_real [dispatch:2]
  void set_width(double value);
  double center() const; // 0D_NOT_real [dispatch:3]
  void set_center(double value);
  int number() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  int ix_branch() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_branch(int value);
  int ix_order() const; // 0D_NOT_integer [dispatch:1]
...
public:
  ...
  bool valid() const; // 0D_NOT_logical [dispatch:0]
  void set_valid(bool value);
};
...
public:
  ...
  bool err() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  double tune() const; // 0D_NOT_real [dispatch:0]
  void set_tune(double value);
  double pol_limit_st() const; // 0D_NOT_real [dispatch:1]
  void set_pol_limit_st(double value);
  double pol_limit_dk() const; // 0D_NOT_real [dispatch:2]
  ...
  double pol_rate_bks() const; // 0D_NOT_real [dispatch:3]
  void set_pol_rate_bks(double value);
  double depol_rate() const; // 0D_NOT_real [dispatch:4]
  ...
  double integral_bn() const; // 0D_NOT_real [dispatch:5]
  void set_integral_bn(double value);
  double integral_bdn() const; // 0D_NOT_real [dispatch:6]
  void set_integral_bdn(double value);
  double integral_1ns() const; // 0D_NOT_real [dispatch:7]
  void set_integral_1ns(double value);
  double integral_dn2() const; // 0D_NOT_real [dispatch:8]
...
public:
  ...
  double cache_x_min() const; // 0D_NOT_real [dispatch:0]
  void set_cache_x_min(double value);
  double cache_x_max() const; // 0D_NOT_real [dispatch:1]
  void set_cache_x_max(double value);
  double comb_ds_save() const; // 0D_NOT_real [dispatch:2]
  void set_comb_ds_save(double value);
  int ix_ref_taylor() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_ref_taylor(int value);
  int ix_ele_taylor() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_ele_taylor(int value);
  int track_state() const; // 0D_NOT_integer [dispatch:2]
  void set_track_state(int value);
  int cache_n_pts() const; // 0D_NOT_integer [dispatch:3]
  void set_cache_n_pts(int value);
  int ix_rad_int_cache() const; // 0D_NOT_integer [dispatch:4]
  void set_ix_rad_int_cache(int value);
  bool has_open_match_element() const; // 0D_NOT_logical [dispatch:0]
  void set_has_open_match_element(bool value);
  bool plot_cache_valid() const; // 0D_NOT_logical [dispatch:1]
  void set_plot_cache_valid(bool value);
  bool spin_map_valid() const; // 0D_NOT_logical [dispatch:2]
  void set_spin_map_valid(bool value);
  bool twiss_valid() const; // 0D_NOT_logical [dispatch:3]
  void set_twiss_valid(bool value);
  bool mode_flip_here() const; // 0D_NOT_logical [dispatch:4]
  void set_mode_flip_here(bool value);
  bool chrom_calc_ok() const; // 0D_NOT_logical [dispatch:5]
  void set_chrom_calc_ok(bool value);
  bool rad_int_calc_ok() const; // 0D_NOT_logical [dispatch:6]
  void set_rad_int_calc_ok(bool value);
  bool emit_6d_calc_ok() const; // 0D_NOT_logical [dispatch:7]
  void set_emit_6d_calc_ok(bool value);
  bool sigma_track_ok() const; // 0D_NOT_logical [dispatch:8]
...
public:
  ...
  bool save_beam_internally() const; // 0D_NOT_logical [dispatch:0]
  void set_save_beam_internally(bool value);
  bool save_beam_to_file() const; // 0D_NOT_logical [dispatch:1]
...
public:
  ...
  explicit TaoBeamBranchStruct(
      ...
      std::optional<std::string> track_start = std::nullopt,
      std::optional<std::string> track_end = std::nullopt,
      std::optional<int> ix_branch = std::nullopt,
  ...
  bool init_starting_distribution() const; // 0D_NOT_logical [dispatch:0]
  ...
  int ix_branch() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_branch(int value);
  int ix_track_start() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_track_start(int value);
  int ix_track_end() const; // 0D_NOT_integer [dispatch:2]
...
public:
  ...
  explicit TaoD2DataStruct(
      std::optional<std::string> name = std::nullopt,
      std::optional<std::string> data_file_name = std::nullopt,
      std::optional<std::string> ref_file_name = std::nullopt,
      std::optional<std::string> data_date = std::nullopt,
      std::optional<std::string> ref_date = std::nullopt,
      std::optional<int> ix_universe = std::nullopt,
    ...
    if (ref_file_name)
      set_ref_file_name(*ref_file_name);
    if (data_date)
      set_data_date(*data_date);
    if (ref_date)
      set_ref_date(*ref_date);
    if (ix_universe)
      set_ix_universe(*ix_universe);
    if (ix_d2_data)
  ...
  int ix_universe() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_universe(int value);
  int ix_d2_data() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_d2_data(int value);
  int ix_ref() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_ref(int value);
  bool data_read_in() const; // 0D_NOT_logical [dispatch:0]
  void set_data_read_in(bool value);
  bool ref_read_in() const; // 0D_NOT_logical [dispatch:1]
...
public:
  ...
  std::string name() const; // 0D_NOT_character
  void set_name(const std::string &value);
  double sign() const; // 0D_NOT_real [dispatch:0]
...
public:
  ...
  explicit TaoGraphStruct(
      ...
      std::optional<std::string> type = std::nullopt,
      std::optional<std::string> title = std::nullopt,
      std::optional<std::string> title_suffix = std::nullopt,
      std::optional<std::string> why_invalid = std::nullopt,
  ...
  double x_axis_scale_factor() const; // 0D_NOT_real [dispatch:0]
  void set_x_axis_scale_factor(double value);
  double symbol_size_scale() const; // 0D_NOT_real [dispatch:1]
  void set_symbol_size_scale(double value);
  FArray1D<int> box() const; // 1D_NOT_integer
  void set_box(const std::vector<int> &v);
  int ix_branch() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_branch(int value);
  int ix_universe() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_universe(int value);
  bool clip() const; // 0D_NOT_logical [dispatch:0]
  void set_clip(bool value);
  bool y2_mirrors_y() const; // 0D_NOT_logical [dispatch:1]
  void set_y2_mirrors_y(bool value);
  bool limited() const; // 0D_NOT_logical [dispatch:2]
  void set_limited(bool value);
  bool draw_axes() const; // 0D_NOT_logical [dispatch:3]
  void set_draw_axes(bool value);
  bool draw_curve_legend() const; // 0D_NOT_logical [dispatch:4]
  void set_draw_curve_legend(bool value);
  bool draw_grid() const; // 0D_NOT_logical [dispatch:5]
  void set_draw_grid(bool value);
  bool draw_title() const; // 0D_NOT_logical [dispatch:6]
  void set_draw_title(bool value);
  bool draw_only_good_user_data_or_vars() const; // 0D_NOT_logical [dispatch:7]
  void set_draw_only_good_user_data_or_vars(bool value);
  bool allow_wrap_around() const; // 0D_NOT_logical [dispatch:8]
  void set_allow_wrap_around(bool value);
  bool is_valid() const; // 0D_NOT_logical [dispatch:9]
...
public:
  ...
  explicit TaoPlotStruct(
      ...
      std::optional<std::string> type = std::nullopt,
      std::optional<std::string> x_axis_type = std::nullopt,
  ...
  int ix_plot() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_plot(int value);
  int n_curve_pts() const; // 0D_NOT_integer [dispatch:1]
  void set_n_curve_pts(int value);
  std::string type() const; // 0D_NOT_character
  void set_type(const std::string &value);
  std::string x_axis_type() const; // 0D_NOT_character
  void set_x_axis_type(const std::string &value);
  bool autoscale_x() const; // 0D_NOT_logical [dispatch:0]
  void set_autoscale_x(bool value);
  bool autoscale_y() const; // 0D_NOT_logical [dispatch:1]
  void set_autoscale_y(bool value);
  bool autoscale_gang_x() const; // 0D_NOT_logical [dispatch:2]
  void set_autoscale_gang_x(bool value);
  bool autoscale_gang_y() const; // 0D_NOT_logical [dispatch:3]
  void set_autoscale_gang_y(bool value);
  bool list_with_show_plot_command() const; // 0D_NOT_logical [dispatch:4]
  void set_list_with_show_plot_command(bool value);
  bool phantom() const; // 0D_NOT_logical [dispatch:5]
  void set_phantom(bool value);
  bool default_plot() const; // 0D_NOT_logical [dispatch:6]
...
public:
  ...
  bool visible() const; // 0D_NOT_logical [dispatch:0]
  void set_visible(bool value);
  bool list_with_show_plot_command() const; // 0D_NOT_logical [dispatch:1]
  void set_list_with_show_plot_command(bool value);
  bool setup_done() const; // 0D_NOT_logical [dispatch:2]
...
public:
  ...
  int n_var_used() const; // 0D_NOT_integer [dispatch:0]
  void set_n_var_used(int value);
  int n_v1_var_used() const; // 0D_NOT_integer [dispatch:1]
  void set_n_v1_var_used(int value);
  TaoCmdHistoryStructArray1D history() const; // 1D_NOT_type
  bool initialized() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  explicit TaoVarStruct(
      ...
      std::optional<std::string> merit_type = std::nullopt,
  ...
  int ix_v1() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_v1(int value);
  int ix_var() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_var(int value);
  int ix_dvar() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_dvar(int value);
  int ix_attrib() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_attrib(int value);
  int ix_key_table() const; // 0D_NOT_integer [dispatch:4]
  ...
  double design_value() const; // 0D_NOT_real [dispatch:0]
  void set_design_value(double value);
  double scratch_value() const; // 0D_NOT_real [dispatch:1]
  void set_scratch_value(double value);
  double old_value() const; // 0D_NOT_real [dispatch:2]
  void set_old_value(double value);
  double meas_value() const; // 0D_NOT_real [dispatch:3]
  void set_meas_value(double value);
  double ref_value() const; // 0D_NOT_real [dispatch:4]
  void set_ref_value(double value);
  double correction_value() const; // 0D_NOT_real [dispatch:5]
  void set_correction_value(double value);
  double high_lim() const; // 0D_NOT_real [dispatch:6]
  void set_high_lim(double value);
  double low_lim() const; // 0D_NOT_real [dispatch:7]
  void set_low_lim(double value);
  double step() const; // 0D_NOT_real [dispatch:8]
  void set_step(double value);
  double weight() const; // 0D_NOT_real [dispatch:9]
  void set_weight(double value);
  double delta_merit() const; // 0D_NOT_real [dispatch:10]
  void set_delta_merit(double value);
  double merit() const; // 0D_NOT_real [dispatch:11]
  void set_merit(double value);
  double dMerit_dVar() const; // 0D_NOT_real [dispatch:12]
  void set_dMerit_dVar(double value);
  double key_val0() const; // 0D_NOT_real [dispatch:13]
  void set_key_val0(double value);
  double key_delta() const; // 0D_NOT_real [dispatch:14]
  void set_key_delta(double value);
  double s() const; // 0D_NOT_real [dispatch:15]
  void set_s(double value);
  double extend_val() const; // 0D_NOT_real [dispatch:16]
  void set_extend_val(double value);
  std::string merit_type() const; // 0D_NOT_character
  void set_merit_type(const std::string &value);
  bool exists() const; // 0D_NOT_logical [dispatch:0]
  void set_exists(bool value);
  bool good_var() const; // 0D_NOT_logical [dispatch:1]
  void set_good_var(bool value);
  bool good_user() const; // 0D_NOT_logical [dispatch:2]
  void set_good_user(bool value);
  bool good_opt() const; // 0D_NOT_logical [dispatch:3]
  void set_good_opt(bool value);
  bool good_plot() const; // 0D_NOT_logical [dispatch:4]
  void set_good_plot(bool value);
  bool useit_opt() const; // 0D_NOT_logical [dispatch:5]
  void set_useit_opt(bool value);
  bool useit_plot() const; // 0D_NOT_logical [dispatch:6]
  void set_useit_plot(bool value);
  bool key_bound() const; // 0D_NOT_logical [dispatch:7]
...
public:
  ...
  int ix_uni() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  explicit TaoBeamUniStruct(
      std::optional<std::string> saved_at = std::nullopt,
      std::optional<std::string> dump_file = std::nullopt,
      std::optional<std::string> dump_at = std::nullopt,
      std::optional<bool> track_beam_in_universe = std::nullopt,
      std::optional<bool> always_reinit = std::nullopt
  )
      : FortranProxy() {
    if (saved_at)
      set_saved_at(*saved_at);
    if (dump_file)
  ...
  bool track_beam_in_universe() const; // 0D_NOT_logical [dispatch:0]
  void set_track_beam_in_universe(bool value);
  bool always_reinit() const; // 0D_NOT_logical [dispatch:1]
...
public:
  ...
  double ellipse_scale() const; // 0D_NOT_real [dispatch:0]
  void set_ellipse_scale(double value);
  double a_emit() const; // 0D_NOT_real [dispatch:1]
  void set_a_emit(double value);
  double b_emit() const; // 0D_NOT_real [dispatch:2]
  void set_b_emit(double value);
};
...
public:
  ...
  int ix_ele() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_ele(int value);
  int ix_ref() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_ref(int value);
  int ix_uni() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_uni(int value);
  int ix_branch() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_branch(int value);
...
public:
  ...
  explicit TaoDataStruct(
      std::optional<std::string> ele_name = std::nullopt,
      std::optional<std::string> ele_start_name = std::nullopt,
      std::optional<std::string> ele_ref_name = std::nullopt,
      std::optional<std::string> data_type = std::nullopt,
      std::optional<std::string> merit_type = std::nullopt,
      std::optional<std::string> id = std::nullopt,
    ...
    if (ele_name)
      set_ele_name(*ele_name);
    if (ele_start_name)
      set_ele_start_name(*ele_start_name);
    if (ele_ref_name)
      set_ele_ref_name(*ele_ref_name);
    if (data_type)
      set_data_type(*data_type);
  ...
  int ix_branch() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_branch(int value);
  int ix_ele() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_ele(int value);
  int ix_ele_start() const; // 0D_NOT_integer [dispatch:4]
  void set_ix_ele_start(int value);
  int ix_ele_ref() const; // 0D_NOT_integer [dispatch:5]
  void set_ix_ele_ref(int value);
  int ix_ele_merit() const; // 0D_NOT_integer [dispatch:6]
  void set_ix_ele_merit(int value);
  int ix_d1() const; // 0D_NOT_integer [dispatch:7]
  void set_ix_d1(int value);
  int ix_data() const; // 0D_NOT_integer [dispatch:8]
  void set_ix_data(int value);
  int ix_dModel() const; // 0D_NOT_integer [dispatch:9]
  void set_ix_dModel(int value);
  int eval_point() const; // 0D_NOT_integer [dispatch:10]
  void set_eval_point(int value);
  double meas_value() const; // 0D_NOT_real [dispatch:0]
  void set_meas_value(double value);
  double ref_value() const; // 0D_NOT_real [dispatch:1]
  void set_ref_value(double value);
  double model_value() const; // 0D_NOT_real [dispatch:2]
  void set_model_value(double value);
  double design_value() const; // 0D_NOT_real [dispatch:3]
  void set_design_value(double value);
  double old_value() const; // 0D_NOT_real [dispatch:4]
  void set_old_value(double value);
  double base_value() const; // 0D_NOT_real [dispatch:5]
  void set_base_value(double value);
  double error_rms() const; // 0D_NOT_real [dispatch:6]
  void set_error_rms(double value);
  double delta_merit() const; // 0D_NOT_real [dispatch:7]
  void set_delta_merit(double value);
  double weight() const; // 0D_NOT_real [dispatch:8]
  void set_weight(double value);
  double invalid_value() const; // 0D_NOT_real [dispatch:9]
  void set_invalid_value(double value);
  double merit() const; // 0D_NOT_real [dispatch:10]
  void set_merit(double value);
  double s() const; // 0D_NOT_real [dispatch:11]
  void set_s(double value);
  double s_offset() const; // 0D_NOT_real [dispatch:12]
  void set_s_offset(double value);
  double ref_s_offset() const; // 0D_NOT_real [dispatch:13]
  void set_ref_s_offset(double value);
  bool err_message_printed() const; // 0D_NOT_logical [dispatch:0]
  void set_err_message_printed(bool value);
  bool exists() const; // 0D_NOT_logical [dispatch:1]
  void set_exists(bool value);
  bool good_model() const; // 0D_NOT_logical [dispatch:2]
  void set_good_model(bool value);
  bool good_base() const; // 0D_NOT_logical [dispatch:3]
  void set_good_base(bool value);
  bool good_design() const; // 0D_NOT_logical [dispatch:4]
  void set_good_design(bool value);
  bool good_meas() const; // 0D_NOT_logical [dispatch:5]
  void set_good_meas(bool value);
  bool good_ref() const; // 0D_NOT_logical [dispatch:6]
  void set_good_ref(bool value);
  bool good_user() const; // 0D_NOT_logical [dispatch:7]
  void set_good_user(bool value);
  bool good_opt() const; // 0D_NOT_logical [dispatch:8]
  void set_good_opt(bool value);
  bool good_plot() const; // 0D_NOT_logical [dispatch:9]
  void set_good_plot(bool value);
  bool useit_plot() const; // 0D_NOT_logical [dispatch:10]
  void set_useit_plot(bool value);
  bool useit_opt() const; // 0D_NOT_logical [dispatch:11]
  void set_useit_opt(bool value);
...
public:
  ...
  double a_mode_meas() const; // 0D_NOT_real [dispatch:0]
  void set_a_mode_meas(double value);
  double a_mode_ref() const; // 0D_NOT_real [dispatch:1]
  void set_a_mode_ref(double value);
  double b_mode_meas() const; // 0D_NOT_real [dispatch:2]
  void set_b_mode_meas(double value);
  double b_mode_ref() const; // 0D_NOT_real [dispatch:3]
...
public:
  ...
  int srdt_for_data() const; // 0D_NOT_integer [dispatch:0]
  void set_srdt_for_data(int value);
  bool rad_int_for_data() const; // 0D_NOT_logical [dispatch:0]
  void set_rad_int_for_data(bool value);
  bool rad_int_for_plotting() const; // 0D_NOT_logical [dispatch:1]
  void set_rad_int_for_plotting(bool value);
  bool chrom_for_data() const; // 0D_NOT_logical [dispatch:2]
  void set_chrom_for_data(bool value);
  bool chrom_for_plotting() const; // 0D_NOT_logical [dispatch:3]
  void set_chrom_for_plotting(bool value);
  bool lat_sigma_for_data() const; // 0D_NOT_logical [dispatch:4]
  void set_lat_sigma_for_data(bool value);
  bool lat_sigma_for_plotting() const; // 0D_NOT_logical [dispatch:5]
  void set_lat_sigma_for_plotting(bool value);
  bool dynamic_aperture() const; // 0D_NOT_logical [dispatch:6]
  void set_dynamic_aperture(bool value);
  bool one_turn_map() const; // 0D_NOT_logical [dispatch:7]
  void set_one_turn_map(bool value);
  bool lattice() const; // 0D_NOT_logical [dispatch:8]
  void set_lattice(bool value);
  bool twiss() const; // 0D_NOT_logical [dispatch:9]
  void set_twiss(bool value);
  bool track() const; // 0D_NOT_logical [dispatch:10]
  void set_track(bool value);
  bool spin_matrices() const; // 0D_NOT_logical [dispatch:11]
...
public:
  ...
  bool good() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  std::string name() const; // 0D_NOT_character
  void set_name(const std::string &value);
  double scale() const; // 0D_NOT_real [dispatch:0]
  void set_scale(double value);
...
public:
  ...
  explicit TaoTitleStruct(
      ...
      std::optional<std::string> justify = std::nullopt,
  ...
  bool draw_it() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  double x1() const; // 0D_NOT_real [dispatch:0]
  void set_x1(double value);
  double x2() const; // 0D_NOT_real [dispatch:1]
  void set_x2(double value);
  double y1() const; // 0D_NOT_real [dispatch:2]
  void set_y1(double value);
  double y2() const; // 0D_NOT_real [dispatch:3]
...
public:
  ...
  double y() const; // 0D_NOT_real [dispatch:1]
  void set_y(double value);
  double radius() const; // 0D_NOT_real [dispatch:2]
...
public:
  ...
  explicit QpAxisStruct(
      ...
      std::optional<std::string> label_color = std::nullopt,
  ...
  double max() const; // 0D_NOT_real [dispatch:1]
  void set_max(double value);
  double tick_min() const; // 0D_NOT_real [dispatch:2]
  void set_tick_min(double value);
  double tick_max() const; // 0D_NOT_real [dispatch:3]
  void set_tick_max(double value);
  double eval_min() const; // 0D_NOT_real [dispatch:4]
  void set_eval_min(double value);
  double eval_max() const; // 0D_NOT_real [dispatch:5]
  void set_eval_max(double value);
  double dtick() const; // 0D_NOT_real [dispatch:6]
  void set_dtick(double value);
  double number_offset() const; // 0D_NOT_real [dispatch:7]
  void set_number_offset(double value);
  double label_offset() const; // 0D_NOT_real [dispatch:8]
  void set_label_offset(double value);
  double major_tick_len() const; // 0D_NOT_real [dispatch:9]
  void set_major_tick_len(double value);
  double minor_tick_len() const; // 0D_NOT_real [dispatch:10]
  ...
  int major_div() const; // 0D_NOT_integer [dispatch:0]
  void set_major_div(int value);
  int major_div_nominal() const; // 0D_NOT_integer [dispatch:1]
  void set_major_div_nominal(int value);
  int minor_div() const; // 0D_NOT_integer [dispatch:2]
  void set_minor_div(int value);
  int minor_div_max() const; // 0D_NOT_integer [dispatch:3]
  void set_minor_div_max(int value);
  int places() const; // 0D_NOT_integer [dispatch:4]
  void set_places(int value);
  std::string type() const; // 0D_NOT_character
  void set_type(const std::string &value);
  std::string bounds() const; // 0D_NOT_character
  void set_bounds(const std::string &value);
  int tick_side() const; // 0D_NOT_integer [dispatch:5]
  void set_tick_side(int value);
  int number_side() const; // 0D_NOT_integer [dispatch:6]
  void set_number_side(int value);
  bool draw_label() const; // 0D_NOT_logical [dispatch:0]
  void set_draw_label(bool value);
  bool draw_numbers() const; // 0D_NOT_logical [dispatch:1]
...
public:
  ...
  double row_spacing() const; // 0D_NOT_real [dispatch:0]
  void set_row_spacing(double value);
  double line_length() const; // 0D_NOT_real [dispatch:1]
  void set_line_length(double value);
  double text_offset() const; // 0D_NOT_real [dispatch:2]
  void set_text_offset(double value);
  bool draw_line() const; // 0D_NOT_logical [dispatch:0]
  void set_draw_line(bool value);
  bool draw_symbol() const; // 0D_NOT_logical [dispatch:1]
  void set_draw_symbol(bool value);
  bool draw_text() const; // 0D_NOT_logical [dispatch:2]
...
public:
  ...
  int width() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  explicit QpSymbolStruct(
      ...
      std::optional<std::string> color = std::nullopt,
      std::optional<std::string> fill_pattern = std::nullopt,
      std::optional<int> line_width = std::nullopt
  )
      : FortranProxy() {
    if (type)
  ...
  std::string type() const; // 0D_NOT_character
  void set_type(const std::string &value);
  double height() const; // 0D_NOT_real [dispatch:0]
...
public:
  ...
  explicit TaoFloorPlanStruct(
      std::optional<std::string> view = std::nullopt,
      ...
      std::optional<std::string> orbit_color = std::nullopt,
      std::optional<std::string> orbit_pattern = std::nullopt,
      std::optional<std::string> orbit_lattice = std::nullopt,
    ...
    if (orbit_color)
      set_orbit_color(*orbit_color);
    if (orbit_pattern)
      set_orbit_pattern(*orbit_pattern);
    if (orbit_lattice)
      set_orbit_lattice(*orbit_lattice);
    if (orbit_width)
  ...
  double rotation() const; // 0D_NOT_real [dispatch:0]
  void set_rotation(double value);
  bool correct_distortion() const; // 0D_NOT_logical [dispatch:0]
  void set_correct_distortion(bool value);
  bool flip_label_side() const; // 0D_NOT_logical [dispatch:1]
  void set_flip_label_side(bool value);
  bool size_is_absolute() const; // 0D_NOT_logical [dispatch:2]
  void set_size_is_absolute(bool value);
  bool draw_only_first_pass() const; // 0D_NOT_logical [dispatch:3]
  void set_draw_only_first_pass(bool value);
  bool draw_building_wall() const; // 0D_NOT_logical [dispatch:4]
  void set_draw_building_wall(bool value);
  double orbit_scale() const; // 0D_NOT_real [dispatch:1]
  ...
  int orbit_width() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  std::string name() const; // 0D_NOT_character
  void set_name(const std::string &value);
  int ix_v1_var() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  explicit TaoGlobalStruct(
      ...
      std::optional<std::string> quiet = std::nullopt,
      std::optional<std::string> random_engine = std::nullopt,
      std::optional<std::string> random_gauss_converter = std::nullopt,
      std::optional<std::string> track_type = std::nullopt,
      std::optional<std::string> lat_sigma_calc_uses_emit_from = std::nullopt,
      std::optional<std::string> prompt_string = std::nullopt,
      std::optional<std::string> prompt_color = std::nullopt,
      std::optional<std::string> optimizer = std::nullopt,
      std::optional<std::string> print_command = std::nullopt,
      std::optional<std::string> var_out_file = std::nullopt,
    ...
    if (lat_sigma_calc_uses_emit_from)
      set_lat_sigma_calc_uses_emit_from(*lat_sigma_calc_uses_emit_from);
    if (prompt_string)
      set_prompt_string(*prompt_string);
    if (prompt_color)
      set_prompt_color(*prompt_color);
    if (optimizer)
      set_optimizer(*optimizer);
    if (print_command)
      set_print_command(*print_command);
    if (var_out_file)
      set_var_out_file(*var_out_file);
    if (history_file)
  ...
  double beam_dead_cutoff() const; // 0D_NOT_real [dispatch:0]
  void set_beam_dead_cutoff(double value);
  double lm_opt_deriv_reinit() const; // 0D_NOT_real [dispatch:1]
  void set_lm_opt_deriv_reinit(double value);
  double de_lm_step_ratio() const; // 0D_NOT_real [dispatch:2]
  void set_de_lm_step_ratio(double value);
  double de_var_to_population_factor() const; // 0D_NOT_real [dispatch:3]
  void set_de_var_to_population_factor(double value);
  double lmdif_eps() const; // 0D_NOT_real [dispatch:4]
  void set_lmdif_eps(double value);
  double lmdif_negligible_merit() const; // 0D_NOT_real [dispatch:5]
  void set_lmdif_negligible_merit(double value);
  double svd_cutoff() const; // 0D_NOT_real [dispatch:6]
  void set_svd_cutoff(double value);
  double unstable_penalty() const; // 0D_NOT_real [dispatch:7]
  void set_unstable_penalty(double value);
  double merit_stop_value() const; // 0D_NOT_real [dispatch:8]
  void set_merit_stop_value(double value);
  double dmerit_stop_value() const; // 0D_NOT_real [dispatch:9]
  void set_dmerit_stop_value(double value);
  double random_sigma_cutoff() const; // 0D_NOT_real [dispatch:10]
  void set_random_sigma_cutoff(double value);
  double delta_e_chrom() const; // 0D_NOT_real [dispatch:11]
  void set_delta_e_chrom(double value);
  double max_plot_time() const; // 0D_NOT_real [dispatch:12]
  void set_max_plot_time(double value);
  int default_universe() const; // 0D_NOT_integer [dispatch:0]
  void set_default_universe(int value);
  int default_branch() const; // 0D_NOT_integer [dispatch:1]
  void set_default_branch(int value);
  int n_opti_cycles() const; // 0D_NOT_integer [dispatch:2]
  void set_n_opti_cycles(int value);
  int n_opti_loops() const; // 0D_NOT_integer [dispatch:3]
  void set_n_opti_loops(int value);
  int n_threads() const; // 0D_NOT_integer [dispatch:4]
  void set_n_threads(int value);
  int phase_units() const; // 0D_NOT_integer [dispatch:5]
  void set_phase_units(int value);
  int bunch_to_plot() const; // 0D_NOT_integer [dispatch:6]
  void set_bunch_to_plot(int value);
  int random_seed() const; // 0D_NOT_integer [dispatch:7]
  void set_random_seed(int value);
  int n_top10_merit() const; // 0D_NOT_integer [dispatch:8]
  void set_n_top10_merit(int value);
  int srdt_gen_n_slices() const; // 0D_NOT_integer [dispatch:9]
  void set_srdt_gen_n_slices(int value);
  int datum_err_messages_max() const; // 0D_NOT_integer [dispatch:10]
  void set_datum_err_messages_max(int value);
  int srdt_sxt_n_slices() const; // 0D_NOT_integer [dispatch:11]
  void set_srdt_sxt_n_slices(int value);
  bool srdt_use_cache() const; // 0D_NOT_logical [dispatch:0]
  ...
  bool beam_timer_on() const; // 0D_NOT_logical [dispatch:1]
  void set_beam_timer_on(bool value);
  bool box_plots() const; // 0D_NOT_logical [dispatch:2]
  void set_box_plots(bool value);
  bool blank_line_between_commands() const; // 0D_NOT_logical [dispatch:3]
  void set_blank_line_between_commands(bool value);
  bool cmd_file_abort_on_error() const; // 0D_NOT_logical [dispatch:4]
  void set_cmd_file_abort_on_error(bool value);
  bool concatenate_maps() const; // 0D_NOT_logical [dispatch:5]
  void set_concatenate_maps(bool value);
  bool derivative_recalc() const; // 0D_NOT_logical [dispatch:6]
  void set_derivative_recalc(bool value);
  bool derivative_uses_design() const; // 0D_NOT_logical [dispatch:7]
  void set_derivative_uses_design(bool value);
  bool disable_smooth_line_calc() const; // 0D_NOT_logical [dispatch:8]
  void set_disable_smooth_line_calc(bool value);
  bool draw_curve_off_scale_warn() const; // 0D_NOT_logical [dispatch:9]
  void set_draw_curve_off_scale_warn(bool value);
  bool external_plotting() const; // 0D_NOT_logical [dispatch:10]
  void set_external_plotting(bool value);
  bool label_lattice_elements() const; // 0D_NOT_logical [dispatch:11]
  void set_label_lattice_elements(bool value);
  bool label_keys() const; // 0D_NOT_logical [dispatch:12]
  void set_label_keys(bool value);
  bool lattice_calc_on() const; // 0D_NOT_logical [dispatch:13]
  void set_lattice_calc_on(bool value);
  bool only_limit_opt_vars() const; // 0D_NOT_logical [dispatch:14]
  void set_only_limit_opt_vars(bool value);
  bool opt_with_ref() const; // 0D_NOT_logical [dispatch:15]
  void set_opt_with_ref(bool value);
  bool opt_with_base() const; // 0D_NOT_logical [dispatch:16]
  void set_opt_with_base(bool value);
  bool opt_match_auto_recalc() const; // 0D_NOT_logical [dispatch:17]
  void set_opt_match_auto_recalc(bool value);
  bool opti_write_var_file() const; // 0D_NOT_logical [dispatch:18]
  void set_opti_write_var_file(bool value);
  bool optimizer_allow_user_abort() const; // 0D_NOT_logical [dispatch:19]
  void set_optimizer_allow_user_abort(bool value);
  bool optimizer_var_limit_warn() const; // 0D_NOT_logical [dispatch:20]
  void set_optimizer_var_limit_warn(bool value);
  bool plot_on() const; // 0D_NOT_logical [dispatch:21]
  void set_plot_on(bool value);
  bool rad_int_user_calc_on() const; // 0D_NOT_logical [dispatch:22]
  void set_rad_int_user_calc_on(bool value);
  bool rf_on() const; // 0D_NOT_logical [dispatch:23]
  void set_rf_on(bool value);
  bool single_step() const; // 0D_NOT_logical [dispatch:24]
  void set_single_step(bool value);
  bool stop_on_error() const; // 0D_NOT_logical [dispatch:25]
  void set_stop_on_error(bool value);
  bool svd_retreat_on_merit_increase() const; // 0D_NOT_logical [dispatch:26]
  void set_svd_retreat_on_merit_increase(bool value);
  bool var_limits_on() const; // 0D_NOT_logical [dispatch:27]
  void set_var_limits_on(bool value);
  bool wait_for_CR_in_single_mode() const; // 0D_NOT_logical [dispatch:28]
  void set_wait_for_CR_in_single_mode(bool value);
  bool symbol_import() const; // 0D_NOT_logical [dispatch:29]
  void set_symbol_import(bool value);
  bool debug_on() const; // 0D_NOT_logical [dispatch:30]
  void set_debug_on(bool value);
  bool expression_tree_on() const; // 0D_NOT_logical [dispatch:31]
  void set_expression_tree_on(bool value);
  bool verbose_on() const; // 0D_NOT_logical [dispatch:32]
...
public:
  ...
  explicit TaoInitStruct(
      ...
      std::optional<std::string> init_name = std::nullopt,
      std::optional<std::string> hook_init_file = std::nullopt,
      std::optional<std::string> hook_lat_file = std::nullopt,
      std::optional<std::string> hook_beam_file = std::nullopt,
      std::optional<std::string> hook_data_file = std::nullopt,
      std::optional<std::string> hook_plot_file = std::nullopt,
      std::optional<std::string> hook_startup_file = std::nullopt,
      std::optional<std::string> hook_var_file = std::nullopt,
      std::optional<std::string> hook_building_wall_file = std::nullopt,
      std::optional<std::string> init_file_arg_path = std::nullopt,
      std::optional<std::string> lattice_file_arg = std::nullopt,
      std::optional<std::string> hook_init_file_arg = std::nullopt,
      std::optional<std::string> init_file_arg = std::nullopt,
      std::optional<std::string> beam_file_arg = std::nullopt,
      std::optional<std::string> beam_init_position_file_arg = std::nullopt,
      std::optional<std::string> command_arg = std::nullopt,
      std::optional<std::string> data_file_arg = std::nullopt,
      std::optional<std::string> plot_file_arg = std::nullopt,
      std::optional<std::string> startup_file_arg = std::nullopt,
      std::optional<std::string> var_file_arg = std::nullopt,
      std::optional<std::string> building_wall_file_arg = std::nullopt,
      std::optional<std::string> geometry_arg = std::nullopt,
      std::optional<std::string> slice_lattice_arg = std::nullopt,
      std::optional<std::string> start_branch_at_arg = std::nullopt,
      std::optional<std::string> log_startup_arg = std::nullopt,
      std::optional<std::string> no_stopping_arg = std::nullopt,
      std::optional<std::string> noplot_arg = std::nullopt,
      std::optional<std::string> no_rad_int_arg = std::nullopt,
      std::optional<std::string> reverse_arg = std::nullopt,
      std::optional<std::string> debug_arg = std::nullopt,
      std::optional<std::string> disable_smooth_line_calc_arg = std::nullopt,
      std::optional<std::string> rf_on_arg = std::nullopt,
      std::optional<std::string> prompt_color_arg = std::nullopt,
      std::optional<std::string> quiet_arg = std::nullopt,
      std::optional<std::string> noinit_arg = std::nullopt,
      std::optional<std::string> nostartup_arg = std::nullopt,
      std::optional<std::string> symbol_import_arg = std::nullopt,
      std::optional<std::string> unique_name_suffix = std::nullopt
  )
      : FortranProxy() {
    if (parse_cmd_args)
    ...
    if (init_name)
      set_init_name(*init_name);
    if (hook_init_file)
      set_hook_init_file(*hook_init_file);
    if (hook_lat_file)
      set_hook_lat_file(*hook_lat_file);
    if (hook_beam_file)
      set_hook_beam_file(*hook_beam_file);
    if (hook_data_file)
      set_hook_data_file(*hook_data_file);
    if (hook_plot_file)
      set_hook_plot_file(*hook_plot_file);
    if (hook_startup_file)
      set_hook_startup_file(*hook_startup_file);
    if (hook_var_file)
      set_hook_var_file(*hook_var_file);
    if (hook_building_wall_file)
      set_hook_building_wall_file(*hook_building_wall_file);
    if (init_file_arg_path)
      set_init_file_arg_path(*init_file_arg_path);
    if (lattice_file_arg)
      set_lattice_file_arg(*lattice_file_arg);
    if (hook_init_file_arg)
      set_hook_init_file_arg(*hook_init_file_arg);
    if (init_file_arg)
      set_init_file_arg(*init_file_arg);
    if (beam_file_arg)
      set_beam_file_arg(*beam_file_arg);
    if (beam_init_position_file_arg)
      set_beam_init_position_file_arg(*beam_init_position_file_arg);
    if (command_arg)
      set_command_arg(*command_arg);
    if (data_file_arg)
      set_data_file_arg(*data_file_arg);
    if (plot_file_arg)
      set_plot_file_arg(*plot_file_arg);
    if (startup_file_arg)
      set_startup_file_arg(*startup_file_arg);
    if (var_file_arg)
      set_var_file_arg(*var_file_arg);
    if (building_wall_file_arg)
      set_building_wall_file_arg(*building_wall_file_arg);
    if (geometry_arg)
      set_geometry_arg(*geometry_arg);
    if (slice_lattice_arg)
      set_slice_lattice_arg(*slice_lattice_arg);
    if (start_branch_at_arg)
      set_start_branch_at_arg(*start_branch_at_arg);
    if (log_startup_arg)
      set_log_startup_arg(*log_startup_arg);
    if (no_stopping_arg)
      set_no_stopping_arg(*no_stopping_arg);
    if (noplot_arg)
      set_noplot_arg(*noplot_arg);
    if (no_rad_int_arg)
      set_no_rad_int_arg(*no_rad_int_arg);
    if (reverse_arg)
      set_reverse_arg(*reverse_arg);
    if (debug_arg)
      set_debug_arg(*debug_arg);
    if (disable_smooth_line_calc_arg)
      set_disable_smooth_line_calc_arg(*disable_smooth_line_calc_arg);
    if (rf_on_arg)
      set_rf_on_arg(*rf_on_arg);
    if (prompt_color_arg)
      set_prompt_color_arg(*prompt_color_arg);
    if (quiet_arg)
      set_quiet_arg(*quiet_arg);
    if (noinit_arg)
      set_noinit_arg(*noinit_arg);
    if (nostartup_arg)
      set_nostartup_arg(*nostartup_arg);
    if (symbol_import_arg)
      set_symbol_import_arg(*symbol_import_arg);
    if (unique_name_suffix)
      set_unique_name_suffix(*unique_name_suffix);
  }

  bool parse_cmd_args() const; // 0D_NOT_logical [dispatch:0]
  void set_parse_cmd_args(bool value);
  bool debug_switch() const; // 0D_NOT_logical [dispatch:1]
  void set_debug_switch(bool value);
  bool external_plotting_switch() const; // 0D_NOT_logical [dispatch:2]
...
public:
  ...
  double dummy_target() const; // 0D_NOT_real [dispatch:0]
  void set_dummy_target(double value);
  int n_alias() const; // 0D_NOT_integer [dispatch:0]
  void set_n_alias(int value);
  int cmd_file_level() const; // 0D_NOT_integer [dispatch:1]
  void set_cmd_file_level(int value);
  int ix_key_bank() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_key_bank(int value);
  int ix_history() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_history(int value);
  int n_history() const; // 0D_NOT_integer [dispatch:4]
  void set_n_history(int value);
  int lev_loop() const; // 0D_NOT_integer [dispatch:5]
  void set_lev_loop(int value);
  int n_err_messages_printed() const; // 0D_NOT_integer [dispatch:6]
  void set_n_err_messages_printed(int value);
  int n_universes() const; // 0D_NOT_integer [dispatch:7]
  void set_n_universes(int value);
  int ix_beam_track_active_element() const; // 0D_NOT_integer [dispatch:8]
  void set_ix_beam_track_active_element(int value);
  bool cmd_file_paused() const; // 0D_NOT_logical [dispatch:0]
  void set_cmd_file_paused(bool value);
  bool use_cmd_here() const; // 0D_NOT_logical [dispatch:1]
  void set_use_cmd_here(bool value);
  bool cmd_from_cmd_file() const; // 0D_NOT_logical [dispatch:2]
  void set_cmd_from_cmd_file(bool value);
  bool use_saved_beam_in_tracking() const; // 0D_NOT_logical [dispatch:3]
  void set_use_saved_beam_in_tracking(bool value);
  bool single_mode() const; // 0D_NOT_logical [dispatch:4]
  void set_single_mode(bool value);
  bool combine_consecutive_elements_of_like_name() const; // 0D_NOT_logical [dispatch:5]
  void set_combine_consecutive_elements_of_like_name(bool value);
  bool have_tracked_beam() const; // 0D_NOT_logical [dispatch:6]
  void set_have_tracked_beam(bool value);
  bool init_plot_needed() const; // 0D_NOT_logical [dispatch:7]
  void set_init_plot_needed(bool value);
  bool init_beam() const; // 0D_NOT_logical [dispatch:8]
  void set_init_beam(bool value);
  bool init_var() const; // 0D_NOT_logical [dispatch:9]
  void set_init_var(bool value);
  bool init_read_lat_info() const; // 0D_NOT_logical [dispatch:10]
  void set_init_read_lat_info(bool value);
  bool optimizer_running() const; // 0D_NOT_logical [dispatch:11]
  void set_optimizer_running(bool value);
  bool have_datums_using_expressions() const; // 0D_NOT_logical [dispatch:12]
  void set_have_datums_using_expressions(bool value);
  bool print_to_terminal() const; // 0D_NOT_logical [dispatch:13]
  void set_print_to_terminal(bool value);
  bool lattice_calc_done() const; // 0D_NOT_logical [dispatch:14]
  void set_lattice_calc_done(bool value);
  bool add_measurement_noise() const; // 0D_NOT_logical [dispatch:15]
  ...
  bool command_arg_has_been_executed() const; // 0D_NOT_logical [dispatch:16]
  void set_command_arg_has_been_executed(bool value);
  bool all_merit_weights_positive() const; // 0D_NOT_logical [dispatch:17]
  void set_all_merit_weights_positive(bool value);
  bool multi_turn_orbit_is_plotted() const; // 0D_NOT_logical [dispatch:18]
  void set_multi_turn_orbit_is_plotted(bool value);
  bool force_chrom_calc() const; // 0D_NOT_logical [dispatch:19]
  void set_force_chrom_calc(bool value);
  bool force_rad_int_calc() const; // 0D_NOT_logical [dispatch:20]
  void set_force_rad_int_calc(bool value);
  bool rad_int_ri_calc_on() const; // 0D_NOT_logical [dispatch:21]
  void set_rad_int_ri_calc_on(bool value);
  bool rad_int_6d_calc_on() const; // 0D_NOT_logical [dispatch:22]
...
public:
  ...
  double text_height() const; // 0D_NOT_real [dispatch:0]
  void set_text_height(double value);
  double main_title_text_scale() const; // 0D_NOT_real [dispatch:1]
  void set_main_title_text_scale(double value);
  double graph_title_text_scale() const; // 0D_NOT_real [dispatch:2]
  void set_graph_title_text_scale(double value);
  double axis_number_text_scale() const; // 0D_NOT_real [dispatch:3]
  void set_axis_number_text_scale(double value);
  double axis_label_text_scale() const; // 0D_NOT_real [dispatch:4]
  void set_axis_label_text_scale(double value);
  double legend_text_scale() const; // 0D_NOT_real [dispatch:5]
  void set_legend_text_scale(double value);
  double key_table_text_scale() const; // 0D_NOT_real [dispatch:6]
  void set_key_table_text_scale(double value);
  double floor_plan_shape_scale() const; // 0D_NOT_real [dispatch:7]
  void set_floor_plan_shape_scale(double value);
  double floor_plan_text_scale() const; // 0D_NOT_real [dispatch:8]
  void set_floor_plan_text_scale(double value);
  double lat_layout_shape_scale() const; // 0D_NOT_real [dispatch:9]
  void set_lat_layout_shape_scale(double value);
  double lat_layout_text_scale() const; // 0D_NOT_real [dispatch:10]
  void set_lat_layout_text_scale(double value);
  int n_curve_pts() const; // 0D_NOT_integer [dispatch:0]
  void set_n_curve_pts(int value);
  int id_window() const; // 0D_NOT_integer [dispatch:1]
  void set_id_window(int value);
  bool delete_overlapping_plots() const; // 0D_NOT_logical [dispatch:0]
  void set_delete_overlapping_plots(bool value);
  bool draw_graph_title_suffix() const; // 0D_NOT_logical [dispatch:1]
...
public:
  ...
  double theta() const; // 0D_NOT_real [dispatch:0]
  void set_theta(double value);
  double x_offset() const; // 0D_NOT_real [dispatch:1]
  void set_x_offset(double value);
  double z_offset() const; // 0D_NOT_real [dispatch:2]
...
public:
  ...
  double z() const; // 0D_NOT_real [dispatch:0]
  void set_z(double value);
  double x() const; // 0D_NOT_real [dispatch:1]
  void set_x(double value);
  double radius() const; // 0D_NOT_real [dispatch:2]
  void set_radius(double value);
  double z_center() const; // 0D_NOT_real [dispatch:3]
  void set_z_center(double value);
  double x_center() const; // 0D_NOT_real [dispatch:4]
  void set_x_center(double value);
};
...
public:
  ...
  std::string data_type() const; // 0D_NOT_character
  void set_data_type(const std::string &value);
  double rms_rel_a() const; // 0D_NOT_real [dispatch:0]
  void set_rms_rel_a(double value);
  double rms_rel_b() const; // 0D_NOT_real [dispatch:1]
  void set_rms_rel_b(double value);
  double rms_rel_as() const; // 0D_NOT_real [dispatch:2]
  void set_rms_rel_as(double value);
  double rms_rel_bs() const; // 0D_NOT_real [dispatch:3]
  void set_rms_rel_bs(double value);
  double rms_rel_ar() const; // 0D_NOT_real [dispatch:4]
  void set_rms_rel_ar(double value);
  double rms_rel_br() const; // 0D_NOT_real [dispatch:5]
  void set_rms_rel_br(double value);
  double rms_rel_k() const; // 0D_NOT_real [dispatch:6]
  void set_rms_rel_k(double value);
  double rms_rel_ks() const; // 0D_NOT_real [dispatch:7]
  void set_rms_rel_ks(double value);
  double rms_rel_kr() const; // 0D_NOT_real [dispatch:8]
  void set_rms_rel_kr(double value);
  double rms_phi() const; // 0D_NOT_real [dispatch:9]
  void set_rms_phi(double value);
  double rms_phi_s() const; // 0D_NOT_real [dispatch:10]
  void set_rms_phi_s(double value);
  double rms_phi_r() const; // 0D_NOT_real [dispatch:11]
  void set_rms_phi_r(double value);
  double amp_ba_s() const; // 0D_NOT_real [dispatch:12]
  void set_amp_ba_s(double value);
  double amp_ba_r() const; // 0D_NOT_real [dispatch:13]
  void set_amp_ba_r(double value);
  double chi_a() const; // 0D_NOT_real [dispatch:14]
  void set_chi_a(double value);
  double chi_c() const; // 0D_NOT_real [dispatch:15]
  void set_chi_c(double value);
  double chi_ba() const; // 0D_NOT_real [dispatch:16]
  ...
  int n_func() const; // 0D_NOT_integer [dispatch:0]
  void set_n_func(int value);
  int ix_a1() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_a1(int value);
  int ix_a2() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_a2(int value);
  int ix_b1() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_b1(int value);
  int ix_b2() const; // 0D_NOT_integer [dispatch:4]
  void set_ix_b2(int value);
  int i_a1() const; // 0D_NOT_integer [dispatch:5]
  void set_i_a1(int value);
  int i_a2() const; // 0D_NOT_integer [dispatch:6]
  void set_i_a2(int value);
  int i_b1() const; // 0D_NOT_integer [dispatch:7]
  void set_i_b1(int value);
  int i_b2() const; // 0D_NOT_integer [dispatch:8]
  void set_i_b2(int value);
  int n_a() const; // 0D_NOT_integer [dispatch:9]
  void set_n_a(int value);
  int n_b() const; // 0D_NOT_integer [dispatch:10]
  void set_n_b(int value);
  int i_curve_wrap_pt() const; // 0D_NOT_integer [dispatch:11]
  void set_i_curve_wrap_pt(int value);
  IntAlloc1D ix_data() const; // 1D_ALLOC_integer
  void set_ix_data(const std::vector<int> &v);
  int n_kick() const; // 0D_NOT_integer [dispatch:12]
...
public:
  ...
  double phi_s() const; // 0D_NOT_real [dispatch:0]
  void set_phi_s(double value);
  double phi_r() const; // 0D_NOT_real [dispatch:1]
  void set_phi_r(double value);
  double phi() const; // 0D_NOT_real [dispatch:2]
  void set_phi(double value);
  double amp() const; // 0D_NOT_real [dispatch:3]
  void set_amp(double value);
  double s() const; // 0D_NOT_real [dispatch:4]
  void set_s(double value);
  int ix_dat_before_kick() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  void set_cmd(const std::string &value);
  int ix() const; // 0D_NOT_integer [dispatch:0]
...
public:
  ...
  int ix_uni() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_uni(int value);
  int n_d2_data_used() const; // 0D_NOT_integer [dispatch:1]
  void set_n_d2_data_used(int value);
  int n_data_used() const; // 0D_NOT_integer [dispatch:2]
  void set_n_data_used(int value);
  bool is_on() const; // 0D_NOT_logical [dispatch:0]
  void set_is_on(bool value);
  bool design_same_as_previous() const; // 0D_NOT_logical [dispatch:1]
  void set_design_same_as_previous(bool value);
  bool picked_uni() const; // 0D_NOT_logical [dispatch:2]
...
public:
  ...
  double total() const; // 0D_NOT_real [dispatch:0]
  void set_total(double value);
  double beta() const; // 0D_NOT_real [dispatch:1]
  void set_beta(double value);
  double gamma() const; // 0D_NOT_real [dispatch:2]
  void set_gamma(double value);
  double kinetic() const; // 0D_NOT_real [dispatch:3]
...
public:
  ...
  int64_t ix() const; // 0D_NOT_integer8 [dispatch:0]
  void set_ix(int64_t value);
  int64_t iy() const; // 0D_NOT_integer8 [dispatch:1]
  void set_iy(int64_t value);
  bool number_stored() const; // 0D_NOT_logical [dispatch:0]
  void set_number_stored(bool value);
  double h_saved() const; // 0D_NOT_real [dispatch:0]
  void set_h_saved(double value);
  int engine() const; // 0D_NOT_integer [dispatch:0]
  void set_engine(int value);
  int seed() const; // 0D_NOT_integer [dispatch:1]
  void set_seed(int value);
  double am() const; // 0D_NOT_real [dispatch:1]
  void set_am(double value);
  int gauss_converter() const; // 0D_NOT_integer [dispatch:2]
  void set_gauss_converter(int value);
  double gauss_sigma_cut() const; // 0D_NOT_real [dispatch:2]
  void set_gauss_sigma_cut(double value);
  int64_t in_sobseq() const; // 0D_NOT_integer8 [dispatch:2]
...
public:
  ...
  int ix_ele_lr_wake() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_ele_lr_wake(int value);
  int ix_ele_stage_end() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_ele_stage_end(int value);
  int ix_pass() const; // 0D_NOT_integer [dispatch:2]
  void set_ix_pass(int value);
  int ix_stage_pass1() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_stage_pass1(int value);
  int ix_head_bunch() const; // 0D_NOT_integer [dispatch:4]
  void set_ix_head_bunch(int value);
  int ix_hom_max() const; // 0D_NOT_integer [dispatch:5]
  void set_ix_hom_max(int value);
  double hom_voltage_max() const; // 0D_NOT_real [dispatch:0]
  void set_hom_voltage_max(double value);
  double time_at_wake_ele() const; // 0D_NOT_real [dispatch:1]
  ...
  int n_orb() const; // 0D_NOT_integer [dispatch:6]
...
public:
  ...
  int ix_bunch_head() const; // 0D_NOT_integer [dispatch:0]
  void set_ix_bunch_head(int value);
  int ix_bunch_end() const; // 0D_NOT_integer [dispatch:1]
  void set_ix_bunch_end(int value);
  int n_bunch_in_lat() const; // 0D_NOT_integer [dispatch:2]
  void set_n_bunch_in_lat(int value);
  int ix_stage_voltage_max() const; // 0D_NOT_integer [dispatch:3]
  void set_ix_stage_voltage_max(int value);
  double hom_voltage_max() const; // 0D_NOT_real [dispatch:0]
  void set_hom_voltage_max(double value);
  double time_now() const; // 0D_NOT_real [dispatch:1]
  void set_time_now(double value);
  double one_turn_time() const; // 0D_NOT_real [dispatch:2]
  void set_one_turn_time(double value);
  double rf_wavelength_max() const; // 0D_NOT_real [dispatch:3]
...
public:
  ...
  explicit BbuParamStruct(
      std::optional<std::string> lat_filename = std::nullopt,
      std::optional<std::string> lat2_filename = std::nullopt,
      std::optional<std::string> bunch_by_bunch_info_file = std::nullopt,
      ...
      std::optional<std::string> elname = std::nullopt,
      ...
      std::optional<std::string> ele_track_end = std::nullopt,
      ...
      : FortranProxy() {
    if (lat_filename)
      set_lat_filename(*lat_filename);
    if (lat2_filename)
      set_lat2_filename(*lat2_filename);
    if (bunch_by_bunch_info_file)
      set_bunch_by_bunch_info_file(*bunch_by_bunch_info_file);
    if (hybridize)
    ...
    if (ele_track_end)
      set_ele_track_end(*ele_track_end);
    if (ix_ele_track_end)
  ...
  bool hybridize() const; // 0D_NOT_logical [dispatch:0]
  void set_hybridize(bool value);
  bool write_digested_hybrid_lat() const; // 0D_NOT_logical [dispatch:1]
  void set_write_digested_hybrid_lat(bool value);
  bool write_voltage_vs_time_dat() const; // 0D_NOT_logical [dispatch:2]
  void set_write_voltage_vs_time_dat(bool value);
  bool keep_overlays_and_groups() const; // 0D_NOT_logical [dispatch:3]
  void set_keep_overlays_and_groups(bool value);
  bool keep_all_lcavities() const; // 0D_NOT_logical [dispatch:4]
  void set_keep_all_lcavities(bool value);
  bool use_taylor_for_hybrids() const; // 0D_NOT_logical [dispatch:5]
  void set_use_taylor_for_hybrids(bool value);
  bool stable_orbit_anal() const; // 0D_NOT_logical [dispatch:6]
  void set_stable_orbit_anal(bool value);
  double limit_factor() const; // 0D_NOT_real [dispatch:0]
  void set_limit_factor(double value);
  double simulation_turns_max() const; // 0D_NOT_real [dispatch:1]
  void set_simulation_turns_max(double value);
  double bunch_freq() const; // 0D_NOT_real [dispatch:2]
  void set_bunch_freq(double value);
  double init_particle_offset() const; // 0D_NOT_real [dispatch:3]
  void set_init_particle_offset(double value);
  double current() const; // 0D_NOT_real [dispatch:4]
  void set_current(double value);
  double rel_tol() const; // 0D_NOT_real [dispatch:5]
  void set_rel_tol(double value);
  bool drscan() const; // 0D_NOT_logical [dispatch:7]
  void set_drscan(bool value);
  bool use_interpolated_threshold() const; // 0D_NOT_logical [dispatch:8]
  void set_use_interpolated_threshold(bool value);
  bool write_hom_info() const; // 0D_NOT_logical [dispatch:9]
  void set_write_hom_info(bool value);
  int elindex() const; // 0D_NOT_integer [dispatch:0]
  void set_elindex(int value);
  std::string elname() const; // 0D_NOT_character
  void set_elname(const std::string &value);
  int nstep() const; // 0D_NOT_integer [dispatch:1]
  void set_nstep(int value);
  double begdr() const; // 0D_NOT_real [dispatch:6]
  void set_begdr(double value);
  double enddr() const; // 0D_NOT_real [dispatch:7]
  void set_enddr(double value);
  int nrep() const; // 0D_NOT_integer [dispatch:2]
  void set_nrep(int value);
  int ran_seed() const; // 0D_NOT_integer [dispatch:3]
  void set_ran_seed(int value);
  int hom_order_cutoff() const; // 0D_NOT_integer [dispatch:4]
  void set_hom_order_cutoff(int value);
  double ran_gauss_sigma_cut() const; // 0D_NOT_real [dispatch:8]
  ...
  int ix_ele_track_end() const; // 0D_NOT_integer [dispatch:5]
  void set_ix_ele_track_end(int value);
  bool regression() const; // 0D_NOT_logical [dispatch:10]
  void set_regression(bool value);
  bool normalize_z_to_rf() const; // 0D_NOT_logical [dispatch:11]
  void set_normalize_z_to_rf(bool value);
  bool ramp_on() const; // 0D_NOT_logical [dispatch:12]
  void set_ramp_on(bool value);
  FArray1D<double> ramp_pattern() const; // 1D_NOT_real
  void set_ramp_pattern(const std::vector<double> &v);
  int ramp_n_start() const; // 0D_NOT_integer [dispatch:6]
  void set_ramp_n_start(int value);
  int n_ramp_pattern() const; // 0D_NOT_integer [dispatch:7]
...
public:
  ...
  double real_rp_0d() const; // 0D_NOT_real [dispatch:0]
  ...
  double real_dp_0d() const; // 0D_NOT_real [dispatch:1]
  ...
  std::complex<double> complex_dp_0d() const; // 0D_NOT_complex [dispatch:0]
  ...
  int64_t int8_0d() const; // 0D_NOT_integer8 [dispatch:0]
  ...
  bool logical_0d() const; // 0D_NOT_logical [dispatch:0]
...
public:
  ...
  int64_t aaa() const; // 0D_NOT_integer8 [dispatch:0]
  void set_aaa(int64_t value);
  int bbb() const; // 0D_NOT_integer [dispatch:0]
