...
FixedArray1D<Int, 2> CppBmadTest::test_bunch_struct_array(
    ...
    optional_ref<BunchProxyArray1D> arr_in_opt,
    optional_ref<BunchProxyArray1D> arr_inout_opt) {
  // arr_in: BunchProxy in (CppWrapperTypeArgumentArray)
  ...
  // arr_inout: BunchProxy inout (CppWrapperTypeArgumentArray)
  ...
  // arr_in_opt: BunchProxy in (CppWrapperTypeArgumentArray)
  Bmad::array_descriptor_t _arr_in_opt_desc;
  _arr_in_opt_desc.rank = 1;
  if (arr_in_opt) {
    _arr_in_opt_desc.data_ptr = arr_in_opt->get().data();
    _arr_in_opt_desc.dims[0] = arr_in_opt->get().size();
  } else {
    _arr_in_opt_desc.data_ptr = nullptr;
    _arr_in_opt_desc.dims[0] = 0;
  }
  _arr_in_opt_desc.strides[0] = 1;
  // arr_inout_opt: BunchProxy inout (CppWrapperTypeArgumentArray)
  Bmad::array_descriptor_t _arr_inout_opt_desc;
  _arr_inout_opt_desc.rank = 1;
  if (arr_inout_opt) {
    _arr_inout_opt_desc.data_ptr = arr_inout_opt->get().data();
    _arr_inout_opt_desc.dims[0] = arr_inout_opt->get().size();
  } else {
