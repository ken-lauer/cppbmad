...
void Tao::integrate_max(
  ...
  fortran_integrate_max(/* int& */ ix_start,
                        /* int& */ ix_ele,
                        /* double& */ datum_value,
                        /* int& */ ix_m,
...
void Tao::integrate_min(
  ...
  _vec_desc.data_ptr = vec.data();
  _vec_desc.dims[0] = vec.size();
  fortran_integrate_min(/* int& */ ix_start,
                        /* int& */ ix_ele,
                        /* double& */ datum_value,
                        /* int& */ ix_m,
                        /* void* */ branch.get_fortran_ptr(),
...
ResonanceHStructAlloc1D Tao::tao_add_to_normal_mode_h_array(std::string h_str) {
  ...
  fortran_tao_add_to_normal_mode_h_array(/* const char* */ _h_str,
...
void Tao::tao_allocate_data_array(TaoUniverseStruct &u, int n_data, std::optional<bool> exact) {
  ...
  fortran_tao_allocate_data_array(/* void* */ u.get_fortran_ptr(),
                                  /* int& */ n_data,
                                  /* bool* */ _exact);
}
...
Tao::tao_beam_emit_calc(int plane, int emit_type, EleStruct &ele, BunchParamsStruct &bunch_params) {
  double _emit{};
  fortran_tao_beam_emit_calc(/* int& */ plane,
                             /* int& */ emit_type,
...
bool Tao::tao_beam_track(
  ...
  bool _calc_ok{};
  fortran_tao_beam_track(/* void* */ u.get_fortran_ptr(),
...
std::optional<EleStruct> Tao::tao_beam_track_endpoint(
  ...
  void *_ele;
  fortran_tao_beam_track_endpoint(/* const char* */ _ele_id,
...
void Tao::tao_calc_data_at_s_pts(
  ...
  fortran_tao_calc_data_at_s_pts(/* void* */ tao_lat.get_fortran_ptr(),
...
bool Tao::tao_change_ele(
  ...
  bool _err_flag{};
  fortran_tao_change_ele(/* const char* */ _ele_name,
...
bool Tao::tao_change_tune(
  ...
  bool _err_flag{};
  fortran_tao_change_tune(/* const char* */ _branch_str,
...
bool Tao::tao_change_var(std::string name, std::string num_str, bool silent) {
  ...
  auto _num_str = num_str.c_str();
  bool _err_flag{};
  fortran_tao_change_var(/* const char* */ _name,
                         /* const char* */ _num_str,
                         /* bool& */ silent,
                         /* bool& */ _err_flag);
  return _err_flag;
...
bool Tao::tao_change_z_tune(std::string branch_str, std::string dq_str) {
  ...
  bool _err_flag{};
  fortran_tao_change_z_tune(/* const char* */ _branch_str,
                            /* const char* */ _dq_str,
                            /* bool& */ _err_flag);
  return _err_flag;
}
bool Tao::tao_chrom_calc_needed(std::string data_type, std::string data_source) {
  ...
  bool _do_chrom{};
  fortran_tao_chrom_calc_needed(/* const char* */ _data_type,
...
void Tao::tao_clip_cmd(bool gang, std::string where, double value1, double value2) {
  auto _where = where.c_str();
  fortran_tao_clip_cmd(/* bool& */ gang,
                       /* const char* */ _where,
                       /* double& */ value1,
                       /* double& */ value2);
}
...
bool Tao::tao_cmd_split(
  ...
  fortran_tao_cmd_split(/* const char* */ _cmd_line,
                        /* int& */ n_word,
...
void Tao::tao_control_tree_list(EleStruct &ele, ElePointerStructAlloc1D tree) {
  ...
  fortran_tao_control_tree_list(/* void* */ ele.get_fortran_ptr(),
...
bool Tao::tao_curve_check_universe(TaoCurveStruct &curve, TaoUniverseStruct &uni) {
  ...
  bool _is_ok{};
  fortran_tao_curve_check_universe(/* void* */ curve.get_fortran_ptr(),
                                   /* void* */ &uni,
                                   /* bool& */ _is_ok);
  return _is_ok;
}
void Tao::tao_curve_data_setup(TaoPlotStruct &plot, TaoGraphStruct &graph, TaoCurveStruct &curve) {
  fortran_tao_curve_data_setup(/* void* */ plot.get_fortran_ptr(),
...
void Tao::tao_curve_datum_calc(
  ...
  // intent=in allocatable type array
  auto _who = who.c_str();
  fortran_tao_curve_datum_calc(/* void* */ eles.get_fortran_ptr(),
...
std::string Tao::tao_curve_name(TaoCurveStruct &curve, std::optional<bool> use_region) {
  ...
  fortran_tao_curve_name(/* void* */ curve.get_fortran_ptr(),
                         /* bool* */ _use_region,
...
Tao::TaoCurveRmsCalc Tao::tao_curve_rms_calc(TaoCurveStruct &curve, std::string who) {
  ...
  double _rms{};
  double _mean{};
  fortran_tao_curve_rms_calc(/* void* */ curve.get_fortran_ptr(),
                             /* const char* */ _who,
                             /* double& */ _rms,
                             /* double& */ _mean);
...
std::string Tao::tao_d2_d1_name(TaoD1DataStruct &d1, std::optional<bool> show_universe) {
  ...
  fortran_tao_d2_d1_name(/* void* */ d1.get_fortran_ptr(),
                         /* bool* */ _show_universe,
...
void Tao::tao_d2_data_stuffit(TaoUniverseStruct &u, std::string d2_name, int n_d1_data) {
  ...
  fortran_tao_d2_data_stuffit(/* void* */ u.get_fortran_ptr(),
                              /* const char* */ _d2_name,
                              /* int& */ n_d1_data);
}
...
bool Tao::tao_data_sanity_check(
  ...
  bool _is_valid{};
  fortran_tao_data_sanity_check(/* void* */ datum.get_fortran_ptr(),
                                /* bool& */ print_err,
...
void Tao::tao_data_show_use(
  ...
  fortran_tao_data_show_use(/* void* */ d2_data.get_fortran_ptr(),
                            /* void* */ _lines,
                            /* int* */ _nl);
}
std::string
Tao::tao_data_type_substitute(std::string template_, TaoCurveStruct &curve, TaoGraphStruct &graph) {
  ...
  char _str_out[4096];
  fortran_tao_data_type_substitute(/* const char* */ _template_,
                                   /* const char* */ _str_out,
                                   /* void* */ curve.get_fortran_ptr(),
                                   /* void* */ graph.get_fortran_ptr());
  return _str_out;
...
std::string Tao::tao_data_useit_plot_calc(
  ...
  fortran_tao_data_useit_plot_calc(/* void* */ curve.get_fortran_ptr(),
                                   /* void* */ graph.get_fortran_ptr(),
                                   /* Bmad::array_descriptor_t& */ _data_desc,
                                   /* bool& */ check_s_position,
...
int Tao::tao_datum_has_associated_ele(std::string data_type, std::optional<int> branch_geometry) {
  ...
  fortran_tao_datum_has_associated_ele(/* const char* */ _data_type,
...
Tao::TaoDatumIntegrate Tao::tao_datum_integrate(
  ...
  double _result{};
  fortran_tao_datum_integrate(/* void* */ datum.get_fortran_ptr(),
                              /* void* */ branch.get_fortran_ptr(),
                              /* Bmad::array_descriptor_t& */ _s_pos_desc,
                              /* Bmad::array_descriptor_t& */ _values_desc,
                              /* bool& */ _valid_value,
...
std::string Tao::tao_datum_name(TaoDataStruct &datum, std::optional<bool> show_universe) {
  ...
  char _datum_name[4096];
  fortran_tao_datum_name(/* void* */ datum.get_fortran_ptr(),
                         /* bool* */ _show_universe,
                         /* const char* */ _datum_name);
  return _datum_name;
}
double Tao::tao_datum_s_position(TaoDataStruct &datum, EleStruct &ele) {
  double _s_pos{};
  fortran_tao_datum_s_position(/* void* */ datum.get_fortran_ptr(),
                               /* void* */ ele.get_fortran_ptr(),
                               /* double& */ _s_pos);
  return _s_pos;
}
...
double Tao::tao_do_wire_scan(EleStruct &ele, double theta, BeamStruct &beam) {
  double _moment{};
  fortran_tao_do_wire_scan(/* void* */ ele.get_fortran_ptr(),
                           /* double& */ theta,
                           /* void* */ beam.get_fortran_ptr(),
                           /* double& */ _moment);
  return _moment;
...
void Tao::tao_draw_beam_chamber_wall(TaoPlotStruct &plot, TaoGraphStruct &graph) {
  fortran_tao_draw_beam_chamber_wall(/* void* */ plot.get_fortran_ptr(),
                                     /* void* */ graph.get_fortran_ptr());
}
void Tao::tao_draw_curve_data(
  ...
  fortran_tao_draw_curve_data(/* void* */ plot.get_fortran_ptr(),
                              /* void* */ graph.get_fortran_ptr(),
                              /* void* */ curve.get_fortran_ptr(),
                              /* bool& */ have_data);
}
void Tao::tao_draw_ele_for_floor_plan(
  ...
  fortran_tao_draw_ele_for_floor_plan(/* void* */ plot.get_fortran_ptr(),
                                      /* void* */ graph.get_fortran_ptr(),
                                      /* void* */ tao_lat.get_fortran_ptr(),
                                      /* void* */ ele.get_fortran_ptr(),
                                      /* void* */ &ele_shape,
...
void Tao::tao_draw_floor_plan(TaoPlotStruct &plot, TaoGraphStruct &graph) {
  fortran_tao_draw_floor_plan(/* void* */ plot.get_fortran_ptr(),
                              /* void* */ graph.get_fortran_ptr());
}
void Tao::tao_draw_graph_axes(TaoPlotStruct &plot, TaoGraphStruct &graph) {
  fortran_tao_draw_graph_axes(/* void* */ plot.get_fortran_ptr(),
                              /* void* */ graph.get_fortran_ptr());
}
void Tao::tao_draw_histogram_data(
  ...
  fortran_tao_draw_histogram_data(/* void* */ plot.get_fortran_ptr(),
                                  /* void* */ graph.get_fortran_ptr(),
                                  /* void* */ curve.get_fortran_ptr(),
                                  /* bool& */ have_data);
}
void Tao::tao_draw_lat_layout(TaoPlotStruct &plot, TaoGraphStruct &graph) {
  fortran_tao_draw_lat_layout(/* void* */ plot.get_fortran_ptr(),
                              /* void* */ graph.get_fortran_ptr());
}
...
Tao::tao_ele_geometry_with_misalignments(TaoDataStruct &datum, EleStruct &ele) {
  ...
  char _why_invalid[4096];
  double _value{};
  fortran_tao_ele_geometry_with_misalignments(/* void* */ datum.get_fortran_ptr(),
                                              /* void* */ ele.get_fortran_ptr(),
                                              /* bool& */ _valid_value,
                                              /* const char* */ _why_invalid,
                                              /* double& */ _value);
...
TaoEleShapeStruct Tao::tao_ele_shape_input_to_struct(
    TaoEleShapeInput &shape_input,
    std::optional<std::string> namelist_name
) {
  const char *_namelist_name = namelist_name.has_value() ? namelist_name->c_str() : nullptr;
  TaoEleShapeStruct _shape_struct;
  fortran_tao_ele_shape_input_to_struct(/* void* */ shape_input.get_fortran_ptr(),
                                        /* const char* */ _namelist_name,
                                        /* void* */ _shape_struct.get_fortran_ptr());
  return std::move(_shape_struct);
}
TaoEleShapeInput Tao::tao_ele_shape_struct_to_input(TaoEleShapeStruct &shape_struct) {
  TaoEleShapeInput _shape_input;
...
Tao::TaoEvalFloorOrbit Tao::tao_eval_floor_orbit(
  ...
  char _why_invalid[4096];
  double _value{};
  fortran_tao_eval_floor_orbit(/* void* */ datum.get_fortran_ptr(),
                               /* void* */ ele.get_fortran_ptr(),
...
Tao::TaoEvaluateADatum Tao::tao_evaluate_a_datum(
  ...
  fortran_tao_evaluate_a_datum(/* void* */ datum.get_fortran_ptr(),
                               /* void* */ u.get_fortran_ptr(),
                               /* void* */ tao_lat.get_fortran_ptr(),
                               /* double& */ _datum_value,
                               /* bool& */ _valid_value,
...
Tao::TaoEvaluateDatumAtS Tao::tao_evaluate_datum_at_s(
  ...
  bool _bad_datum{};
  double _value{};
  fortran_tao_evaluate_datum_at_s(/* void* */ datum.get_fortran_ptr(),
                                  /* void* */ tao_lat.get_fortran_ptr(),
                                  /* void* */ &ele,
                                  /* void* */ &ele_ref,
                                  /* bool& */ valid_value,
...
Tao::TaoEvaluateElementParameters Tao::tao_evaluate_element_parameters(
  ...
  fortran_tao_evaluate_element_parameters(/* bool& */ _err,
...
Tao::TaoEvaluateExpression Tao::tao_evaluate_expression(
  ...
  fortran_tao_evaluate_expression(/* const char* */ _expression,
                                  /* int& */ n_size,
                                  /* bool& */ use_good_user,
...
Tao::TaoEvaluateExpressionNew Tao::tao_evaluate_expression_new(
  ...
  auto *_dflt_orbit =
      dflt_orbit.has_value() ? dflt_orbit->get().get_fortran_ptr() : nullptr; // input, optional
  auto *_datum = datum.has_value() ? datum->get().get_fortran_ptr() : nullptr; // input, optional
  fortran_tao_evaluate_expression_new(/* const char* */ _expression,
                                      /* int& */ n_size,
                                      /* bool& */ use_good_user,
                                      /* void* */ value.get_fortran_ptr(),
                                      /* bool& */ _err_flag,
...
Tao::TaoEvaluateExpressionOld Tao::tao_evaluate_expression_old(
  ...
  auto *_dflt_orbit =
      dflt_orbit.has_value() ? dflt_orbit->get().get_fortran_ptr() : nullptr; // input, optional
  auto *_datum = datum.has_value() ? datum->get().get_fortran_ptr() : nullptr; // input, optional
  fortran_tao_evaluate_expression_old(/* const char* */ _expression,
                                      /* int& */ n_size,
                                      /* bool& */ use_good_user,
                                      /* void* */ value.get_fortran_ptr(),
                                      /* bool& */ _err_flag,
...
Tao::TaoEvaluateLatOrBeamData Tao::tao_evaluate_lat_or_beam_data(
  ...
  fortran_tao_evaluate_lat_or_beam_data(/* bool& */ _err,
...
Tao::TaoEvaluateStackOld Tao::tao_evaluate_stack_old(
  ...
  fortran_tao_evaluate_stack_old(/* Bmad::array_descriptor_t& */ _stack_desc,
                                 /* int& */ n_size_in,
                                 /* bool& */ use_good_user,
                                 /* void* */ value.get_fortran_ptr(),
                                 /* bool& */ _err_flag,
...
Tao::TaoEvaluateTree Tao::tao_evaluate_tree(
  ...
  // intent=inout allocatable type array
  auto *_info_in = info_in.has_value() ? info_in->get_fortran_ptr() : nullptr; // input, optional
  fortran_tao_evaluate_tree(/* void* */ tao_tree.get_fortran_ptr(),
                            /* int& */ n_size,
                            /* bool& */ use_good_user,
                            /* void* */ value.get_fortran_ptr(),
                            /* bool& */ _err_flag,
...
double Tao::tao_evaluate_tune(std::string q_str, double q0, bool delta_input) {
  ...
  double _q_val{};
  fortran_tao_evaluate_tune(/* const char* */ _q_str,
                            /* double& */ q0,
                            /* bool& */ delta_input,
                            /* double& */ _q_val);
  return _q_val;
...
Tao::tao_expression_hash_substitute(std::string expression_in, optional_ref<EleStruct> eval_ele) {
  ...
  fortran_tao_expression_hash_substitute(/* const char* */ _expression_in,
...
std::string Tao::tao_expression_tree_to_string(
  ...
  char _str_out[4096];
  fortran_tao_expression_tree_to_string(/* void* */ tree.get_fortran_ptr(),
                                        /* bool* */ _include_root,
                                        /* int* */ _n_node,
                                        /* void* */ _parent,
                                        /* const char* */ _str_out);
...
Tao::TaoFindData Tao::tao_find_data(
    std::string data_name,
    std::optional<int> ix_uni,
    std::optional<std::string> dflt_index,
    std::optional<bool> print_err
) {
  bool _err{};
  auto _data_name = data_name.c_str();
  // intent=out allocatable type array
  auto d2_array{TaoD2DataArrayStructAlloc1D()};
  // intent=out allocatable type array
  auto d1_array{TaoD1DataArrayStructAlloc1D()};
  // intent=out allocatable type array
  auto d_array{TaoDataArrayStructAlloc1D()};
  // intent=out allocatable type array
  auto re_array{TaoRealPointerStructAlloc1D()};
  // intent=out allocatable type array
  auto log_array{TaoLogicalArrayStructAlloc1D()};
  // intent=out allocatable type array
  auto str_array{TaoStringArrayStructAlloc1D()};
  // intent=out allocatable type array
  auto int_array{TaoIntegerArrayStructAlloc1D()};
  int ix_uni_lvalue;
  auto *_ix_uni{&ix_uni_lvalue};
  if (ix_uni.has_value()) {
    ix_uni_lvalue = ix_uni.value();
  } else {
    _ix_uni = nullptr;
  }
  const char *_dflt_index = dflt_index.has_value() ? dflt_index->c_str() : nullptr;
  bool print_err_lvalue;
  auto *_print_err{&print_err_lvalue};
  if (print_err.has_value()) {
    print_err_lvalue = print_err.value();
  ...
  fortran_tao_find_data(/* bool& */ _err,
                        /* const char* */ _data_name,
                        /* void* */ d2_array.get_fortran_ptr(),
                        /* void* */ d1_array.get_fortran_ptr(),
                        /* void* */ d_array.get_fortran_ptr(),
                        /* void* */ re_array.get_fortran_ptr(),
                        /* void* */ log_array.get_fortran_ptr(),
                        /* void* */ str_array.get_fortran_ptr(),
                        /* void* */ int_array.get_fortran_ptr(),
                        /* int* */ _ix_uni,
                        /* const char* */ _dflt_index,
                        /* bool* */ _print_err,
...
Tao::tao_find_plot_region(std::string where, std::optional<bool> print_flag) {
  ...
  fortran_tao_find_plot_region(/* bool& */ _err,
                               /* const char* */ _where,
                               /* void* */ &_region,
                               /* bool* */ _print_flag);
...
Tao::TaoFindPlots Tao::tao_find_plots(
    std::string name,
    std::string where,
    std::optional<bool> print_flag,
    std::optional<bool> blank_means_all,
    std::optional<bool> only_visible
) {
  bool _err{};
  auto _name = name.c_str();
  auto _where = where.c_str();
  // intent=out allocatable type array
  auto plot{TaoPlotArrayStructAlloc1D()};
  // intent=out allocatable type array
  auto graph{TaoGraphArrayStructAlloc1D()};
  // intent=out allocatable type array
  auto curve{TaoCurveArrayStructAlloc1D()};
  bool print_flag_lvalue;
  auto *_print_flag{&print_flag_lvalue};
  if (print_flag.has_value()) {
    print_flag_lvalue = print_flag.value();
  ...
  bool blank_means_all_lvalue;
  auto *_blank_means_all{&blank_means_all_lvalue};
  if (blank_means_all.has_value()) {
    blank_means_all_lvalue = blank_means_all.value();
  } else {
    _blank_means_all = nullptr;
  }
  bool only_visible_lvalue;
  auto *_only_visible{&only_visible_lvalue};
  if (only_visible.has_value()) {
    only_visible_lvalue = only_visible.value();
  } else {
    _only_visible = nullptr;
  }
  fortran_tao_find_plots(/* bool& */ _err,
                         /* const char* */ _name,
                         /* const char* */ _where,
                         /* void* */ plot.get_fortran_ptr(),
                         /* void* */ graph.get_fortran_ptr(),
                         /* void* */ curve.get_fortran_ptr(),
                         /* bool* */ _print_flag,
                         /* bool* */ _blank_means_all,
                         /* bool* */ _only_visible);
  return TaoFindPlots{_err, std::move(plot), std::move(graph), std::move(curve)};
}
Tao::TaoFindVar Tao::tao_find_var(
    std::string var_name,
    std::optional<bool> print_err,
    std::optional<std::string> dflt_var_index
) {
  bool _err{};
  auto _var_name = var_name.c_str();
  // intent=out allocatable type array
  auto v1_array{TaoV1VarArrayStructAlloc1D()};
  // intent=out allocatable type array
  auto v_array{TaoVarArrayStructAlloc1D()};
  // intent=out allocatable type array
  auto re_array{TaoRealPointerStructAlloc1D()};
  // intent=out allocatable type array
  auto log_array{TaoLogicalArrayStructAlloc1D()};
  ...
  char _component[4096];
  const char *_dflt_var_index = dflt_var_index.has_value() ? dflt_var_index->c_str() : nullptr;
  fortran_tao_find_var(/* bool& */ _err,
                       /* const char* */ _var_name,
                       /* void* */ v1_array.get_fortran_ptr(),
                       /* void* */ v_array.get_fortran_ptr(),
                       /* void* */ re_array.get_fortran_ptr(),
                       /* void* */ log_array.get_fortran_ptr(),
                       /* void* */ str_array.get_fortran_ptr(),
                       /* bool* */ _print_err,
                       /* const char* */ _component,
                       /* const char* */ _dflt_var_index);
  return TaoFindVar{
      _err,
      std::move(v1_array),
      std::move(v_array),
...
Tao::tao_floor_to_screen(TaoGraphStruct &graph, FixedArray1D<Real, 3> r_floor) {
  ...
  double _x_screen{};
  double _y_screen{};
  fortran_tao_floor_to_screen(/* void* */ graph.get_fortran_ptr(),
                              /* Bmad::array_descriptor_t& */ _r_floor_desc,
                              /* double& */ _x_screen,
                              /* double& */ _y_screen);
...
Tao::tao_floor_to_screen_coords(TaoGraphStruct &graph, FloorPositionStruct &floor) {
  ...
  fortran_tao_floor_to_screen_coords(/* void* */ graph.get_fortran_ptr(),
...
Tao::TaoGetData Tao::tao_get_data() {
  ...
  fortran_tao_get_data(/* void* */ data_value.get_fortran_ptr(),
...
Tao::TaoGetOptVars Tao::tao_get_opt_vars() {
  ...
  fortran_tao_get_opt_vars(/* void* */ var_value.get_fortran_ptr(),
...
std::string Tao::tao_get_user_input(
  ...
  fortran_tao_get_user_input(/* const char* */ _cmd_out,
...
void Tao::tao_graph_data_setup(TaoPlotStruct &plot, TaoGraphStruct &graph) {
  fortran_tao_graph_data_setup(/* void* */ plot.get_fortran_ptr(),
                               /* void* */ graph.get_fortran_ptr());
}
void Tao::tao_graph_data_slice_setup(TaoPlotStruct &plot, TaoGraphStruct &graph) {
  fortran_tao_graph_data_slice_setup(/* void* */ plot.get_fortran_ptr(),
                                     /* void* */ graph.get_fortran_ptr());
}
void Tao::tao_graph_dynamic_aperture_setup(TaoPlotStruct &plot, TaoGraphStruct &graph) {
  fortran_tao_graph_dynamic_aperture_setup(/* void* */ plot.get_fortran_ptr(),
                                           /* void* */ graph.get_fortran_ptr());
}
void Tao::tao_graph_histogram_setup(TaoPlotStruct &plot, TaoGraphStruct &graph) {
  fortran_tao_graph_histogram_setup(/* void* */ plot.get_fortran_ptr(),
                                    /* void* */ graph.get_fortran_ptr());
}
std::string Tao::tao_graph_name(TaoGraphStruct &graph, std::optional<bool> use_region) {
  ...
  fortran_tao_graph_name(/* void* */ graph.get_fortran_ptr(),
                         /* bool* */ _use_region,
                         /* const char* */ _graph_name);
  return _graph_name;
}
void Tao::tao_graph_phase_space_setup(TaoPlotStruct &plot, TaoGraphStruct &graph) {
  fortran_tao_graph_phase_space_setup(/* void* */ plot.get_fortran_ptr(),
                                      /* void* */ graph.get_fortran_ptr());
}
...
Tao::tao_graph_s_min_max_calc(TaoGraphStruct &graph, BranchStruct &branch) {
  double _s_min{};
  double _s_max{};
  fortran_tao_graph_s_min_max_calc(/* void* */ graph.get_fortran_ptr(),
                                   /* void* */ branch.get_fortran_ptr(),
                                   /* double& */ _s_min,
                                   /* double& */ _s_max);
...
void Tao::tao_has_been_created() { fortran_tao_has_been_created(); }
Tao::TaoHelp Tao::tao_help(std::string what1, std::string what2) {
  ...
  int _n_lines{};
  fortran_tao_help(/* const char* */ _what1,
                   /* const char* */ _what2,
...
void Tao::tao_init_beam_in_universe(
  ...
  fortran_tao_init_beam_in_universe(/* void* */ u.get_fortran_ptr(),
...
void Tao::tao_init_data_in_universe(
  ...
  fortran_tao_init_data_in_universe(/* void* */ u.get_fortran_ptr(),
                                    /* int& */ n_d2_add,
...
Tao::TaoInitFindElements Tao::tao_init_find_elements(
  ...
  bool _found_one{};
  fortran_tao_init_find_elements(/* void* */ u.get_fortran_ptr(),
...
void Tao::tao_init_single_mode(std::string single_mode_file) {
  auto _single_mode_file = single_mode_file.c_str();
  fortran_tao_init_single_mode(/* const char* */ _single_mode_file);
}
...
Tao::tao_inject_beam(TaoUniverseStruct &u, TaoLatticeStruct &model, int ix_branch) {
  BeamStruct _beam;
  bool _init_ok{};
  fortran_tao_inject_beam(/* void* */ u.get_fortran_ptr(),
...
void Tao::tao_inject_particle(TaoUniverseStruct &u, TaoLatticeStruct &model, int ix_branch) {
  fortran_tao_inject_particle(/* void* */ u.get_fortran_ptr(),
                              /* void* */ model.get_fortran_ptr(),
                              /* int& */ ix_branch);
}
Tao::TaoIsValidName Tao::tao_is_valid_name(std::string name) {
  ...
  char _why_invalid[4096];
  bool _is_valid{};
  fortran_tao_is_valid_name(/* const char* */ _name,
                            /* const char* */ _why_invalid,
                            /* bool& */ _is_valid);
...
void Tao::tao_key_info_to_str(
  ...
  fortran_tao_key_info_to_str(/* int& */ ix_key,
                              /* int& */ ix_min_key,
                              /* int& */ ix_max_key,
                              /* const char* */ _key_str,
...
bool Tao::tao_lat_bookkeeper(TaoUniverseStruct &u, TaoLatticeStruct &tao_lat) {
  bool _err_flag{};
  fortran_tao_lat_bookkeeper(/* void* */ u.get_fortran_ptr(),
                             /* void* */ tao_lat.get_fortran_ptr(),
                             /* bool& */ _err_flag);
  return _err_flag;
}
double Tao::tao_lat_emit_calc(int plane, int emit_type, EleStruct &ele, NormalModesStruct &modes) {
  double _emit{};
  fortran_tao_lat_emit_calc(/* int& */ plane,
                            /* int& */ emit_type,
                            /* void* */ ele.get_fortran_ptr(),
...
bool Tao::tao_lat_sigma_calc_needed(std::string data_type, std::string data_source) {
  ...
  auto _data_source = data_source.c_str();
  bool _do_lat_sigma{};
  fortran_tao_lat_sigma_calc_needed(/* const char* */ _data_type,
                                    /* const char* */ _data_source,
                                    /* bool& */ _do_lat_sigma);
...
bool Tao::tao_lat_sigma_track(
  ...
  fortran_tao_lat_sigma_track(/* void* */ tao_lat.get_fortran_ptr(),
                              /* bool& */ _calc_ok,
                              /* int& */ ix_branch,
                              /* bool* */ _print_err,
                              /* bool* */ _force_calc);
...
void Tao::tao_lattice_equal_tao_lattice(TaoLatticeStruct &lat1, TaoLatticeStruct &lat2) {
  fortran_tao_lattice_equal_tao_lattice(/* void* */ lat1.get_fortran_ptr(),
...
void Tao::tao_load_this_datum(
  ...
  fortran_tao_load_this_datum(/* Bmad::array_descriptor_t& */ _vec_desc,
                              /* void* */ &ele_ref,
                              /* void* */ &ele_start,
                              /* void* */ &ele,
                              /* double& */ datum_value,
...
Tao::tao_locate_all_elements(std::string ele_list, std::optional<bool> ignore_blank) {
  ...
  fortran_tao_locate_all_elements(/* const char* */ _ele_list,
                                  /* void* */ eles.get_fortran_ptr(),
                                  /* bool& */ _err,
                                  /* bool* */ _ignore_blank);
...
Tao::TaoLocateElements Tao::tao_locate_elements(
  ...
  fortran_tao_locate_elements(/* const char* */ _ele_list,
                              /* int& */ ix_universe,
                              /* void* */ eles.get_fortran_ptr(),
                              /* bool& */ _err,
                              /* int* */ _lat_type,
...
Tao::TaoNextSwitch Tao::tao_next_switch(
  ...
  fortran_tao_next_switch(/* const char* */ _line,
...
bool Tao::tao_one_turn_map_calc_needed(std::string data_type, std::string data_source) {
  ...
  fortran_tao_one_turn_map_calc_needed(/* const char* */ _data_type,
                                       /* const char* */ _data_source,
                                       /* bool& */ _do_one_turn_map);
...
int Tao::tao_open_file(
  ...
  fortran_tao_open_file(/* const char* */ _file,
                        /* int& */ _iunit,
...
TaoBuildingWallPointStruct Tao::tao_oreint_building_wall_pt(TaoBuildingWallPointStruct &pt_in) {
  ...
  fortran_tao_oreint_building_wall_pt(/* void* */ pt_in.get_fortran_ptr(),
...
Tao::TaoParamValueAtS Tao::tao_param_value_at_s(
  ...
  bool _bad_datum{};
  double _value{};
  fortran_tao_param_value_at_s(/* const char* */ _dat_name,
...
void Tao::tao_param_value_routine(
  ...
  auto *_dflt_orbit =
      dflt_orbit.has_value() ? dflt_orbit->get().get_fortran_ptr() : nullptr; // input, optional
  auto *_datum = datum.has_value() ? datum->get().get_fortran_ptr() : nullptr; // input, optional
  fortran_tao_param_value_routine(/* const char* */ _str,
                                  /* bool& */ use_good_user,
...
Tao::TaoParseElementParamStr Tao::tao_parse_element_param_str(std::string in_str) {
  ...
  int _where{};
  char _component[4096];
  fortran_tao_parse_element_param_str(/* bool& */ _err,
                                      /* const char* */ _in_str,
                                      /* const char* */ _uni,
                                      /* const char* */ _element,
...
Tao::TaoParticleDataValue Tao::tao_particle_data_value(
  ...
  auto value{RealAlloc1D()};
  bool _err{};
  fortran_tao_particle_data_value(/* const char* */ _data_type,
                                  /* Bmad::array_descriptor_t& */ _p_desc,
                                  /* void* */ value.get_fortran_ptr(),
                                  /* bool& */ _err,
                                  /* void* */ ele.get_fortran_ptr(),
...
int Tao::tao_phase_space_axis_index(std::string data_type, bool err) {
  auto _data_type = data_type.c_str();
  int _ix_axis{};
  fortran_tao_phase_space_axis_index(/* const char* */ _data_type,
                                     /* bool& */ err,
                                     /* int& */ _ix_axis);
  return _ix_axis;
}
...
Tao::TaoPickUniverse Tao::tao_pick_universe(
  ...
  fortran_tao_pick_universe(/* const char* */ _name_in,
...
void Tao::tao_plot_histogram(TaoPlotStruct &plot, TaoGraphStruct &graph) {
  fortran_tao_plot_histogram(/* void* */ plot.get_fortran_ptr(),
                             /* void* */ graph.get_fortran_ptr());
}
void Tao::tao_plot_key_table(TaoPlotStruct &plot, TaoGraphStruct &graph) {
  fortran_tao_plot_key_table(/* void* */ plot.get_fortran_ptr(),
                             /* void* */ graph.get_fortran_ptr());
}
...
TaoPlotStruct Tao::tao_plot_struct_transfer(TaoPlotStruct &plot_in) {
  ...
  fortran_tao_plot_struct_transfer(/* void* */ plot_in.get_fortran_ptr(),
...
Tao::TaoPointerToBranches Tao::tao_pointer_to_branches(std::string branch_str) {
  auto _branch_str = branch_str.c_str();
  // intent=out allocatable type array
  auto branches{BranchPointerStructAlloc1D()};
  // intent=out allocatable type array
  auto unis{TaoUniversePointerStructAlloc1D()};
  bool _err{};
  fortran_tao_pointer_to_branches(/* const char* */ _branch_str,
                                  /* void* */ branches.get_fortran_ptr(),
                                  /* void* */ unis.get_fortran_ptr(),
                                  /* bool& */ _err);
  return TaoPointerToBranches{std::move(branches), std::move(unis), _err};
}
...
std::optional<TaoDataStruct> Tao::tao_pointer_to_datum(TaoD1DataStruct &d1, std::string ele_name) {
  auto _ele_name = ele_name.c_str();
  void *_datum_ptr;
  fortran_tao_pointer_to_datum(/* void* */ d1.get_fortran_ptr(),
...
Tao::TaoPointerToDatumEle Tao::tao_pointer_to_datum_ele(
  ...
  void *_ele;
  fortran_tao_pointer_to_datum_ele(/* void* */ lat.get_fortran_ptr(),
                                   /* const char* */ _ele_name,
                                   /* int& */ ix_ele,
                                   /* void* */ datum.get_fortran_ptr(),
                                   /* bool& */ _valid,
...
Tao::tao_pointer_to_tao_lat(TaoUniverseStruct &u, std::optional<int> lat_type) {
  ...
  void *_tao_lat;
  fortran_tao_pointer_to_tao_lat(/* void* */ u.get_fortran_ptr(),
                                 /* int* */ _lat_type,
                                 /* void* */ &_tao_lat);
...
Tao::tao_pointer_to_universe(int ix_uni, std::optional<bool> neg2_to_default) {
  ...
  void *_u;
  fortran_tao_pointer_to_universe_int(/* int& */ ix_uni,
...
Tao::tao_pointer_to_universe(std::string &string, std::optional<bool> neg2_to_default) {
  ...
  void *_u;
  fortran_tao_pointer_to_universe_str(/* const char* */ _string,
                                      /* bool* */ _neg2_to_default,
                                      /* void* */ &_u);
  return std::move((_u ? std::make_optional<TaoUniverseStruct>(_u) : std::nullopt));
}
...
Tao::tao_pointer_to_universes(std::string name_in, std::optional<int> dflt_uni) {
  ...
  fortran_tao_pointer_to_universes(/* const char* */ _name_in,
                                   /* void* */ unis.get_fortran_ptr(),
                                   /* bool& */ _err,
                                   /* const char* */ _name_out,
                                   /* bool& */ _explicit_uni,
...
bool Tao::tao_pointer_to_var_in_lattice(TaoVarStruct &var, int ix_uni, EleStruct &ele) {
  bool _err{};
  fortran_tao_pointer_to_var_in_lattice(/* void* */ var.get_fortran_ptr(),
                                        /* int& */ ix_uni,
                                        /* void* */ ele.get_fortran_ptr(),
                                        /* bool& */ _err);
  return _err;
...
void Tao::tao_print_vars(
  ...
  // v_array: TaoVarArrayStruct in (CppWrapperTypeArgumentArray)
  Bmad::array_descriptor_t _v_array_desc;
  _v_array_desc.rank = 1;
  if (v_array) {
    _v_array_desc.data_ptr = v_array->data();
    _v_array_desc.dims[0] = v_array->size();
  } else {
    _v_array_desc.data_ptr = nullptr;
    _v_array_desc.dims[0] = 0;
  }
  _v_array_desc.strides[0] = 1;
  fortran_tao_print_vars(/* int& */ iu,
                         /* int& */ ix_uni,
...
void Tao::tao_ptc_normal_form(
  ...
  fortran_tao_ptc_normal_form(/* bool& */ do_calc,
                              /* void* */ tao_lat.get_fortran_ptr(),
                              /* int& */ ix_branch,
                              /* int* */ _rf_on);
}
...
bool Tao::tao_rad_int_calc_needed(std::string data_type, std::string data_source) {
  ...
  auto _data_source = data_source.c_str();
  bool _do_rad_int{};
  fortran_tao_rad_int_calc_needed(/* const char* */ _data_type,
                                  /* const char* */ _data_source,
                                  /* bool& */ _do_rad_int);
  return _do_rad_int;
}
void Tao::tao_re_allocate_expression_info(
  ...
  fortran_tao_re_allocate_expression_info(/* void* */ info.get_fortran_ptr(),
                                          /* int& */ n,
                                          /* bool* */ _exact);
}
void Tao::tao_re_associate_node_array(TaoEvalNodeStruct &tree, int n, std::optional<bool> exact) {
  ...
  fortran_tao_re_associate_node_array(/* void* */ tree.get_fortran_ptr(),
                                      /* int& */ n,
                                      /* bool* */ _exact);
}
...
void Tao::tao_read_cmd(std::string which, std::string unis, std::string file, bool silent) {
  ...
  auto _file = file.c_str();
  fortran_tao_read_cmd(/* const char* */ _which,
                       /* const char* */ _unis,
                       /* const char* */ _file,
                       /* bool& */ silent);
}
int Tao::tao_read_phase_space_index(std::string name, int ixc, std::optional<bool> print_err) {
  ...
  int _ix_ps{};
  fortran_tao_read_phase_space_index(/* const char* */ _name,
                                     /* int& */ ixc,
                                     /* bool* */ _print_err,
                                     /* int& */ _ix_ps);
  return _ix_ps;
...
void Tao::tao_scale_cmd(
  ...
  fortran_tao_scale_cmd(/* const char* */ _where,
                        /* double& */ y_min_in,
                        /* double& */ y_max_in,
                        /* const char* */ _axis,
                        /* bool* */ _include_wall,
...
Tao::TaoScaleGraph Tao::tao_scale_graph(
  ...
  fortran_tao_scale_graph(/* void* */ graph.get_fortran_ptr(),
                          /* double& */ y_min,
                          /* double& */ y_max,
                          /* const char* */ _axis,
                          /* bool* */ _include_wall,
...
void Tao::tao_scale_plot(
  ...
  fortran_tao_scale_plot(/* void* */ plot.get_fortran_ptr(),
                         /* double& */ y_min_in,
                         /* double& */ y_max_in,
                         /* const char* */ _axis,
                         /* bool* */ _include_wall,
...
void Tao::tao_scratch_values_calc(
  ...
  fortran_tao_scratch_values_calc(/* void* */ &ele_ref,
                                  /* void* */ &ele_start,
                                  /* void* */ &ele,
                                  /* void* */ datum.get_fortran_ptr(),
                                  /* void* */ branch.get_fortran_ptr(),
...
void Tao::tao_set_beam_cmd(std::string who, std::string value_str, std::string branch_str) {
  ...
  auto _branch_str = branch_str.c_str();
  fortran_tao_set_beam_cmd(/* const char* */ _who,
...
void Tao::tao_set_beam_init_cmd(std::string who, std::string value_str, std::string branch_str) {
  ...
  auto _value_str = value_str.c_str();
  auto _branch_str = branch_str.c_str();
  fortran_tao_set_beam_init_cmd(/* const char* */ _who,
                                /* const char* */ _value_str,
                                /* const char* */ _branch_str);
}
...
void Tao::tao_set_branch_cmd(
  ...
  auto _value_str = value_str.c_str();
  fortran_tao_set_branch_cmd(/* const char* */ _branch_str,
...
void Tao::tao_set_curve_cmd(std::string curve_name, std::string component, std::string value_str) {
  ...
  auto _component = component.c_str();
  auto _value_str = value_str.c_str();
  fortran_tao_set_curve_cmd(/* const char* */ _curve_name,
                            /* const char* */ _component,
                            /* const char* */ _value_str);
}
void Tao::tao_set_curve_invalid(
  ...
  fortran_tao_set_curve_invalid(/* void* */ curve.get_fortran_ptr(),
                                /* const char* */ _why_invalid,
                                /* bool* */ _print_err);
}
void Tao::tao_set_data_cmd(std::string who_str, std::string value_str, std::optional<bool> silent) {
  ...
  fortran_tao_set_data_cmd(/* const char* */ _who_str,
                           /* const char* */ _value_str,
                           /* bool* */ _silent);
}
...
void Tao::tao_set_drawing_cmd(
  ...
  auto _component = component.c_str();
  auto _value_str = value_str.c_str();
  fortran_tao_set_drawing_cmd(/* void* */ drawing.get_fortran_ptr(),
                              /* const char* */ _component,
                              /* const char* */ _value_str);
}
...
void Tao::tao_set_elements_cmd(
  ...
  fortran_tao_set_elements_cmd(/* const char* */ _ele_list,
                               /* const char* */ _attribute,
                               /* const char* */ _value,
                               /* bool& */ update);
}
void Tao::tao_set_flags_for_changed_attribute(
    TaoUniverseStruct &u,
    std::string ele_name,
    optional_ref<EleStruct> ele_ptr,
    optional_ref<AllPointerStruct> val_ptr,
    std::optional<std::string> who
) {
  auto _ele_name = ele_name.c_str();
  auto *_ele_ptr =
      ele_ptr.has_value() ? ele_ptr->get().get_fortran_ptr() : nullptr; // input, optional
  auto *_val_ptr =
      val_ptr.has_value() ? val_ptr->get().get_fortran_ptr() : nullptr; // input, optional
  const char *_who = who.has_value() ? who->c_str() : nullptr;
  fortran_tao_set_flags_for_changed_attribute(/* void* */ u.get_fortran_ptr(),
                                              /* const char* */ _ele_name,
                                              /* void* */ _ele_ptr,
                                              /* void* */ _val_ptr,
                                              /* const char* */ _who);
...
void Tao::tao_set_floor_plan_axis_label(
  ...
  auto _which = which.c_str();
  fortran_tao_set_floor_plan_axis_label(/* void* */ graph.get_fortran_ptr(),
...
void Tao::tao_set_graph_cmd(std::string graph_name, std::string component, std::string value_str) {
  ...
  auto _component = component.c_str();
  auto _value_str = value_str.c_str();
  fortran_tao_set_graph_cmd(/* const char* */ _graph_name,
                            /* const char* */ _component,
                            /* const char* */ _value_str);
}
Tao::TaoSetIntegerValue Tao::tao_set_integer_value(
  ...
  fortran_tao_set_integer_value(/* int& */ _var,
                                /* const char* */ _var_str,
                                /* const char* */ _value_str,
                                /* bool& */ _error,
                                /* int* */ _min_val,
...
std::string Tao::tao_set_invalid(
  ...
  fortran_tao_set_invalid(/* void* */ datum.get_fortran_ptr(),
                          /* const char* */ _message,
                          /* const char* */ _why_invalid,
                          /* bool* */ _exterminate,
                          /* int* */ _err_level,
...
Tao::TaoSetLogicalValue Tao::tao_set_logical_value(std::string var_str, std::string value_str) {
  ...
  auto _value_str = value_str.c_str();
  bool _error{};
  fortran_tao_set_logical_value(/* bool& */ _var,
                                /* const char* */ _var_str,
                                /* const char* */ _value_str,
                                /* bool& */ _error);
...
void Tao::tao_set_opt_vars(FArray1D<Real> &var_vec, std::optional<bool> print_limit_warning) {
  ...
  fortran_tao_set_opt_vars(/* Bmad::array_descriptor_t& */ _var_vec_desc,
...
void Tao::tao_set_plot_cmd(std::string plot_name, std::string component, std::string value_str) {
  ...
  auto _component = component.c_str();
  auto _value_str = value_str.c_str();
  fortran_tao_set_plot_cmd(/* const char* */ _plot_name,
                           /* const char* */ _component,
                           /* const char* */ _value_str);
}
void Tao::tao_set_plot_page_cmd(
  ...
  fortran_tao_set_plot_page_cmd(/* const char* */ _component,
                                /* const char* */ _value_str,
                                /* const char* */ _value_str2);
}
void Tao::tao_set_plotting(
  ...
  fortran_tao_set_plotting(/* void* */ plot_input.get_fortran_ptr(),
                           /* void* */ plot_page.get_fortran_ptr(),
                           /* bool& */ use_cmd_line_geom,
                           /* bool* */ _reverse);
}
...
Tao::TaoSetQpAxisStruct Tao::tao_set_qp_axis_struct(
  ...
  bool _error{};
  int _ix_uni{};
  fortran_tao_set_qp_axis_struct(/* const char* */ _qp_axis_name,
                                 /* const char* */ _component,
...
Tao::TaoSetQpPointStruct Tao::tao_set_qp_point_struct(
  ...
  bool _error{};
  int _ix_uni{};
  fortran_tao_set_qp_point_struct(/* const char* */ _qp_point_name,
                                  /* const char* */ _component,
...
Tao::TaoSetQpRectStruct Tao::tao_set_qp_rect_struct(
  ...
  bool _error{};
  int _ix_uni{};
  fortran_tao_set_qp_rect_struct(/* const char* */ _qp_rect_name,
                                 /* const char* */ _component,
...
Tao::TaoSetRealValue Tao::tao_set_real_value(
  ...
  fortran_tao_set_real_value(/* double& */ _var,
                             /* const char* */ _var_str,
                             /* const char* */ _value_str,
                             /* bool& */ _error,
                             /* double* */ _min_val,
...
void Tao::tao_set_region_cmd(
  ...
  auto _component = component.c_str();
  auto _value_str = value_str.c_str();
  fortran_tao_set_region_cmd(/* const char* */ _region_name,
                             /* const char* */ _component,
                             /* const char* */ _value_str);
}
...
void Tao::tao_set_symbolic_number_cmd(
  ...
  fortran_tao_set_symbolic_number_cmd(/* const char* */ _sym_str,
                                      /* const char* */ _num_str,
                                      /* double* */ _val);
}
void Tao::tao_set_tune_cmd(
  ...
  fortran_tao_set_tune_cmd(/* const char* */ _branch_str,
                           /* const char* */ _mask_str,
                           /* bool& */ print_list,
                           /* const char* */ _qa_str,
                           /* const char* */ _qb_str,
...
void Tao::tao_set_universe_cmd(std::string uni, std::string who, std::string what) {
  ...
  fortran_tao_set_universe_cmd(/* const char* */ _uni,
                               /* const char* */ _who,
                               /* const char* */ _what);
}
...
void Tao::tao_set_var_model_value(
  ...
  fortran_tao_set_var_model_value(/* void* */ var.get_fortran_ptr(),
                                  /* double& */ value,
                                  /* bool* */ _print_limit_warning);
}
...
void Tao::tao_set_z_tune_cmd(std::string branch_str, std::string q_str, bool delta_input) {
  auto _branch_str = branch_str.c_str();
  auto _q_str = q_str.c_str();
  fortran_tao_set_z_tune_cmd(/* const char* */ _branch_str,
                             /* const char* */ _q_str,
                             /* bool& */ delta_input);
}
...
bool Tao::tao_shape_init(TaoEleShapeStruct &shape, std::optional<bool> print_err) {
  ...
  fortran_tao_shape_init(/* void* */ shape.get_fortran_ptr(),
                         /* bool& */ _err,
                         /* bool* */ _print_err);
  return _err;
}
...
Tao::TaoShowThis Tao::tao_show_this(std::string what) {
  ...
  auto lines{CharacterAlloc1D()};
  int _nl{};
  fortran_tao_show_this(/* const char* */ _what,
...
bool Tao::tao_single_track(
  ...
  fortran_tao_single_track(/* void* */ tao_lat.get_fortran_ptr(),
                           /* bool& */ _calc_ok,
                           /* int& */ ix_branch,
                           /* bool* */ _print_err);
  return _calc_ok;
...
bool Tao::tao_spin_matrices_calc_needed(std::string data_type, std::string data_source) {
  ...
  auto _data_source = data_source.c_str();
  bool _do_calc{};
  fortran_tao_spin_matrices_calc_needed(/* const char* */ _data_type,
                                        /* const char* */ _data_source,
                                        /* bool& */ _do_calc);
  return _do_calc;
}
...
Tao::TaoSplitComponent Tao::tao_split_component(std::string comp_str) {
  ...
  bool _err{};
  fortran_tao_split_component(/* const char* */ _comp_str,
...
int Tao::tao_srdt_calc_needed(std::string data_type, std::string data_source) {
  ...
  auto _data_source = data_source.c_str();
  int _do_srdt{};
  fortran_tao_srdt_calc_needed(/* const char* */ _data_type,
                               /* const char* */ _data_source,
                               /* int& */ _do_srdt);
  return _do_srdt;
}
Tao::TaoSubinUniNumber Tao::tao_subin_uni_number(std::string name_in, int ix_uni) {
  ...
  char _name_out[4096];
  bool _ok{};
  fortran_tao_subin_uni_number(/* const char* */ _name_in,
                               /* int& */ ix_uni,
                               /* const char* */ _name_out,
                               /* bool& */ _ok);
...
void Tao::tao_to_change_number(
  ...
  fortran_tao_to_change_number(/* const char* */ _num_str,
                               /* int& */ n_size,
...
Tao::TaoToPhaseAndCouplingReading Tao::tao_to_phase_and_coupling_reading(
  ...
  bool _valid_value{};
  auto _why_invalid = why_invalid.c_str();
  fortran_tao_to_phase_and_coupling_reading(/* void* */ ele.get_fortran_ptr(),
...
void Tao::tao_to_top10(
  ...
  // top10: TaoTop10Struct inout (CppWrapperTypeArgumentArray)
  Bmad::array_descriptor_t _top10_desc;
  _top10_desc.rank = 1;
  _top10_desc.data_ptr = top10.data();
  _top10_desc.dims[0] = top10.size();
  _top10_desc.strides[0] = 1;
  auto _name = name.c_str();
  auto _order = order.c_str();
  fortran_tao_to_top10(/* Bmad::array_descriptor_t& */ _top10_desc,
                       /* double& */ value,
                       /* const char* */ _name,
                       /* int& */ c_index,
                       /* const char* */ _order);
...
Tao::TaoTrackingEleIndex Tao::tao_tracking_ele_index(EleStruct &ele, TaoDataStruct &datum) {
  ...
  int _ix_branch{};
  int _ix_ele{};
  fortran_tao_tracking_ele_index(/* void* */ &ele,
                                 /* void* */ datum.get_fortran_ptr(),
                                 /* int& */ _ix_branch,
                                 /* int& */ _ix_ele);
...
int Tao::tao_universe_index(int i_uni, std::optional<bool> neg2_to_default) {
  ...
  int _i_this_uni{};
  fortran_tao_universe_index(/* int& */ i_uni,
                             /* bool* */ _neg2_to_default,
                             /* int& */ _i_this_uni);
  return _i_this_uni;
}
...
std::string Tao::tao_var_attrib_name(TaoVarStruct &var) {
  ...
  fortran_tao_var_attrib_name(/* void* */ var.get_fortran_ptr(),
...
void Tao::tao_var_check(ElePointerStructAlloc1D eles, std::string attribute, bool silent) {
  // intent=in allocatable type array
  auto _attribute = attribute.c_str();
  fortran_tao_var_check(/* void* */ eles.get_fortran_ptr(),
                        /* const char* */ _attribute,
                        /* bool& */ silent);
}
...
void Tao::tao_var_show_use(
  ...
  fortran_tao_var_show_use(/* void* */ v1_var.get_fortran_ptr(),
                           /* void* */ _lines,
                           /* int* */ _nl);
}
...
void Tao::tao_var_useit_plot_calc(TaoGraphStruct &graph, TaoVarStructArray1D var) {
  ...
  fortran_tao_var_useit_plot_calc(/* void* */ graph.get_fortran_ptr(),
                                  /* Bmad::array_descriptor_t& */ _var_desc);
}
void Tao::tao_var_write(
  ...
  fortran_tao_var_write(/* const char* */ _out_file,
                        /* bool* */ _show_good_opt_only,
                        /* bool* */ _tao_format);
}
...
void Tao::tao_wave_cmd(std::string curve_name, std::string plot_place, bool err_flag) {
  ...
  fortran_tao_wave_cmd(/* const char* */ _curve_name,
...
void Tao::tao_wave_fit(
  ...
  fortran_tao_wave_fit(/* void* */ curve.get_fortran_ptr(),
                       /* int& */ ix1,
                       /* int& */ n_dat,
                       /* Bmad::array_descriptor_t& */ _coef_desc,
                       /* Bmad::array_descriptor_t& */ _rms_desc,
...
bool Tao::tao_x_scale_cmd(
  ...
  fortran_tao_x_scale_cmd(/* const char* */ _where,
                          /* double& */ x_min_in,
                          /* double& */ x_max_in,
                          /* bool& */ _err,
                          /* bool* */ _include_wall,
...
void Tao::tao_x_scale_graph(
  ...
  fortran_tao_x_scale_graph(/* void* */ graph.get_fortran_ptr(),
                            /* double& */ x_min,
                            /* double& */ x_max,
                            /* bool* */ _include_wall,
                            /* bool* */ _have_scaled);
...
bool Tao::tao_x_scale_plot(
  ...
  const char *_gang = gang.has_value() ? gang->c_str() : nullptr;
  bool _have_scaled{};
  fortran_tao_x_scale_plot(/* void* */ plot.get_fortran_ptr(),
                           /* double& */ x_min_in,
                           /* double& */ x_max_in,
                           /* bool* */ _include_wall,
                           /* const char* */ _gang,
