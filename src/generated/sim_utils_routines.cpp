...
void SimUtils::apfft(
  ...
  fortran_apfft(/* Bmad::array_descriptor_t& */ _rdata_in_desc,
                /* Bmad::array_descriptor_t& */ _bounds_desc,
                /* const char* */ _window,
                /* double& */ phase,
                /* int* */ _diag);
...
SimUtils::ApfftCorr SimUtils::apfft_corr(
  ...
  fortran_apfft_corr(/* Bmad::array_descriptor_t& */ _rdata_in_desc,
                     /* Bmad::array_descriptor_t& */ _bounds_desc,
                     /* const char* */ _window,
                     /* double& */ _phase,
                     /* double& */ _amp,
...
void SimUtils::apfft_ext(
  ...
  fortran_apfft_ext(/* Bmad::array_descriptor_t& */ _rdata_desc,
                    /* Bmad::array_descriptor_t& */ _bounds_desc,
                    /* const char* */ _window,
                    /* double& */ phase,
                    /* double& */ amp,
...
int SimUtils::assert_equal(FArray1D<Int> &int_arr, std::string err_str) {
  ...
  int _ival{};
  fortran_assert_equal(/* Bmad::array_descriptor_t& */ _int_arr_desc,
                       /* const char* */ _err_str,
                       /* int& */ _ival);
  return _ival;
}
...
int SimUtils::atomic_species_id(int charge, bool is_anti, int atomic_num, int n_nuc) {
  int _species_id{};
  fortran_atomic_species_id(/* int& */ charge,
                            /* bool& */ is_anti,
                            /* int& */ atomic_num,
                            /* int& */ n_nuc,
                            /* int& */ _species_id);
...
FixedArray1D<Real, 4> SimUtils::axis_angle_to_quat(FixedArray1D<Real, 3> axis, double angle) {
  ...
  fortran_axis_angle_to_quat(/* Bmad::array_descriptor_t& */ _axis_desc,
                             /* double& */ angle,
                             /* Bmad::array_descriptor_t& */ _quat_desc);
  return _quat;
}
FixedArray2D<Real, 3, 3> SimUtils::axis_angle_to_w_mat(FixedArray1D<Real, 3> axis, double angle) {
  ...
  fortran_axis_angle_to_w_mat(/* Bmad::array_descriptor_t& */ _axis_desc,
                              /* double& */ angle,
                              /* Bmad::array_descriptor_t& */ _w_mat_desc);
...
SimUtils::bicubic_cmplx_eval(double x_norm, double y_norm, BicubicCmplxCoefStruct &bi_coef) {
  ...
  fortran_bicubic_cmplx_eval(/* double& */ x_norm,
                             /* double& */ y_norm,
...
SimUtils::bicubic_eval(double x_norm, double y_norm, BicubicCoefStruct &bi_coef) {
  double _df_dx{};
  double _df_dy{};
  double _f_val{};
  fortran_bicubic_eval(/* double& */ x_norm,
                       /* double& */ y_norm,
                       /* void* */ bi_coef.get_fortran_ptr(),
                       /* double& */ _df_dx,
                       /* double& */ _df_dy,
                       /* double& */ _f_val);
  return BicubicEval{_df_dx, _df_dy, _f_val};
}
BicubicCmplxCoefStruct SimUtils::bicubic_interpolation_cmplx_coefs(
...
GeneralBinStruct SimUtils::bin_2d(
    FArray1D<Real> &data1,
    FArray1D<Real> &data2,
    std::optional<FArray1D<Real>> weight,
    std::optional<double> min1,
    std::optional<double> max1,
    std::optional<double> min2,
    std::optional<double> max2,
    std::optional<int> n_bins1,
    std::optional<int> n_bins2
) {
  // data1: in NOT (CppWrapperGeneralArgumentArray) ([':'])
  Bmad::array_descriptor_t _data1_desc;
  _data1_desc.rank = 1;
  _data1_desc.data_ptr = data1.data();
  _data1_desc.dims[0] = data1.size();
  // data2: in NOT (CppWrapperGeneralArgumentArray) ([':'])
  Bmad::array_descriptor_t _data2_desc;
  _data2_desc.rank = 1;
  _data2_desc.data_ptr = data2.data();
  _data2_desc.dims[0] = data2.size();
  // weight: in NOT (CppWrapperGeneralArgumentArray) ([':'])
  Bmad::array_descriptor_t _weight_desc;
  _weight_desc.rank = 1;
  if (weight.has_value()) {
    _weight_desc.data_ptr = weight->data();
    _weight_desc.dims[0] = weight->size();
  } else {
    _weight_desc.data_ptr = nullptr;
    _weight_desc.dims[0] = 0;
  }
  double min1_lvalue;
  auto *_min1{&min1_lvalue};
  if (min1.has_value()) {
    min1_lvalue = min1.value();
  } else {
    _min1 = nullptr;
  }
  double max1_lvalue;
  auto *_max1{&max1_lvalue};
  if (max1.has_value()) {
    max1_lvalue = max1.value();
  } else {
    _max1 = nullptr;
  }
  double min2_lvalue;
  auto *_min2{&min2_lvalue};
  if (min2.has_value()) {
    min2_lvalue = min2.value();
  } else {
    _min2 = nullptr;
  }
  double max2_lvalue;
  auto *_max2{&max2_lvalue};
  if (max2.has_value()) {
    max2_lvalue = max2.value();
  } else {
    _max2 = nullptr;
  }
  int n_bins1_lvalue;
  auto *_n_bins1{&n_bins1_lvalue};
  if (n_bins1.has_value()) {
    n_bins1_lvalue = n_bins1.value();
  } else {
    _n_bins1 = nullptr;
  }
  int n_bins2_lvalue;
  auto *_n_bins2{&n_bins2_lvalue};
  if (n_bins2.has_value()) {
    n_bins2_lvalue = n_bins2.value();
  } else {
    _n_bins2 = nullptr;
  }
  GeneralBinStruct _bin_data;
  fortran_bin_2d(/* Bmad::array_descriptor_t& */ _data1_desc,
                 /* Bmad::array_descriptor_t& */ _data2_desc,
                 /* Bmad::array_descriptor_t& */ _weight_desc,
                 /* double* */ _min1,
                 /* double* */ _max1,
                 ...
                 /* int* */ _n_bins1,
                 /* int* */ _n_bins2,
                 /* void* */ _bin_data.get_fortran_ptr());
  return std::move(_bin_data);
}
BinStruct SimUtils::bin_data(
    FArray1D<Real> &data,
    std::optional<FArray1D<Real>> weight,
    std::optional<double> min,
    std::optional<double> max,
    std::optional<int> n_bins
) {
  ...
  double min_lvalue;
  auto *_min{&min_lvalue};
  if (min.has_value()) {
    min_lvalue = min.value();
  } else {
    _min = nullptr;
  }
  double max_lvalue;
  auto *_max{&max_lvalue};
  if (max.has_value()) {
    max_lvalue = max.value();
  } else {
    _max = nullptr;
  }
  int n_bins_lvalue;
  auto *_n_bins{&n_bins_lvalue};
  if (n_bins.has_value()) {
    n_bins_lvalue = n_bins.value();
  } else {
    _n_bins = nullptr;
  }
  BinStruct _binned_data;
  fortran_bin_data(/* Bmad::array_descriptor_t& */ _data_desc,
                   /* Bmad::array_descriptor_t& */ _weight_desc,
                   /* double* */ _min,
                   /* double* */ _max,
                   /* int* */ _n_bins,
                   /* void* */ _binned_data.get_fortran_ptr());
  return std::move(_binned_data);
}
double SimUtils::bin_data_density(BinStruct &bin_data, double x, std::optional<int> order) {
  int order_lvalue;
...
double SimUtils::bin_x_center(int &ix_bin, double bin1_x_min, double bin_delta) {
  double _x_center{};
  fortran_bin_x_center(/* int& */ ix_bin,
                       /* double& */ bin1_x_min,
                       /* double& */ bin_delta,
                       /* double& */ _x_center);
  return _x_center;
...
SimUtils::BracketIndexForSpline SimUtils::bracket_index_for_spline(
  ...
  bool _ok{};
  fortran_bracket_index_for_spline(/* Bmad::array_descriptor_t& */ _x_knot_desc,
                                   /* double& */ x,
                                   /* int& */ _ix0,
                                   /* bool* */ _strict,
                                   /* bool* */ _print_err,
...
void SimUtils::calc_file_number(std::string file_name, int num_in, int num_out, bool err_flag) {
  ...
  fortran_calc_file_number(/* const char* */ _file_name,
                           /* int& */ num_in,
                           /* int& */ num_out,
                           /* bool& */ err_flag);
}
...
int SimUtils::cesr_iargc() {
  int _func_retval__{};
  fortran_cesr_iargc(/* int& */ _func_retval__);
...
double SimUtils::coarse_frequency_estimate(FArray1D<Real> &data, std::optional<bool> error) {
  ...
  double _frequency{};
  fortran_coarse_frequency_estimate(/* Bmad::array_descriptor_t& */ _data_desc,
                                    /* bool* */ _error,
                                    /* double& */ _frequency);
  return _frequency;
}
void SimUtils::complex_error_function(double wr, double wi, double zr, double zi) {
  fortran_complex_error_function(/* double& */ wr,
                                 /* double& */ wi,
                                 /* double& */ zr,
                                 /* double& */ zi);
}
...
SimUtils::create_a_spline(FArray1D<Real> &r0, FArray1D<Real> &r1, double slope0, double slope1) {
  ...
  fortran_create_a_spline(/* Bmad::array_descriptor_t& */ _r0_desc,
                          /* Bmad::array_descriptor_t& */ _r1_desc,
                          /* double& */ slope0,
                          /* double& */ slope1,
...
FixedArray1D<Real, 3> SimUtils::cross_product(FArray1D<Real> &a, FArray1D<Real> &b) {
  ...
  fortran_cross_product(/* Bmad::array_descriptor_t& */ _a_desc,
                        /* Bmad::array_descriptor_t& */ _b_desc,
                        /* Bmad::array_descriptor_t& */ _c_desc);
  return _c;
}
void SimUtils::date_and_time_stamp(
  ...
  fortran_date_and_time_stamp(/* const char* */ _string,
                              /* bool* */ _numeric_month,
                              /* bool* */ _include_zone);
}
...
void SimUtils::display_size_and_resolution(
  ...
  fortran_display_size_and_resolution(/* int& */ ix_screen,
                                      /* double& */ x_size,
                                      /* double& */ y_size,
                                      /* double& */ x_res,
                                      /* double& */ y_res);
...
int SimUtils::djb_hash(std::string str, std::optional<int> old_hash) {
  auto _str = str.c_str();
  int old_hash_lvalue;
  ...
  int _hash{};
  fortran_djb_hash(/* const char* */ _str, /* int* */ _old_hash, /* int& */ _hash);
  return _hash;
}
std::string SimUtils::djb_str_hash(std::string in_str) {
...
void SimUtils::faddeeva_function(
  ...
  fortran_faddeeva_function(/* Bmad::array_descriptor_t& */ _z_desc,
                            /* Bmad::array_descriptor_t& */ _w_desc,
                            /* Bmad::array_descriptor_t& */ _dw_desc);
  vec_to_matrix(_dw_vec, dw);
}
void SimUtils::fff_sub(std::string line, bool error) {
  auto _line = line.c_str();
  fortran_fff_sub(/* const char* */ _line, /* bool& */ error);
}
...
void SimUtils::file_directorizer(
  ...
  fortran_file_directorizer(/* const char* */ _in_file,
...
void SimUtils::file_get(std::string string, std::string dflt_file_name, std::string file_name) {
  ...
  auto _file_name = file_name.c_str();
  fortran_file_get(/* const char* */ _string,
...
void SimUtils::file_get_open(
  ...
  auto _dflt_file_name = dflt_file_name.c_str();
  auto _file_name = file_name.c_str();
  fortran_file_get_open(/* const char* */ _string,
                        /* const char* */ _dflt_file_name,
                        /* const char* */ _file_name,
                        /* int& */ file_unit,
                        /* bool& */ readonly);
...
void SimUtils::file_suffixer(
  ...
  fortran_file_suffixer(/* const char* */ _in_file_name,
                        /* const char* */ _out_file_name,
                        /* const char* */ _suffix,
                        /* bool& */ add_switch);
}
int SimUtils::find_location(FArray1D<Int> &arr, int value) {
  // arr: inout NOT (CppWrapperGeneralArgumentArray) ([':'])
  Bmad::array_descriptor_t _arr_desc;
  _arr_desc.rank = 1;
  _arr_desc.data_ptr = arr.data();
  _arr_desc.dims[0] = arr.size();
  int _ix_match{};
  fortran_find_location_int(/* Bmad::array_descriptor_t& */ _arr_desc,
                            /* int& */ value,
                            /* int& */ _ix_match);
  return _ix_match;
}
...
int SimUtils::find_location(FArray1D<Real> &arr, double value) {
  ...
  _arr_desc.dims[0] = arr.size();
  int _ix_match{};
  fortran_find_location_real(/* Bmad::array_descriptor_t& */ _arr_desc,
                             /* double& */ value,
                             /* int& */ _ix_match);
  return _ix_match;
}
int SimUtils::find_location(CharacterAlloc1D &arr, std::string value) {
...
double SimUtils::fine_frequency_estimate(FArray1D<Real> &data) {
  ...
  _data_desc.dims[0] = data.size();
  double _frequency{};
  fortran_fine_frequency_estimate(/* Bmad::array_descriptor_t& */ _data_desc,
                                  /* double& */ _frequency);
  return _frequency;
}
double SimUtils::fixedwindowls(double ynew, int id) {
  double _z{};
  fortran_fixedwindowls(/* double& */ ynew, /* int& */ id, /* double& */ _z);
  return _z;
}
SimUtils::FourierAmplitude SimUtils::fourier_amplitude(FArray1D<Real> &data, double frequency) {
  ...
  double _dcos_amp{};
  double _dsin_amp{};
  fortran_fourier_amplitude(/* Bmad::array_descriptor_t& */ _data_desc,
                            /* double& */ frequency,
                            /* double& */ _cos_amp,
                            /* double& */ _sin_amp,
                            /* double& */ _dcos_amp,
...
double SimUtils::gen_complete_elliptic(
  ...
  double _value{};
  fortran_gen_complete_elliptic(/* double& */ kc,
                                /* double& */ p,
                                /* double& */ c,
                                /* double& */ s,
                                /* double* */ _err_tol,
...
double SimUtils::general_bin_count(
    GeneralBinStruct &bin_data,
    int ix1,
    std::optional<int> ix2,
    std::optional<int> ix3
) {
  int ix2_lvalue;
  ...
  int ix3_lvalue;
  auto *_ix3{&ix3_lvalue};
  if (ix3.has_value()) {
    ix3_lvalue = ix3.value();
  } else {
    _ix3 = nullptr;
  }
  double _count{};
...
void SimUtils::get_file_number(
  ...
  fortran_get_file_number(/* const char* */ _file_name,
                          /* const char* */ _cnum_in,
                          /* int& */ num_out,
                          /* bool& */ err_flag);
}
...
void SimUtils::get_next_number(std::string filein, std::string cnum, int digits) {
  auto _filein = filein.c_str();
  auto _cnum = cnum.c_str();
  fortran_get_next_number(/* const char* */ _filein, /* const char* */ _cnum, /* int& */ digits);
}
...
void SimUtils::increment_file_number(
  ...
  fortran_increment_file_number(/* const char* */ _file_name,
                                /* int& */ digits,
                                /* int& */ number,
                                /* const char* */ _cnumber);
}
int SimUtils::index_nocase(std::string string1, std::string string2) {
  auto _string1 = string1.c_str();
  auto _string2 = string2.c_str();
  int _indx{};
  fortran_index_nocase(/* const char* */ _string1, /* const char* */ _string2, /* int& */ _indx);
  return _indx;
}
int SimUtils::initfixedwindowls(int N, double dt, int order, int der) {
  int _id{};
  fortran_initfixedwindowls(/* int& */ N,
                            /* double& */ dt,
                            /* int& */ order,
                            /* int& */ der,
                            /* int& */ _id);
...
std::string SimUtils::int_str(int int_, std::optional<int> width) {
  int width_lvalue;
...
double SimUtils::interpolated_fft(
  ...
  double _this_fft{};
  fortran_interpolated_fft(/* Bmad::array_descriptor_t& */ _cdata_desc,
                           /* bool& */ calc_ok,
...
double SimUtils::interpolated_fft_gsl(
    FArray1D<Complex> &cdata,
    bool calc_ok,
    std::optional<int> opt_dump_spectrum,
    std::optional<int> opt_dump_index
  ...
  double _this_fft{};
  fortran_interpolated_fft_gsl(/* Bmad::array_descriptor_t& */ _cdata_desc,
                               /* bool& */ calc_ok,
                               /* int* */ _opt_dump_spectrum,
                               /* int* */ _opt_dump_index,
                               /* double& */ _this_fft);
...
double SimUtils::inverse_prob(double val) {
  double _prob{};
  fortran_inverse_prob(/* double& */ val, /* double& */ _prob);
  return _prob;
}
bool SimUtils::is_alphabetic(std::string string, std::optional<std::string> valid_chars) {
  auto _string = string.c_str();
  const char *_valid_chars = valid_chars.has_value() ? valid_chars->c_str() : nullptr;
  bool _is_alpha{};
  fortran_is_alphabetic(/* const char* */ _string,
...
bool SimUtils::is_decreasing_sequence(FArray1D<Real> &array, std::optional<bool> strict) {
  ...
  bool _is_decreasing{};
  fortran_is_decreasing_sequence(/* Bmad::array_descriptor_t& */ _array_desc,
                                 /* bool* */ _strict,
                                 /* bool& */ _is_decreasing);
...
bool SimUtils::is_increasing_sequence(FArray1D<Real> &array, std::optional<bool> strict) {
  ...
  bool _is_increasing{};
  fortran_is_increasing_sequence(/* Bmad::array_descriptor_t& */ _array_desc,
                                 /* bool* */ _strict,
                                 /* bool& */ _is_increasing);
  return _is_increasing;
}
bool SimUtils::is_integer(
    std::string string,
  ...
  bool _valid{};
  fortran_is_integer(/* const char* */ _string,
                     /* int* */ _int_,
                     /* const char* */ _delims,
                     /* int* */ _ix_word,
                     /* bool& */ _valid);
...
bool SimUtils::is_logical(std::string string, std::optional<bool> ignore) {
  auto _string = string.c_str();
  bool ignore_lvalue;
  ...
  bool _valid{};
  fortran_is_logical(/* const char* */ _string, /* bool* */ _ignore, /* bool& */ _valid);
  return _valid;
}
bool SimUtils::is_real(
    std::string string,
  ...
  bool _valid{};
  fortran_is_real(/* const char* */ _string,
                  /* bool* */ _ignore,
                  /* double* */ _real_num,
                  /* bool& */ _valid);
  return _valid;
...
void SimUtils::linear_fit(
  ...
  fortran_linear_fit(/* Bmad::array_descriptor_t& */ _x_desc,
                     /* Bmad::array_descriptor_t& */ _y_desc,
                     /* int& */ n_data,
                     /* double& */ a,
                     /* double& */ b,
...
SimUtils::linear_fit_2d(FArray1D<Real> &x, FArray1D<Real> &y, FArray1D<Real> &z) {
  ...
  fortran_linear_fit_2d(/* Bmad::array_descriptor_t& */ _x_desc,
                        /* Bmad::array_descriptor_t& */ _y_desc,
                        /* Bmad::array_descriptor_t& */ _z_desc,
                        /* Bmad::array_descriptor_t& */ _coef_desc);
  return _coef;
}
std::string SimUtils::logic_str(bool logic) {
  char _str[4096];
...
bool SimUtils::match_reg(std::string str, std::string pat) {
  auto _str = str.c_str();
  auto _pat = pat.c_str();
  bool _is_match{};
  fortran_match_reg(/* const char* */ _str, /* const char* */ _pat, /* bool& */ _is_match);
  return _is_match;
}
bool SimUtils::match_wild(std::string string, std::string template_) {
  auto _string = string.c_str();
  auto _template_ = template_.c_str();
  bool _is_match{};
  fortran_match_wild(/* const char* */ _string,
...
void SimUtils::match_word(
  ...
  fortran_match_word(/* const char* */ _string,
...
double SimUtils::maximize_projection(double seed, FArray1D<Complex> &cdata) {
  // cdata: inout NOT (CppWrapperGeneralArgumentArray) ([':'])
  Bmad::array_descriptor_t _cdata_desc;
  _cdata_desc.rank = 1;
  _cdata_desc.data_ptr = cdata.data();
  ...
  fortran_maximize_projection(/* double& */ seed,
                              /* Bmad::array_descriptor_t& */ _cdata_desc,
                              /* double& */ _func_retval__);
  return _func_retval__;
}
...
MolecularComponentStructAlloc1D SimUtils::molecular_components(std::string molecule) {
  auto _molecule = molecule.c_str();
  // intent=out allocatable type array
  auto component{MolecularComponentStructAlloc1D()};
  fortran_molecular_components(/* const char* */ _molecule,
                               /* void* */ component.get_fortran_ptr());
  return std::move(component);
}
int SimUtils::n_bins_automatic(int n_data) {
  int _n{};
  fortran_n_bins_automatic(/* int& */ n_data, /* int& */ _n);
  return _n;
}
...
void SimUtils::n_spline_create(
  ...
  fortran_n_spline_create(/* Bmad::array_descriptor_t& */ _deriv0_desc,
                          /* Bmad::array_descriptor_t& */ _deriv1_desc,
                          /* double& */ x1,
                          /* Bmad::array_descriptor_t& */ _n_spline_desc);
}
void SimUtils::naff(
  ...
  fortran_naff(/* Bmad::array_descriptor_t& */ _cdata_desc,
               /* Bmad::array_descriptor_t& */ _freqs_desc,
               /* Bmad::array_descriptor_t& */ _amps_desc,
...
FixedArray1D<Real, 4> SimUtils::omega_to_quat(FixedArray1D<Real, 3> omega) {
  ...
  _quat_desc.data_ptr = _quat.data();
  _quat_desc.dims[0] = _quat.size();
  fortran_omega_to_quat(/* Bmad::array_descriptor_t& */ _omega_desc,
                        /* Bmad::array_descriptor_t& */ _quat_desc);
  return _quat;
}
...
std::string SimUtils::ordinal_str(int n) {
  char _str[4096];
  fortran_ordinal_str(/* int& */ n, /* const char* */ _str);
  return _str;
}
std::string SimUtils::out_io_buffer_get_line(int ix_line) {
  char _line[4096];
  fortran_out_io_buffer_get_line(/* int& */ ix_line, /* const char* */ _line);
  return _line;
}
int SimUtils::out_io_buffer_num_lines() {
  int _n_lines{};
  fortran_out_io_buffer_num_lines(/* int& */ _n_lines);
  return _n_lines;
}
...
void SimUtils::out_io(
  ...
  fortran_out_io_line12(/* int& */ level,
                        /* const char* */ _routine_name,
                        /* const char* */ _line1,
                        /* const char* */ _line2,
                        /* const char* */ _line3,
...
void SimUtils::out_io(
  ...
  fortran_out_io_lines(/* int& */ level,
                       /* const char* */ _routine_name,
...
void SimUtils::out_io(
  ...
  fortran_out_io_logical(/* int& */ level,
                         /* const char* */ _routine_name,
                         /* const char* */ _line,
                         /* bool& */ l_num,
                         /* bool* */ _insert_tag_line);
...
void SimUtils::out_io_print_and_capture_setup(
  ...
  fortran_out_io_print_and_capture_setup(/* bool* */ _print_on,
...
void SimUtils::out_io(
  ...
  fortran_out_io_real(/* int& */ level,
                      /* const char* */ _routine_name,
                      /* const char* */ _line,
                      /* double& */ r_num,
                      /* bool* */ _insert_tag_line);
}
OutIoOutputDirectStruct SimUtils::output_direct(
    std::optional<int> file_unit,
    std::optional<bool> print_and_capture,
    std::optional<int> min_level,
    std::optional<int> max_level,
    optional_ref<OutIoOutputDirectStruct> set
) {
  ...
  bool print_and_capture_lvalue;
  auto *_print_and_capture{&print_and_capture_lvalue};
  if (print_and_capture.has_value()) {
    print_and_capture_lvalue = print_and_capture.value();
  } else {
    _print_and_capture = nullptr;
  }
  int min_level_lvalue;
  auto *_min_level{&min_level_lvalue};
  if (min_level.has_value()) {
    min_level_lvalue = min_level.value();
  } else {
    _min_level = nullptr;
  }
  int max_level_lvalue;
  auto *_max_level{&max_level_lvalue};
  if (max_level.has_value()) {
    max_level_lvalue = max_level.value();
  } else {
    _max_level = nullptr;
  }
  auto *_set = set.has_value() ? set->get().get_fortran_ptr() : nullptr; // input, optional
  OutIoOutputDirectStruct _get;
  fortran_output_direct(/* int* */ _file_unit,
                        /* bool* */ _print_and_capture,
                        /* int* */ _min_level,
                        /* int* */ _max_level,
                        /* void* */ _set,
                        /* void* */ _get.get_fortran_ptr());
...
void SimUtils::parse_fortran_format(
  ...
  fortran_parse_fortran_format(/* const char* */ _format_str,
                               /* int& */ n_repeat,
                               /* int& */ power,
                               /* const char* */ _descrip,
                               /* int& */ width,
...
void SimUtils::pointer_to_locations(
  ...
  fortran_pointer_to_locations(/* const char* */ _string,
...
std::optional<RandomStateStruct> SimUtils::pointer_to_ran_state(
  ...
  void *_ran_state_ptr;
  fortran_pointer_to_ran_state(/* void* */ _ran_state,
                               /* int* */ _ix_thread,
                               /* void* */ &_ran_state_ptr);
  return std::move(
...
double SimUtils::poly_eval(FArray1D<Real> &poly, double x, std::optional<bool> diff_coef) {
  ...
  double _y{};
  fortran_poly_eval(/* Bmad::array_descriptor_t& */ _poly_desc,
                    /* double& */ x,
                    /* bool* */ _diff_coef,
                    /* double& */ _y);
  return _y;
}
double SimUtils::probability_funct(double x) {
  double _prob{};
  fortran_probability_funct(/* double& */ x, /* double& */ _prob);
  return _prob;
}
std::complex<double> SimUtils::projdd(FArray1D<Complex> &a, FArray1D<Complex> &b) {
  ...
  _b_desc.data_ptr = b.data();
  _b_desc.dims[0] = b.size();
  std::complex<double> _func_retval__{};
  fortran_projdd(/* Bmad::array_descriptor_t& */ _a_desc,
                 /* Bmad::array_descriptor_t& */ _b_desc,
                 /* std::complex<double>& */ _func_retval__);
  return _func_retval__;
}
FixedArray1D<Complex, 2> SimUtils::quadratic_roots(FixedArray1D<Real, 3> coefs) {
  ...
  fortran_quadratic_roots(/* Bmad::array_descriptor_t& */ _coefs_desc,
                          /* Bmad::array_descriptor_t& */ _root_desc);
  return _root;
}
FixedArray1D<Complex, 4> SimUtils::quat_conj(FixedArray1D<Complex, 4> q_in) {
  ...
  fortran_quat_conj_complex(/* Bmad::array_descriptor_t& */ _q_in_desc,
                            /* Bmad::array_descriptor_t& */ _q_out_desc);
  return _q_out;
}
FixedArray1D<Real, 4> SimUtils::quat_conj(FixedArray1D<Real, 4> q_in) {
  ...
  _q_out_desc.data_ptr = _q_out.data();
  _q_out_desc.dims[0] = _q_out.size();
  fortran_quat_conj_real(/* Bmad::array_descriptor_t& */ _q_in_desc,
                         /* Bmad::array_descriptor_t& */ _q_out_desc);
  return _q_out;
}
FixedArray1D<Real, 4> SimUtils::quat_inverse(FixedArray1D<Real, 4> q_in) {
  ...
  _q_out_desc.data_ptr = _q_out.data();
  _q_out_desc.dims[0] = _q_out.size();
  fortran_quat_inverse(/* Bmad::array_descriptor_t& */ _q_in_desc,
                       /* Bmad::array_descriptor_t& */ _q_out_desc);
  return _q_out;
}
FixedArray1D<Complex, 4> SimUtils::quat_mul(
  ...
  _q_out_desc.data_ptr = _q_out.data();
  _q_out_desc.dims[0] = _q_out.size();
  fortran_quat_mul_complex(/* Bmad::array_descriptor_t& */ _q1_desc,
                           /* Bmad::array_descriptor_t& */ _q2_desc,
                           /* Bmad::array_descriptor_t& */ _q3_desc,
                           /* Bmad::array_descriptor_t& */ _q4_desc,
                           /* Bmad::array_descriptor_t& */ _q5_desc,
...
FixedArray1D<Real, 4> SimUtils::quat_mul(
  ...
  _q_out_desc.data_ptr = _q_out.data();
  _q_out_desc.dims[0] = _q_out.size();
  fortran_quat_mul_real(/* Bmad::array_descriptor_t& */ _q1_desc,
                        /* Bmad::array_descriptor_t& */ _q2_desc,
                        /* Bmad::array_descriptor_t& */ _q3_desc,
                        /* Bmad::array_descriptor_t& */ _q4_desc,
                        /* Bmad::array_descriptor_t& */ _q5_desc,
...
SimUtils::quat_rotate(FixedArray1D<Complex, 4> quat, FixedArray1D<Complex, 3> vec_in) {
  ...
  fortran_quat_rotate_complex(/* Bmad::array_descriptor_t& */ _quat_desc,
                              /* Bmad::array_descriptor_t& */ _vec_in_desc,
                              /* Bmad::array_descriptor_t& */ _vec_out_desc);
  return _vec_out;
}
...
SimUtils::quat_rotate(FixedArray1D<Real, 4> quat, FixedArray1D<Real, 3> vec_in) {
  ...
  _vec_out_desc.data_ptr = _vec_out.data();
  _vec_out_desc.dims[0] = _vec_out.size();
  fortran_quat_rotate_real(/* Bmad::array_descriptor_t& */ _quat_desc,
                           /* Bmad::array_descriptor_t& */ _vec_in_desc,
                           /* Bmad::array_descriptor_t& */ _vec_out_desc);
  return _vec_out;
}
SimUtils::QuatToAxisAngle SimUtils::quat_to_axis_angle(FixedArray1D<Real, 4> quat) {
  ...
  double _angle{};
  fortran_quat_to_axis_angle(/* Bmad::array_descriptor_t& */ _quat_desc,
                             /* Bmad::array_descriptor_t& */ _axis_desc,
                             /* double& */ _angle);
...
FixedArray1D<Real, 3> SimUtils::quat_to_omega(FixedArray1D<Real, 4> quat) {
  ...
  fortran_quat_to_omega(/* Bmad::array_descriptor_t& */ _quat_desc,
                        /* Bmad::array_descriptor_t& */ _omega_desc);
  return _omega;
}
FixedArray2D<Real, 3, 3> SimUtils::quat_to_w_mat(FixedArray1D<Real, 4> quat) {
  ...
  _w_mat_desc.dims[0] = 3;
  _w_mat_desc.dims[1] = 3;
  fortran_quat_to_w_mat(/* Bmad::array_descriptor_t& */ _quat_desc,
                        /* Bmad::array_descriptor_t& */ _w_mat_desc);
  vec_to_matrix(_w_mat_vec, w_mat);
  return w_mat;
}
void SimUtils::query_string(
  ...
  fortran_query_string(/* const char* */ _query_str,
                       /* bool& */ upcase,
                       /* const char* */ _return_str,
                       /* int& */ ix,
                       /* int& */ ios);
}
std::string SimUtils::quote(std::string str) {
  auto _str = str.c_str();
  char _q_str[4096];
  fortran_quote(/* const char* */ _str, /* const char* */ _q_str);
  return _q_str;
}
std::string SimUtils::quoten(CharacterAlloc1D &str, std::optional<std::string> delim) {
  // intent=inout character array container
...
SimUtils::RanGaussConverter SimUtils::ran_gauss_converter(
  ...
  auto *_ran_state =
      ran_state.has_value() ? ran_state->get().get_fortran_ptr() : nullptr; // input, optional
  fortran_ran_gauss_converter(/* const char* */ _set,
...
double SimUtils::ran_gauss_scalar(
  ...
  fortran_ran_gauss_scalar(/* double& */ _harvest,
                           /* void* */ _ran_state,
                           /* double* */ _sigma_cut,
                           /* int* */ _index_quasi);
  return _harvest;
...
void SimUtils::ran_gauss_vector(
  ...
  fortran_ran_gauss_vector(/* Bmad::array_descriptor_t& */ _harvest_desc,
                           /* void* */ _ran_state,
                           /* double* */ _sigma_cut);
}
...
void SimUtils::ran_seed_put(std::optional<int> seed, std::optional<int> mpi_offset) {
  int seed_lvalue;
  auto *_seed{&seed_lvalue};
  if (seed.has_value()) {
    seed_lvalue = seed.value();
  } else {
    _seed = nullptr;
  }
  ...
  fortran_ran_seed_put(/* int* */ _seed, /* int* */ _mpi_offset);
}
double
SimUtils::ran_uniform(optional_ref<RandomStateStruct> ran_state, std::optional<int> index_quasi) {
  ...
  fortran_ran_uniform_scalar(/* double& */ _harvest,
                             /* void* */ _ran_state,
                             /* int* */ _index_quasi);
  return _harvest;
}
...
std::string SimUtils::read_a_line(
  ...
  fortran_read_a_line(/* const char* */ _prompt,
...
std::string
SimUtils::real_num_fortran_format(double number, int width, std::optional<int> n_blanks) {
  int n_blanks_lvalue;
  ...
  char _fmt_str[4096];
  fortran_real_num_fortran_format(/* double& */ number,
                                  /* int& */ width,
                                  /* int* */ _n_blanks,
                                  /* const char* */ _fmt_str);
  return _fmt_str;
}
bool SimUtils::real_path(std::string path_in, std::string path_out) {
  auto _path_in = path_in.c_str();
  auto _path_out = path_out.c_str();
  bool _is_ok{};
  fortran_real_path(/* const char* */ _path_in, /* const char* */ _path_out, /* bool& */ _is_ok);
  return _is_ok;
}
std::string
SimUtils::real_str(double r_num, std::optional<int> n_signif, std::optional<int> n_decimal) {
  int n_signif_lvalue;
  ...
  char _str[4096];
  fortran_real_str(/* double& */ r_num,
                   /* int* */ _n_signif,
                   /* int* */ _n_decimal,
                   /* const char* */ _str);
  return _str;
}
std::string SimUtils::real_to_string(
    double real_num,
    int width,
  ...
  char _str[4096];
  fortran_real_to_string(/* double& */ real_num,
                         /* int& */ width,
                         /* int* */ _n_signif,
                         /* int* */ _n_decimal,
                         /* const char* */ _str);
...
SimUtils::rms_value(FArray1D<Real> &val_arr, optional_ref<BoolAlloc1D> good_val) {
  ...
  double _ave_val{};
  double _rms_val{};
  fortran_rms_value(/* Bmad::array_descriptor_t& */ _val_arr_desc,
                    /* void* */ _good_val,
                    /* double& */ _ave_val,
                    /* double& */ _rms_val);
...
FixedArray1D<Real, 2> SimUtils::rot_2d(FixedArray1D<Real, 2> vec_in, double angle) {
  ...
  _vec_out_desc.data_ptr = _vec_out.data();
  _vec_out_desc.dims[0] = _vec_out.size();
  fortran_rot_2d(/* Bmad::array_descriptor_t& */ _vec_in_desc,
                 /* double& */ angle,
                 /* Bmad::array_descriptor_t& */ _vec_out_desc);
  return _vec_out;
}
void SimUtils::rotate_vec(FArray1D<Real> &vec, int axis, double angle) {
  ...
  fortran_rotate_vec(/* Bmad::array_descriptor_t& */ _vec_desc,
                     /* int& */ axis,
                     /* double& */ angle);
}
FixedArray1D<Real, 3> SimUtils::rotate_vec_given_axis_angle(
  ...
  _vec_out_desc.data_ptr = _vec_out.data();
  _vec_out_desc.dims[0] = _vec_out.size();
  fortran_rotate_vec_given_axis_angle(/* Bmad::array_descriptor_t& */ _vec_in_desc,
                                      /* Bmad::array_descriptor_t& */ _axis_desc,
                                      /* double& */ angle,
                                      /* Bmad::array_descriptor_t& */ _vec_out_desc);
  return _vec_out;
...
int SimUtils::set_parameter(int param_val, int set_val) {
  int _save_val{};
  fortran_set_parameter_int(/* int& */ param_val, /* int& */ set_val, /* int& */ _save_val);
  return _save_val;
}
bool SimUtils::set_parameter(bool param_val, bool set_val) {
  bool _save_val{};
  fortran_set_parameter_logic(/* bool& */ param_val, /* bool& */ set_val, /* bool& */ _save_val);
  return _save_val;
}
double SimUtils::set_parameter(double param_val, double set_val) {
  double _save_val{};
  fortran_set_parameter_real(/* double& */ param_val,
                             /* double& */ set_val,
                             /* double& */ _save_val);
  return _save_val;
}
...
int SimUtils::species_id(
  ...
  int _species{};
  fortran_species_id(/* const char* */ _name,
                     /* int* */ _default_,
                     /* bool* */ _print_err,
                     /* int& */ _species);
  return _species;
...
int SimUtils::species_id_from_openpmd(std::string pmd_name, int charge) {
  ...
  int _species{};
  fortran_species_id_from_openpmd(/* const char* */ _pmd_name,
                                  /* int& */ charge,
                                  /* int& */ _species);
  return _species;
}
...
SimUtils::spline_akima_interpolate(FArray1D<Real> &x_knot, FArray1D<Real> &y_knot, double x) {
  ...
  double _y{};
  double _dy{};
  fortran_spline_akima_interpolate(/* Bmad::array_descriptor_t& */ _x_knot_desc,
                                   /* Bmad::array_descriptor_t& */ _y_knot_desc,
                                   /* double& */ x,
                                   /* bool& */ _ok,
                                   /* double& */ _y,
...
SimUtils::SplineEvaluate SimUtils::spline_evaluate(SplineStructArray1D spline, double x) {
  ...
  double _y{};
  double _dy{};
  fortran_spline_evaluate(/* Bmad::array_descriptor_t& */ _spline_desc,
                          /* double& */ x,
                          /* bool& */ _ok,
                          /* double& */ _y,
                          /* double& */ _dy);
...
double SimUtils::sqrt_one(double x, std::optional<int> nd) {
  int nd_lvalue;
  auto *_nd{&nd_lvalue};
  if (nd.has_value()) {
    nd_lvalue = nd.value();
  ...
  double _ds1{};
  fortran_sqrt_one(/* double& */ x, /* int* */ _nd, /* double& */ _ds1);
  return _ds1;
}
int SimUtils::str_count(std::string str, std::string match) {
  auto _str = str.c_str();
  auto _match = match.c_str();
  int _num{};
  fortran_str_count(/* const char* */ _str, /* const char* */ _match, /* int& */ _num);
  return _num;
}
...
int SimUtils::str_first_in_set(
  ...
  int _ix_match{};
  fortran_str_first_in_set(/* const char* */ _line,
                           /* const char* */ _set,
                           /* bool* */ _ignore_clauses,
                           /* int& */ _ix_match);
  return _ix_match;
}
int SimUtils::str_first_not_in_set(std::string line, std::string set) {
  auto _line = line.c_str();
  auto _set = set.c_str();
  int _ix_match{};
  fortran_str_first_not_in_set(/* const char* */ _line,
                               /* const char* */ _set,
                               /* int& */ _ix_match);
  return _ix_match;
}
int SimUtils::str_last_in_set(std::string line, std::string set) {
  auto _line = line.c_str();
  auto _set = set.c_str();
  int _ix_match{};
  fortran_str_last_in_set(/* const char* */ _line, /* const char* */ _set, /* int& */ _ix_match);
  return _ix_match;
}
int SimUtils::str_last_not_in_set(std::string line, std::string set) {
  auto _line = line.c_str();
  auto _set = set.c_str();
  int _ix_match{};
  fortran_str_last_not_in_set(/* const char* */ _line,
                              /* const char* */ _set,
                              /* int& */ _ix_match);
  return _ix_match;
}
bool SimUtils::str_match_wild(std::string str, std::string pat) {
  auto _str = str.c_str();
  auto _pat = pat.c_str();
  bool _a_match{};
  fortran_str_match_wild(/* const char* */ _str, /* const char* */ _pat, /* bool& */ _a_match);
  return _a_match;
}
void SimUtils::str_substitute(
  ...
  fortran_str_substitute(/* const char* */ _string,
...
int SimUtils::string_to_int(
  ...
  int _value{};
  fortran_string_to_int(/* const char* */ _line,
                        /* int& */ default_,
                        /* bool& */ err_flag,
...
double SimUtils::string_to_real(
    std::string line,
    double default_,
    bool err_flag,
    std::optional<bool> err_print_flag
  ...
  double _value{};
  fortran_string_to_real(/* const char* */ _line,
                         /* double& */ default_,
                         /* bool& */ err_flag,
                         /* bool* */ _err_print_flag,
                         /* double& */ _value);
...
void SimUtils::string_trim(std::string in_string, std::string out_string, int word_len) {
  ...
  fortran_string_trim(/* const char* */ _in_string,
...
void SimUtils::string_trim2(
  ...
  fortran_string_trim2(/* const char* */ _in_str,
...
bool SimUtils::suggest_lmdif(
  ...
  fortran_suggest_lmdif(/* Bmad::array_descriptor_t& */ _XV_desc,
                        /* Bmad::array_descriptor_t& */ _FV_desc,
                        /* double& */ eps,
                        /* int& */ itermx,
                        /* bool& */ _at_end,
...
FixedArray2D<Real, 4, 4> SimUtils::super_bicubic_coef(
  ...
  _c_desc.dims[0] = 4;
  _c_desc.dims[1] = 4;
  fortran_super_bicubic_coef(/* Bmad::array_descriptor_t& */ _y_desc,
                             /* Bmad::array_descriptor_t& */ _y1_desc,
                             /* Bmad::array_descriptor_t& */ _y2_desc,
                             /* Bmad::array_descriptor_t& */ _y12_desc,
                             /* double& */ d1,
...
SimUtils::SuperBicubicInterpolation SimUtils::super_bicubic_interpolation(
  ...
  double _ansy1{};
  double _ansy2{};
  fortran_super_bicubic_interpolation(/* Bmad::array_descriptor_t& */ _y_desc,
                                      /* Bmad::array_descriptor_t& */ _y1_desc,
                                      /* Bmad::array_descriptor_t& */ _y2_desc,
                                      /* Bmad::array_descriptor_t& */ _y12_desc,
                                      /* double& */ x1l,
...
SimUtils::SuperPolint SimUtils::super_polint(FArray1D<Real> &xa, FArray1D<Real> &ya, double x) {
  ...
  double _y{};
  double _dy{};
  fortran_super_polint(/* Bmad::array_descriptor_t& */ _xa_desc,
                       /* Bmad::array_descriptor_t& */ _ya_desc,
                       /* double& */ x,
                       /* double& */ _y,
                       /* double& */ _dy);
...
void SimUtils::test_tune_tracker_lock(BoolAlloc1D &tracker_locked) {
  // intent=inout allocatable general array
  fortran_test_tune_tracker_lock(/* void* */ tracker_locked.get_fortran_ptr());
}
void SimUtils::test_xgelbd() { fortran_test_xgelbd(); }
std::string SimUtils::to_str(double num, std::optional<int> max_signif) {
...
SimUtils::TricubicCmplxEval SimUtils::tricubic_cmplx_eval(
  ...
  std::complex<double> _f_val{};
  fortran_tricubic_cmplx_eval(/* double& */ x_norm,
                              /* double& */ y_norm,
                              /* double& */ z_norm,
...
SimUtils::tricubic_eval(double x_norm, double y_norm, double z_norm, TricubicCoefStruct &tri_coef) {
  double _df_dx{};
  double _df_dy{};
  double _df_dz{};
  double _f_val{};
  fortran_tricubic_eval(/* double& */ x_norm,
                        /* double& */ y_norm,
                        /* double& */ z_norm,
                        /* void* */ tri_coef.get_fortran_ptr(),
                        /* double& */ _df_dx,
                        ...
                        /* double& */ _df_dz,
                        /* double& */ _f_val);
  return TricubicEval{_df_dx, _df_dy, _df_dz, _f_val};
}
TricubicCmplxCoefStruct SimUtils::tricubic_interpolation_cmplx_coefs(
...
SimUtils::WMatToAxisAngle SimUtils::w_mat_to_axis_angle(FixedArray2D<Real, 3, 3> w_mat) {
  ...
  _axis_desc.dims[0] = _axis.size();
  double _angle{};
  fortran_w_mat_to_axis_angle(/* Bmad::array_descriptor_t& */ _w_mat_desc,
                              /* Bmad::array_descriptor_t& */ _axis_desc,
                              /* double& */ _angle);
...
FixedArray1D<Real, 4> SimUtils::w_mat_to_quat(FixedArray2D<Real, 3, 3> w_mat) {
  ...
  _quat_desc.data_ptr = _quat.data();
  _quat_desc.dims[0] = _quat.size();
  fortran_w_mat_to_quat(/* Bmad::array_descriptor_t& */ _w_mat_desc,
                        /* Bmad::array_descriptor_t& */ _quat_desc);
  return _quat;
}
int SimUtils::word_len(std::string wording) {
  auto _wording = wording.c_str();
  int _wlen{};
  fortran_word_len(/* const char* */ _wording, /* int& */ _wlen);
  return _wlen;
}
void SimUtils::word_read(
  ...
  fortran_word_read(/* const char* */ _in_str,
