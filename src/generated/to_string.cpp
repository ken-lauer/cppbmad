...
std::string to_string(const AllEncompassingStruct &self) {
  return repr(
      ...
      {std::pair{"real_rp_0d", to_string(self.real_rp_0d())},
       ...
       std::pair{"int8_1d", to_string(self.int8_1d())},
       std::pair{"int8_2d", to_string(self.int8_2d())},
       std::pair{"int8_3d", to_string(self.int8_3d())},
       std::pair{"int8_0d_ptr", to_string(self.int8_0d_ptr())},
       std::pair{"int8_1d_ptr", to_string(self.int8_1d_ptr())},
       std::pair{"int8_2d_ptr", to_string(self.int8_2d_ptr())},
       std::pair{"int8_3d_ptr", to_string(self.int8_3d_ptr())},
       std::pair{"int8_1d_alloc", to_string(self.int8_1d_alloc())},
       std::pair{"int8_2d_alloc", to_string(self.int8_2d_alloc())},
       std::pair{"int8_3d_alloc", to_string(self.int8_3d_alloc())},
       std::pair{"logical_0d", to_string(self.logical_0d())},
       std::pair{"logical_1d", to_string(self.logical_1d())},
...
std::string to_string(const Bmad::ActionToXyz &self) {
  return repr(
      &self,
      "Bmad::ActionToXyz",
      {std::pair{"X", to_string(self.X)}, std::pair{"err_flag", to_string(self.err_flag)}}
  );
}
...
std::string to_string(const bsim::BbuTrackAll &self) {
  return repr(
      &self,
      "bsim::BbuTrackAll",
      {std::pair{"hom_voltage_normalized", to_string(self.hom_voltage_normalized)},
       std::pair{"growth_rate", to_string(self.growth_rate)},
       std::pair{"lost", to_string(self.lost)},
...
std::string to_string(const Bmad::BendShift &self) {
  return repr(
      &self,
      "Bmad::BendShift",
      {std::pair{"w_mat", to_string(self.w_mat)}, std::pair{"position2", to_string(self.position2)}}
  );
}
...
std::string to_string(const SimUtils::BracketIndexForSpline &self) {
  return repr(
      ...
      {std::pair{"ix0", to_string(self.ix0)}, std::pair{"ok", to_string(self.ok)}}
  );
}
std::string to_string(const Bmad::CalcBunchParams &self) {
  return repr(
      &self,
      "Bmad::CalcBunchParams",
...
std::string to_string(const Bmad::ClosedOrbitFromTracking &self) {
  return repr(
      ...
      {std::pair{"closed_orb", "[...]"}, std::pair{"err_flag", to_string(self.err_flag)}}
  );
}
...
std::string to_string(const Bmad::CoordsBodyToLocal &self) {
  return repr(
      &self,
      "Bmad::CoordsBodyToLocal",
      {std::pair{"w_mat", to_string(self.w_mat)},
       std::pair{"local_position", to_string(self.local_position)}}
  );
}
std::string to_string(const Bmad::CoordsBodyToRelExit &self) {
  return repr(
      &self,
      "Bmad::CoordsBodyToRelExit",
      {std::pair{"w_mat", to_string(self.w_mat)}, std::pair{"rel_exit", to_string(self.rel_exit)}}
  );
}
std::string to_string(const Bmad::CoordsCurvilinearToFloor &self) {
  return repr(
      ...
      {std::pair{"err_flag", to_string(self.err_flag)}, std::pair{"global", to_string(self.global)}}
  );
}
std::string to_string(const Bmad::CoordsFloorToCurvilinear &self) {
  return repr(
      ...
      {std::pair{"ele1", to_string(self.ele1)},
       ...
       std::pair{"w_mat", to_string(self.w_mat)},
       std::pair{"local_coords", to_string(self.local_coords)}}
  );
}
...
std::string to_string(const Bmad::CoordsLocalCurvilinearToBody &self) {
  return repr(
      ...
      {std::pair{"w_mat", to_string(self.w_mat)},
       std::pair{"body_position", to_string(self.body_position)}}
  );
}
std::string to_string(const Bmad::CoordsLocalCurvilinearToFloor &self) {
  return repr(
      ...
      {std::pair{"w_mat", to_string(self.w_mat)},
       std::pair{"global_position", to_string(self.global_position)}}
  );
}
...
std::string to_string(const Bmad::DistanceToAperture &self) {
  return repr(
      ...
      {std::pair{"no_aperture_here", to_string(self.no_aperture_here)},
       std::pair{"dist", to_string(self.dist)}}
  );
}
...
std::string to_string(const Bmad::EleMisalignmentLSCalc &self) {
  return repr(
      ...
      {std::pair{"L_mis", to_string(self.L_mis)}, std::pair{"S_mis", to_string(self.S_mis)}}
  );
}
...
std::string to_string(const Bmad::EleToTaylor &self) {
  return repr(
      &self,
      "Bmad::EleToTaylor",
      {std::pair{"orbital_taylor", "[...]"}, std::pair{"spin_taylor", "[...]"}}
  );
}
...
std::string to_string(const Bmad::EmFieldCalc &self) {
  return repr(
      &self,
      "Bmad::EmFieldCalc",
      {std::pair{"field", to_string(self.field)}, std::pair{"err_flag", to_string(self.err_flag)}}
  );
}
...
std::string to_string(const Bmad::EnvelopeRadintsIbs &self) {
  return repr(
      ...
      {std::pair{"alpha", to_string(self.alpha)}, std::pair{"emit", to_string(self.emit)}}
  );
}
...
std::string to_string(const Bmad::ExpressionStringToTree &self) {
  return repr(
      ...
      {std::pair{"err_flag", to_string(self.err_flag)}, std::pair{"err_str", self.err_str}}
  );
}
...
std::string to_string(const Bmad::FindElementEnds &self) {
  return repr(
      ...
      {std::pair{"ele1", to_string(self.ele1)}, std::pair{"ele2", to_string(self.ele2)}}
  );
}
...
std::string to_string(const Bmad::FloorAnglesToWMat &self) {
  return repr(
      ...
      {std::pair{"w_mat", to_string(self.w_mat)}, std::pair{"w_mat_inv", to_string(self.w_mat_inv)}}
  );
}
...
std::string to_string(const Bmad::GetNextWord &self) {
  return repr(
      &self,
      "Bmad::GetNextWord",
      {std::pair{"ix_word", to_string(self.ix_word)},
       std::pair{"delim", self.delim},
       std::pair{"delim_found", to_string(self.delim_found)},
       std::pair{"err_flag", to_string(self.err_flag)}}
  );
...
std::string to_string(const Bmad::GetSlaveList &self) {
  return repr(
      &self,
      "Bmad::GetSlaveList",
      {std::pair{"slaves", "[...]"}, std::pair{"n_slave", to_string(self.n_slave)}}
  );
}
...
std::string to_string(const Bmad::KickVectorCalc &self) {
  return repr(
      &self,
      "Bmad::KickVectorCalc",
      {std::pair{"dr_ds", to_string(self.dr_ds)}, std::pair{"err", to_string(self.err)}}
  );
}
std::string to_string(const Bmad::KnotInterpolate &self) {
  return repr(
      ...
      {std::pair{"err_flag", to_string(self.err_flag)}, std::pair{"y_pt", to_string(self.y_pt)}}
  );
}
std::string to_string(const Bmad::LinearCoef &self) {
  return repr(
      &self,
      "Bmad::LinearCoef",
      {std::pair{"err_flag", to_string(self.err_flag)}, std::pair{"coef", to_string(self.coef)}}
  );
}
...
std::string to_string(const Bmad::MakeGMats &self) {
  return repr(
      &self,
      "Bmad::MakeGMats",
      {std::pair{"g_mat", to_string(self.g_mat)}, std::pair{"g_inv_mat", to_string(self.g_inv_mat)}}
  );
}
...
std::string to_string(const Bmad::MakeMadMap &self) {
  return repr(
      &self,
      "Bmad::MakeMadMap",
      {std::pair{"energy", to_string(self.energy)}, std::pair{"map", to_string(self.map)}}
  );
}
...
std::string to_string(const Bmad::MakeMat6Bmad &self) {
  return repr(
      &self,
      "Bmad::MakeMat6Bmad",
      {std::pair{"end_orb", to_string(self.end_orb)}, std::pair{"err", to_string(self.err)}}
  );
}
...
std::string to_string(const Bmad::MakeVMats &self) {
  return repr(
      &self,
      "Bmad::MakeVMats",
      {std::pair{"v_mat", to_string(self.v_mat)}, std::pair{"v_inv_mat", to_string(self.v_inv_mat)}}
  );
}
...
std::string to_string(const Bmad::MultipassChain &self) {
  return repr(
      ...
      "Bmad::MultipassChain",
      {std::pair{"ix_pass", to_string(self.ix_pass)},
       std::pair{"n_links", to_string(self.n_links)},
       std::pair{"chain_ele", "[...]"}}
  );
}
std::string to_string(const Bmad::Multipole1AbToKt &self) {
  return repr(
      ...
      {std::pair{"knl", to_string(self.knl)}, std::pair{"tn", to_string(self.tn)}}
  );
}
std::string to_string(const Bmad::Multipole1KtToAb &self) {
  return repr(
      ...
      {std::pair{"an", to_string(self.an)}, std::pair{"bn", to_string(self.bn)}}
  );
}
...
std::string to_string(const Bmad::NormalFormTaylors &self) {
  return repr(
      ...
      {std::pair{"dhdj", "[...]"}, std::pair{"A", "[...]"}, std::pair{"A_inverse", "[...]"}}
  );
}
...
std::string to_string(const Bmad::OdeintBmad &self) {
  return repr(
      &self,
      "Bmad::OdeintBmad",
      {std::pair{"err_flag", to_string(self.err_flag)}, std::pair{"track", to_string(self.track)}}
  );
}
...
std::string to_string(const Bmad::OffsetParticle &self) {
  return repr(
      &self,
      "Bmad::OffsetParticle",
      {std::pair{"s_out", to_string(self.s_out)}, std::pair{"spin_qrot", to_string(self.spin_qrot)}}
  );
}
...
std::string to_string(const Bmad::OrbitTooLarge &self) {
  return repr(
      ...
      "Bmad::OrbitTooLarge",
      {std::pair{"param", to_string(self.param)},
       std::pair{"is_too_large", to_string(self.is_too_large)}}
  );
}
std::string to_string(const Bmad::OrderEvecsByNSimilarity &self) {
  return repr(
      ...
      {std::pair{"evec", to_string(self.evec)}, std::pair{"err_flag", to_string(self.err_flag)}}
  );
}
...
std::string to_string(const Bmad::ParserFastComplexRead &self) {
  return repr(
      ...
      {std::pair{"delim", self.delim}, std::pair{"is_ok", to_string(self.is_ok)}}
  );
}
...
std::string to_string(const Bmad::PointerToFieldEle &self) {
  return repr(
      &self,
      "Bmad::PointerToFieldEle",
      {std::pair{"dz_offset", to_string(self.dz_offset)},
       std::pair{"field_ele", to_string(self.field_ele)}}
  );
}
...
std::string to_string(const Bmad::PointerToMultipassLord &self) {
  return repr(
      ...
      {std::pair{"ix_pass", to_string(self.ix_pass)},
       ...
       std::pair{"multi_lord", to_string(self.multi_lord)}}
  );
}
...
std::string to_string(const Bmad::PointerToWakeEle &self) {
  return repr(
      &self,
      "Bmad::PointerToWakeEle",
      {std::pair{"delta_s", to_string(self.delta_s)},
       std::pair{"wake_ele", to_string(self.wake_ele)}}
  );
}
...
std::string to_string(const Bmad::PtcCheckForLostParticle &self) {
  return repr(
      ...
      {std::pair{"state", to_string(self.state)}, std::pair{"ptc_fibre", to_string(self.ptc_fibre)}}
  );
}
...
std::string to_string(const SimUtils::QuatToAxisAngle &self) {
  return repr(
      ...
      {std::pair{"axis", to_string(self.axis)}, std::pair{"angle", to_string(self.angle)}}
  );
}
...
std::string to_string(const Bmad::RamperValue &self) {
  return repr(
      &self,
      "Bmad::RamperValue",
      {std::pair{"err_flag", to_string(self.err_flag)}, std::pair{"value", to_string(self.value)}}
  );
}
std::string to_string(const SimUtils::RanGaussConverter &self) {
  return repr(
      ...
      {std::pair{"get", self.get}, std::pair{"get_sigma_cut", to_string(self.get_sigma_cut)}}
  );
}
...
std::string to_string(const Bmad::SpinDnDpzFromMat8 &self) {
  return repr(
      &self,
      "Bmad::SpinDnDpzFromMat8",
      {std::pair{"error", to_string(self.error)}, std::pair{"dn_dpz", to_string(self.dn_dpz)}}
  );
}
std::string to_string(const Bmad::SpinDnDpzFromQmap &self) {
  return repr(
      &self,
      "Bmad::SpinDnDpzFromQmap",
      {std::pair{"error", to_string(self.error)}, std::pair{"dn_dpz", to_string(self.dn_dpz)}}
  );
}
std::string to_string(const Bmad::SpinMat8ResonanceStrengths &self) {
  return repr(
      ...
      {std::pair{"xi_sum", to_string(self.xi_sum)}, std::pair{"xi_diff", to_string(self.xi_diff)}}
  );
}
...
std::string to_string(const Tao::TaoCurveRmsCalc &self) {
  return repr(
      &self,
      "Tao::TaoCurveRmsCalc",
      {std::pair{"rms", to_string(self.rms)}, std::pair{"mean", to_string(self.mean)}}
  );
}
...
std::string to_string(const Tao::TaoEvaluateLatOrBeamData &self) {
  return repr(
      ...
      {std::pair{"err", to_string(self.err)}, std::pair{"values", to_string(self.values)}}
  );
}
...
std::string to_string(const Tao::TaoGetOptVars &self) {
  return repr(
      ...
      {std::pair{"var_value", to_string(self.var_value)},
       ...
       std::pair{"ignore_if_weight_is_zero", to_string(self.ignore_if_weight_is_zero)},
       std::pair{"ignore_if_not_limited", to_string(self.ignore_if_not_limited)}}
  );
}
...
std::string to_string(const Tao::TaoInitFindElements &self) {
  return repr(
      ...
      {std::pair{"eles", "[...]"}, std::pair{"found_one", to_string(self.found_one)}}
  );
}
std::string to_string(const Tao::TaoInjectBeam &self) {
  return repr(
      &self,
      "Tao::TaoInjectBeam",
      {std::pair{"beam", to_string(self.beam)}, std::pair{"init_ok", to_string(self.init_ok)}}
  );
}
std::string to_string(const Tao::TaoIsValidName &self) {
  return repr(
      &self,
      "Tao::TaoIsValidName",
      {std::pair{"why_invalid", self.why_invalid}, std::pair{"is_valid", to_string(self.is_valid)}}
  );
}
...
std::string to_string(const Tao::TaoOpenScratchFile &self) {
  return repr(
      &self,
      "Tao::TaoOpenScratchFile",
      {std::pair{"err", to_string(self.err)}, std::pair{"iu", to_string(self.iu)}}
  );
}
...
std::string to_string(const Tao::TaoParticleDataValue &self) {
  return repr(
      ...
      {std::pair{"value", to_string(self.value)}, std::pair{"err", to_string(self.err)}}
  );
}
std::string to_string(const Tao::TaoPickUniverse &self) {
  return repr(
      ...
      {std::pair{"name_out", self.name_out},
       std::pair{"picked", to_string(self.picked)},
       std::pair{"err", to_string(self.err)},
       std::pair{"ix_uni", to_string(self.ix_uni)},
...
std::string to_string(const Tao::TaoSetQpAxisStruct &self) {
  return repr(
      ...
      {std::pair{"error", to_string(self.error)}, std::pair{"ix_uni", to_string(self.ix_uni)}}
  );
}
...
std::string to_string(const Tao::TaoSubinUniNumber &self) {
  return repr(
      &self,
      "Tao::TaoSubinUniNumber",
      {std::pair{"name_out", self.name_out}, std::pair{"ok", to_string(self.ok)}}
  );
}
...
std::string to_string(const CppBmadTest::TestBunchStructArray &self) {
  return repr(
      ...
      {std::pair{"arr_out", "[...]"}, std::pair{"opt_status", to_string(self.opt_status)}}
  );
}
...
std::string to_string(const CppBmadTest::TestCharacterScalar &self) {
  return repr(
      ...
      {std::pair{"val_out", self.val_out}, std::pair{"opt_status", to_string(self.opt_status)}}
  );
}
...
std::string to_string(const Bmad::TrackABeambeam &self) {
  return repr(
      &self,
      "Bmad::TrackABeambeam",
      {std::pair{"track", to_string(self.track)}, std::pair{"mat6", to_string(self.mat6)}}
  );
}
...
std::string to_string(const Bmad::TrackUntilDead &self) {
  return repr(
      &self,
      "Bmad::TrackUntilDead",
      {std::pair{"end_orb", to_string(self.end_orb)}, std::pair{"track", to_string(self.track)}}
  );
}
...
std::string to_string(const Bmad::Twiss1Propagate &self) {
  return repr(
      ...
      {std::pair{"twiss2", to_string(self.twiss2)}, std::pair{"err", to_string(self.err)}}
  );
}
...
std::string to_string(const Bmad::WriteAstraFieldGridFile &self) {
  return repr(
      ...
      {std::pair{"maxfield", to_string(self.maxfield)}, std::pair{"err", to_string(self.err)}}
  );
}
