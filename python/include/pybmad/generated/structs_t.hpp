...
void init_tricubic_coef_struct(nb::module_ &m, nb::class_<TricubicCoefStruct> &class_);
void init_tao_ele_shape_input(nb::module_ &m, nb::class_<TaoEleShapeInput> &class_);
void init_tao_plot_page_input(nb::module_ &m, nb::class_<TaoPlotPageInput> &class_);
void init_tao_alias_struct(nb::module_ &m, nb::class_<TaoAliasStruct> &class_);
...
void init_tao_command_file_struct(nb::module_ &m, nb::class_<TaoCommandFileStruct> &class_);
void init_tao_common_struct(nb::module_ &m, nb::class_<TaoCommonStruct> &class_);
void init_tao_curve_array_struct(nb::module_ &m, nb::class_<TaoCurveArrayStruct> &class_);
...
void init_tao_d1_data_array_struct(nb::module_ &m, nb::class_<TaoD1DataArrayStruct> &class_);
void init_tao_d1_data_struct(nb::module_ &m, nb::class_<TaoD1DataStruct> &class_);
void init_tao_d2_data_array_struct(nb::module_ &m, nb::class_<TaoD2DataArrayStruct> &class_);
void init_tao_d2_data_struct(nb::module_ &m, nb::class_<TaoD2DataStruct> &class_);
void init_tao_data_array_struct(nb::module_ &m, nb::class_<TaoDataArrayStruct> &class_);
...
void init_tao_graph_array_struct(nb::module_ &m, nb::class_<TaoGraphArrayStruct> &class_);
...
void init_tao_integer_array_struct(nb::module_ &m, nb::class_<TaoIntegerArrayStruct> &class_);
...
void init_tao_logical_array_struct(nb::module_ &m, nb::class_<TaoLogicalArrayStruct> &class_);
...
void init_tao_plot_array_struct(nb::module_ &m, nb::class_<TaoPlotArrayStruct> &class_);
...
void init_tao_real_pointer_struct(nb::module_ &m, nb::class_<TaoRealPointerStruct> &class_);
...
void init_tao_string_array_struct(nb::module_ &m, nb::class_<TaoStringArrayStruct> &class_);
...
void init_tao_v1_var_array_struct(nb::module_ &m, nb::class_<TaoV1VarArrayStruct> &class_);
void init_tao_v1_var_struct(nb::module_ &m, nb::class_<TaoV1VarStruct> &class_);
void init_tao_var_array_struct(nb::module_ &m, nb::class_<TaoVarArrayStruct> &class_);
...
void init_tao_top10_struct(nb::module_ &m, nb::class_<TaoTop10Struct> &class_);
